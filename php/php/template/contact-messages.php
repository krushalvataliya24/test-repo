					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-8">
									<h4 class="page-title">Contact Messages<span class="count-title">123</span></h4>
								</div>
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="contact-messages.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="table-responsive custom-table">
									<table class="table" id="contact-messages-list">
					...
					<div>
						<div class="row">
							...
							<div class="col-md-12">
								<div class="mb-3">
									<label class="col-form-label">Message <span class="text-danger">*</span></label>
									<textarea class="form-control">Duis aute irure dolor in reprehenderit</textarea>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="contact-messages.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
