							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="deals-details.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
							...
							<div class="row align-items-center">
								<div class="col-sm-8">
									<ul class="contact-breadcrumb">
										<li><a href="deals.php"><i class="ti ti-arrow-narrow-left"></i>Deals</a></li>
								...
								<div class="col-sm-4 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="deals-details.php"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="deals-details.php"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="deals-details.php" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
