							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="contact-grid.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="contact-grid.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="view-icons">
											<a href="contacts.php"><i class="ti ti-list-tree"></i></a>
											<a href="contact-grid.php" class="active"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- Contact Grid -->
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														<a href="contact-details.php" class="avatar avatar-md flex-shrink-0 me-2">
															<img src="assets/img/profiles/avatar-19.jpg" alt="img">
														</a>
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Darlee Robertson</a></h6>
													...
													<div class="dropdown table-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="contact-details.php"><i class="ti ti-eye text-blue-light"></i> Preview</a>
														</div>
													</div>
												</div>
												<div class="d-block">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Sharon Roy</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Vaughan</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Jessica</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Carol Thomas</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Dawn Mercha</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Rachel Hampton</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Jonelle Curtiss</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Jonathan</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Brook</a></h6>
															<p class="text-default">Team Lead Dev</p>
														</div>
													</div>
													<div class="dropdown table-action">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Eric Adams</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact-details.php" class="fw-medium">Richard Cooper</a></h6>
			...
			<div class="offcanvas-body">
				<form action="contact-grid.php">
					<div class="accordion" id="main_accordion_2">
						...
						<div class="accordion-item rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button bg-white rounded fw-medium text-dark" data-bs-toggle="collapse" data-bs-target="#basic-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i class="ti ti-user-plus fs-20"></i></span>
									Basic Info
								</a>
							</div>
							<div class="accordion-collapse collapse show" id="basic-2" data-bs-parent="#main_accordion_2">
								<div class="accordion-body border-top">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
										...
										<div class="col-md-12">
											<div class="mb-3">
												<div class="d-flex justify-content-between align-items-center">
													...
													<div class="status-toggle small-toggle-btn d-flex align-items-center">
														<span class="me-2 label-text">Email Opt Out</span>
														<input type="checkbox" id="user2" class="check" checked="" value="robertson@example.com">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded bg-white fw-medium text-dark" data-bs-toggle="collapse" data-bs-target="#address-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i class="ti ti-map-pin-cog fs-20"></i></span>
									Address Info
								</a>
							</div>
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded bg-white fw-medium text-dark" data-bs-toggle="collapse" data-bs-target="#social-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i class="ti ti-social fs-20"></i></span>
									Social Profile
								</a>
							</div>
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#" class="accordion-button accordion-custom-button rounded bg-white fw-medium text-dark" data-bs-toggle="collapse" data-bs-target="#access-info-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i class="ti ti-accessible fs-20"></i></span>
									Access
								</a>
							</div>
							<div class="accordion-collapse collapse" id="access-info-2" data-bs-parent="#main_accordion_2">
								<div class="accordion-body border-top">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<div class="d-flex flex-wrap">
													<div class="me-2">
														<input type="radio" class="status-radio" id="public2" name="visible">
														<label for="public2">Public</label>
													</div>
													<div class="me-2">
														<input type="radio" class="status-radio" id="private2" name="visible">
														<label for="private2">Private</label>
													</div>
													<div data-bs-toggle="modal" data-bs-target="#access_view">
														<input type="radio" class="status-radio" id="people2" name="visible">
											...
											<div class="mb-0">
												...
												<div class="d-flex flex-wrap">
													<div class="me-2">
														<input type="radio" class="status-radio" id="active2" name="status" checked="">
														<label for="active2">Active</label>
													</div>
													<div>
														<input type="radio" class="status-radio" id="inactive2" name="status">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="contact-grid.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
