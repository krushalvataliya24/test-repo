...
<head>
  <title>Managership Adddons | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
  <?php include 'layouts/title-meta.php'; ?>

  <!-- Bootstrap Tagsinput CSS -->
  <link
    rel="stylesheet" href="assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.css" />

  <!-- Summernote CSS -->
  <link
    rel="stylesheet" href="assets/plugins/summernote/summernote-lite.min.css" />
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="membership-addons.php">
                  <div class="row">
                    <div class="col-lg-4 col-md-6">
                      <div class="mb-3">
                        <label class="col-form-label">Addon Name
                    ...
                    <div class="col-lg-4 col-md-6">
                      <div class="mb-3">
                        <label class="col-form-label">Activities
                          <span class="text-danger">*</span></label>
                        <div class="d-flex align-items-center">
                          <input
                            type="text"
