	...
	<div class="main-wrapper">
				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="campaign-complete.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
						...
						<div class="campaign-tab">
							<ul class="nav">
								<li>
									<a href="campaign.php">Active Campaign<span>24</span></a>
								</li>
								<li>
									<a href="campaign-complete.php" class="active">Completed Campaign</a>
								</li>
								<li>
									<a href="campaign-archieve.php">Archived Campaign</a>
								</li>
							</ul>
						</div>
						<!-- Campaign Tab -->
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="campaign-archieve.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="campaign-archieve.php">
					<div>
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="campaign.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
