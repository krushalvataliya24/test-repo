							...
							<div class="row align-items-center">
								...
								<div class="col-sm-8 text-sm-end">
									<div class="head-icons">
										<a href="contact-details.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="contact-grid.php"><i class="ti ti-arrow-narrow-left"></i>Contacts</a></li>
								...
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="contact-details.php"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="contact-details.php"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="card-body pb-2">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<div class="contacts-action">
										...
										<a href="chat.php" class="btn-icon">
								...
								<div class="mb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-lg rounded me-2 border">
											<img src="assets/img/icons/google-icon.svg" alt="" class="img-fluid w-auto h-auto">
										</span>
										<div>
										...
										<div class="card border shadow-none mb-3">
											<div class="card-body p-3">
												<div class="d-flex">
													...
													<div>
														<h6 class="fw-medium mb-1 d-inline-flex align-items-center flex-wrap">Meeting With <span class="avatar avatar-xs mx-2"><img src="assets/img/profiles/avatar-19.jpg" alt="img"></span> Abraham</h6>
																...
																<div class="col-sm-4">
																	...
																	<div class="dropdown">
																		...
																		<div class="dropdown-menu dropdown-menu-right">
																			...
																			<a class="dropdown-item" href="javascript:void(0);">
																				<img src="assets/img/profiles/avatar-15.jpg" alt="img" class="avatar-xs">Peter
																			</a>
																		</div>
																	</div>
																</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="contacts.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal custom-modal fade modal-padding" id="add_notes" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="contact-details.php">
							<div class="mb-3">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="contact-details.php" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
