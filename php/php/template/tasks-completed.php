							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="tasks-completed.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="tasks-completed.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
