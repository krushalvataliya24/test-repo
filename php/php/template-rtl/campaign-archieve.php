					...
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="campaign-archieve.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
						...
						<div class="campaign-tab">
							<ul class="nav">
								...
								<li>
									<a href="campaign-complete.php">Completed Campaign</a>
								</li>
								<li>
									<a href="campaign-archieve.php" class="active">Archived Campaign</a>
								</li>
							</ul>
						</div>
						<!-- Campaign Tab -->
