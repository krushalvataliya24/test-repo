				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="campaign.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
						...
						<div class="campaign-tab">
							<ul class="nav">
								<li>
									<a href="campaign.php" class="active">Active Campaign<span>24</span></a>
								</li>
								<li>
