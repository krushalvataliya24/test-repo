							...
							<div class="row align-items-center">
								...
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="project-reports.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="project-reports.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
