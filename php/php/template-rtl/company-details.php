							...
							<div class="row align-items-center">
								...
								<div class="col-sm-8 text-sm-end">
									<div class="head-icons">
										<a href="company-details.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="companies.php"><i class="ti ti-arrow-narrow-left"></i>Company</a></li>
										<li>NovaWave LLC</li>
									</ul>
								</div>
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="company-details.php"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="company-details.php"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="companies.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="company-details.php" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
