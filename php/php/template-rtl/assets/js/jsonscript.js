...
$(document).ready(function () {
	...
	if($('#categorieslist').length > 0) {
		$('#categorieslist').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="contact-details.php" class="avatar avatar-sm me-2"><img class="img-fluid" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact-details.php" class="d-flex flex-column">' + row['customer_name'] + ' <span class="text-default">' + row['customer_no'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if($('#companieslist').length > 0) {
		$('#companieslist').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border rounded p-1 me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details.php" class="d-flex flex-column fw-medium">'+row['company_name']+'</a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
				...
				{ "render": function ( data, type, row ){
					return '<div class="dropdown table-action"><a href="#" class="action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit"><i class="ti ti-edit text-blue"></i> Edit</a><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_contact"><i class="ti ti-trash text-danger"></i> Delete</a><a class="dropdown-item" href="company-details.php"><i class="ti ti-eye text-blue-light"></i> Preview</a></div></div>';
				}}
			]
		});
	}
	...
	if($('#leads_list').length > 0) {
		$('#leads_list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<a href="leads-details.php" class="title-name">'+row['lead_name']+'</a>';
				}},
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border rounded p-1 me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details.php" class="d-flex flex-column">'+row['company_name']+'<span class="text-default">'+row['company_address']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
	...
	if($('#deal_list').length > 0) {
		$('#deal_list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<a href="deals-details.php" class="title-name">'+row['Deal_Name']+'</a>';
				}},
				{ "data": "Stage" },
				{ "data": "Deal_Value" },
				{ "render": function ( data, type, row ){
	...
	if($('#recent-project').length > 0) {
		...
		"columns": [
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="project-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['priority_img']+'" alt="User Image"></a><a href="project-details.php">'+row['priority_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['recent_img']+'" alt="User Image"></a><a href="company-details.php">'+row['recent_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
	...
	if($('#lead-project').length > 0) {
		...
		"columns": [
			{ "data": "lead" },
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details.php" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
			}},
			{ "data": "phone" },
			{ "render": function ( data, type, row ){
	...
	if($('#project-list').length > 0) {
		$('#project-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="project-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['pro_img']+'" alt="User Image"></a><a href="project-details.php">'+row['name']+'</a></h2>';
				}},
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details.php">'+row['client']+'</a></h2>';
				}},   
				{ "render": function ( data, type, row ){
	...
	if($('#proposals-list').length > 0) {
		$('#proposals-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details.php">'+row['sent_to']+'</a></h2>';
				}},
				{ "data": "total_value" },    
				{ "data": "date" },                 
				{ "data": "open_till" }, 
	...
	if($('#contracts-list').length > 0) {
		$('#contracts-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details.php">'+row['customer']+'</a></h2>';
				}},  
				{ "data": "contract_value" },                 
				{ "data": "contract_type" },                 
				{ "data": "date" },                 
	...
	if($('#analytic-contact').length > 0) {
		$('#analytic-contact').DataTable({
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="contact-details.php" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="contact-details.php" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
	...
	if($('#analytic-company').length > 0) {
		$('#analytic-company').DataTable({
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details.php">'+row['lead_name']+'</a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
	...
	if($('#analytic-lead').length > 0) {
		$('#analytic-lead').DataTable({
			...
			"columns": [
				{ "data": "name" },
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="leads-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="leads-details.php" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "render": function ( data, type, row ){
	...
	if($('#contact-reports').length > 0) {
		$('#contact-reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="contact-details.php" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="'+row['customer_image']+'" alt="User Image"></a><a href="contact-details.php" class="d-flex flex-column">'+row['customer_name']+' <span class="text-default">'+row['customer_no']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details.php">'+row['company_name']+'</a></h2>';
				}},
				{ "data": "industry" },
				{ "data": "type" },
				{ "data": "source" },
	...
	if($('#leads_reports').length > 0) {
		$('#leads_reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details.php" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details.php" class="d-flex flex-column">'+row['company_name']+'<span class="text-default">'+row['company_address']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
