							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="project-grid.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="project-grid.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="view-icons">
											<a href="projects.php"><i class="ti ti-list-tree"></i></a>
											<a href="project-grid.php" class="active"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- /Filter -->
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/truellysel.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Truelysell</a></h5>
															<p>Web App</p>
														</div>
													</div>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/dreamchat.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Dreamschat</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/truellysell.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Truelysell</a></h5>
															<p>Web App</p>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/servbook.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Servbook</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/dream-pos.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">DreamPOS</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/project-01.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Kofejob</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Doccure</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/best.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Best@laundry</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">POS</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="assets/img/icons/company-icon-09.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>CoastalStar Inc</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="assets/img/icons/company-icon-10.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>Redwood Inc</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Dreamchat</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="project-details.php" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="assets/img/priority/sports.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="project-details.php">Sports</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="project-grid.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								...
								<a href="project-details.php" class="btn btn-primary">View Details</a>
							</div>
						</div>
					</div>
				</div>
