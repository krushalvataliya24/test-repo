							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="companies-grid.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="companies-grid.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="view-icons">
											<a href="companies.php"><i class="ti ti-list-tree"></i></a>
											<a href="companies-grid.php" class="active"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- Company Grid -->
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="company-details.php" class="avatar avatar-lg border rounded flex-shrink-0 me-2">
															<img src="assets/img/icons/company-icon-01.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h6><a href="company-details.php" class="fw-medium">NovaWave LLC</a></h6>
													...
													<div class="dropdown table-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="company-details.php"><i class="ti ti-eye text-blue-light"></i> Preview</a>
														</div>
													</div>
												</div>
												<div class="d-block">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">BlueSky Industries</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">Summit Peak</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">RiverStone Ventur</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">Bright Bridge Grp</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>5.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">CoastalStar Co.</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">HarborView</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>5.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">Golden Gate Ltd</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">Redwood Inc</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">SilverHawk</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>3.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="company-details.php" class="fw-medium">SummitPeak</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>3.0
															</div>
														</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="companies-grid.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
