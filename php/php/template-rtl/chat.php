							...
							<div class="messages">
								<div class="chats">
									<div class="chat-avatar">
										<img src="assets/img/profiles/avatar-02.jpg" class="rounded-circle dreams_chat" alt="image">
									</div>
								...
								<div class="chats chats-right">
									...
									<div class="chat-avatar">
										<img src="assets/img/profiles/avatar-10.jpg" class="rounded-circle dreams_chat" alt="image">
									</div>
								</div>
								<div class="chats">
									<div class="chat-avatar">
								...
								<div class="mt-0 right_sidebar_logo">
									<div class="text-center right-sidebar-profile">
										...
										<div class="chat-options chat-option-profile">
											<ul class="list-inline">
												<li class="list-inline-item">
													<a href="audio-call" class="btn btn-outline-light " data-bs-toggle="tooltip" data-bs-placement="bottom" title="Voice Call">
														<i class="bx bx-phone"></i>
													</a>
												</li>
												<li class="list-inline-item ">
													<a href="video-call" class="btn btn-outline-light profile-open" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Video Call">
														<i class="bx bx-video"></i>
													</a>
												</li>
												<li class="list-inline-item">
																...
																<td>
																	<div class="productimgname">
																		<a href="javascript:void(0);" class="product-img stock-img">
																			<img src="assets/img/supplier/stock-img-01.png" alt="product">
																		</a>
					...
					<div class="content">
						...
						<div class="modal-body custom-modal-body">
							...
							<div class="col-lg-12">
								<div class="modal-footer-btn">
									<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
									<a href="purchase-list" class="btn btn-submit">Submit</a>
								</div>
							</div>
						</div>
					</div>
