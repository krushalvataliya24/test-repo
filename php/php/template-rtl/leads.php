							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="leads.php" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="row align-items-center">
									...
									<div class="col-sm-8">
										<div
											...
											<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="border-top pt-3">
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Lead Name</p>
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Company Name</p>
														<div class="status-toggle">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Lead Status</p>
														<div class="status-toggle">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Lead Owner</p>
														<div class="status-toggle">
										...
										<div class="view-icons">
											<a href="leads.php" class="active"><i class="ti ti-list-tree"></i></a>
											<a href="leads-kanban.php"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- /Filter -->
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="leads.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
