							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="deals-kanban.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="deals-kanban.php" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<ul class="d-flex align-items-center">
									<li>
										<div class="view-icons me-2">
											<a href="deals.php"><i class="ti ti-list-tree"></i></a>
											<a href="deals-kanban.php" class="active"><i class="ti ti-grid-dots"></i></a>
										</div>
									</li>
									<li>
											...
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">HT</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Howell, Tremblay <br> and Rath</a></h6>
													</div>
												</div>
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-19.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">RJ</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Robert, John and <br> Carlos</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-20.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">WS</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Wendy, Star and <br> David</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-21.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-success border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">BR</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Byron, Roman and <br> Bailey</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-01.jpg" alt=""></a>
									...
									<div>
										<div class="card kanban-card border">
											<div class="card-body">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-16.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">IC</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Irene, Charles and <br> Wilston</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-22.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">HT</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Jody, Powell and <br> Cecil</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-23.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-success border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">BL</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Bonnie, Linda and <br> Mullin</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-24.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-purple border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">CJ</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Carlos, Jones and <br> Jim</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-25.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-danger border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">FJ</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Freda,Jennfier and <br> Thompson</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-17.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-purple border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">BF</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Bruce, Faulkner and <br> Lela</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-26.jpg" alt=""></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-warning border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="deals-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">LP</span></a>
														<h6 class="fw-medium"><a href="deals-details.php">Lawrence, Patrick and <br> Vandorn</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="avatar avatar-md flex-shrink-0 me-2"><img src="assets/img/profiles/avatar-15.jpg" alt=""></a>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="deals-kanban.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
