							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="activity-meeting.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
										...
										<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="active-list">
												<ul class="mb-0">
													...
													<li>
														<a href="activity-task.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Task"><i class="ti ti-subtask"></i></a>
													</li>
													<li>
														<a href="activity-meeting.php" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
													</li>
												</ul>
											</div>
										</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="activity-meeting.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal custom-modal fade" id="add_contacts" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="activity-meeting.php">
							<div class="mb-2 icon-form">
								<span class="form-icon"><i class="ti ti-search"></i></span>
