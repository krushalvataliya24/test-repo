							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="leads-kanban.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="leads.php" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<ul class="d-flex align-items-center">
									<li>
										<div class="view-icons me-2">
											<a href="leads.php"><i class="ti ti-list-tree"></i></a>
											<a href="leads-kanban.php" class="active"><i class="ti ti-grid-dots"></i></a>
										</div>
									</li>
									<li>
											...
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">SM</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Schumm</a></h6>
													</div>
												</div>
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-09.svg" class="w-auto h-auto" alt=""></span>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">CS</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Collins</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-01.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">KI</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Konopelski</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-02.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													...
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">AS</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Adams</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-03.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-warning border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">WK</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Wizosk</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-04.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-success border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">HR</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Heller</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-05.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-success border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">GI</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Gutkowsi</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-06.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-danger border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">WR</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Walter</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-07.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-purple border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">HN</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Hansen</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-08.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-danger border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">SE</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Steve</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-success border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">LE</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Leuschke</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
												...
												<div class="d-flex align-items-center justify-content-between border-top pt-3 mt-3">
													<span class="avatar avatar-sm border rounded d-flex align-items-center justify-content-center"><img src="assets/img/icons/company-icon-10.svg" class="w-auto h-auto" alt=""></span>
													<div class="icons-social d-flex align-items-center">
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-phone-check"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center me-1"><i class="ti ti-message-circle-2"></i></a>
														<a href="#" class="d-flex align-items-center justify-content-center"><i class="ti ti-color-swatch"></i></a>
										...
										<div class="card kanban-card border">
											<div class="card-body">
												<div class="d-block">
													<div class="bg-warning border border-2 mb-3"></div>
													<div class="d-flex align-items-center mb-3">
														<a href="leads-details.php" class="avatar avatar-lg bg-gray flex-shrink-0 me-2"><span class="avatar-title text-dark">AY</span></a>
														<h6 class="fw-medium"><a href="leads-details.php">Anthony</a></h6>
													</div>
												</div>
												<div class="mb-3 d-flex flex-column">
													<p class="text-default d-inline-flex align-items-center mb-2">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="leads-kanban.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								...
								<a href="leads-details.php" class="btn btn-primary">View Details</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="#" class="btn btn-light" data-bs-dismiss="modal">Cancel</a>
								<a href="company-details.php" class="btn btn-primary">View Details</a>
							</div>
						</div>
					</div>
				</div>
