        ...
        <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-01">
                <div class="d-flex align-items-center justify-content-center flex-wrap vh-100 overflow-auto p-4 w-50 bg-backdrop">
                    <form action="index.php" class="needs-validation flex-fill">
                        <div class="mx-auto mw-450">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" value="user@example.com" required>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="col-form-label">Password</label>
                                <div class="pass-group">
                                    <input type="password" class="pass-input form-control" id="password" name="password" value="123456" required>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="text-end">
                                    <a href="forgot-password.php" class="text-primary fw-medium link-hover">Forgot Password?</a>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <h6>New on our platform?<a href="register.php" class="text-purple link-hover"> Create an account</a></h6>
                            </div>
