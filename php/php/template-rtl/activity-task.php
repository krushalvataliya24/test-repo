...
<body>
	...
	<div class="main-wrapper">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="activity-task.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
						...
						<div class="card">
							...
							<div class="card-body">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
										<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="active-list">
												<ul class="mb-0">
													<li>
														<a href="activity-calls.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Calls"><i class="ti ti-phone"></i></a>
													</li>
													<li>
														<a href="activity-mail.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
													</li>
													<li>
														<a href="activity-task.php" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Task"><i class="ti ti-subtask"></i></a>
													</li>
													<li>
														<a href="activity-meeting.php" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
													</li>
												</ul>
											</div>
										</div>
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="activities.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
								...
								<div class="table-responsive custom-table">
									<table class="table" id="activity-task">
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit">
			...
			<div class="offcanvas-body">
				<form action="activity-calls.php">
											...
											<ul class="radio-activity">
												...
												<li>
													<div class="active-type">
														...
														<label for="shares2"><i class="ti ti-user-share"></i>Meeting</label>
													</div>
												</li>
											</ul>
										</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="activity-task.php" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
