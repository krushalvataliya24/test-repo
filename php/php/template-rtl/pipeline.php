							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="pipeline.php" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="card-body">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="pipeline.php" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_pipeline"><i class="ti ti-square-rounded-plus me-2"></i>Add Pipeline</a>
									</div>
								</div>
								<!-- /Filter -->
		...
		<div class="offcanvas-body">
			<form action="pipeline.php">
				...
				<div class="d-flex align-items-center justify-content-end">
					...
					<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="delete_pipeline">Create</button>
				</div>
			</form>
		</div>
				...
				<div class="modal-body">
					<div class="text-center">
						...
						<div class="d-flex align-items-center justify-content-center mt-4">
							...
							<a href="pipeline.php" class="btn btn-danger">Yes, Delete it</a>
						</div>
					</div>
				</div>
			</div>
