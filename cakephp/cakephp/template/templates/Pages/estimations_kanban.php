			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="estimations_kanban" data-bs-toggle="tooltip"
						...
						<!-- Filter -->
						<div
							class="d-flex align-items-center justify-content-between flex-wrap mb-4 row-gap-2 border-top pt-4 mt-4">
							...
							<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="accordion" id="accordionExample">
												<div class="filter-set-content">
													<div class="filter-set-content-head">
														<a href="#" data-bs-toggle="collapse" data-bs-target="#collapse"
															aria-expanded="true" aria-controls="collapse">Client</a>
													</div>
								...
								<div class="view-icons">
									<a href="estimations"><i class="ti ti-list-tree"></i></a>
									<a href="estimations_kanban" class="active"><i class="ti ti-grid-dots"></i></a>
								</div>
							</div>
						</div>
						<!-- /Filter -->
										...
										<div class="card kanban-card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between">
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);"
															class="avatar avatar-md rounded flex-shrink-0 me-2">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="estimations_kanban" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
