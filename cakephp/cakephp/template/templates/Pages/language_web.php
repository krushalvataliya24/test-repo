							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="language_web" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="card">
											...
											<div class="row gy-3">
														...
														<div class="d-flex align-items-center">
															<div class="lang-flag me-2">
																<a href="javascript:void(0);">
																	<?php echo $this->Html->image('icons/flag-02.svg', [
													'alt' => 'Flag'
												]); ?><span>Arabic</span>
																</a>
															</div>
												...
												<div class="col-xl-7 col-md-9 col-lg-12">
													<div
														...
														<a href="language" class="btn btn-primary"><i
																class="ti ti-arrow-narrow-left me-2"></i>Back to
															Translation</a>
													</div>
												</div>
											</div>
									...
									<div class="card-body">
													...
													<div class="border-top pt-3">
														<div
															...
															<p class="mb-0 d-flex align-items-center"><i
																	class="ti ti-grip-vertical me-2"></i>Medium</p>
														...
														<div
															class="d-flex align-items-center justify-content-between mb-3">
															<p class="mb-0 d-flex align-items-center"><i
																	class="ti ti-grip-vertical me-2"></i>File</p>
															<div class="status-toggle">
										...
										<div class="table-responsive custom-table">
											<table class="table" id="language_web">
					...
					<form action="language_web">
						<div class="modal-body pb-0">
							<div class="translate-item">
								...
								<a href="language" class="btn btn-primary"><i
										class="ti ti-arrow-narrow-left me-2"></i>Back to Translation</a>
							</div>
