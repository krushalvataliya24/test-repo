				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="campaign" data-bs-toggle="tooltip" data-bs-placement="top"
						...
						<div class="campaign-tab">
							<ul class="nav">
								<li>
									<a href="campaign" class="active">Active Campaign<span>24</span></a>
								</li>
								<li>
									<a href="campaign_complete">Completed Campaign</a>
								</li>
								<li>
