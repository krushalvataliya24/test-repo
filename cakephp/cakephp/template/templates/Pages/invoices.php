							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="invoices" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
										<div class="dropdown me-2">
											...
											<div class="dropdown-menu  dropdown-menu-md-end dropdown-md p-3">
												...
												<div class="border-top pt-3">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Balance Amount</p>
														<div class="status-toggle">
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" class="collapsed" data-bs-toggle="collapse"
																	...
																	aria-expanded="false"
																	aria-controls="collapseThree">Project</a>
															</div>
															<div class="filter-set-contents accordion-collapse collapse"
										...
										<div class="view-icons">
											<a href="invoices" class="active"><i class="ti ti-list-tree"></i></a>
											<a href="invoice_grid"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- /Filter -->
									...
									<table class="table datatable">
										...
										<tbody>
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															<?php echo $this->Html->image('icons/company-icon-01.svg', [
																'alt' => 'User Image',
																'class' => 'w-auto h-auto'
															]); ?></a><a href="company_details"
															class="d-flex flex-column">NovaWave LLC</a></h2>
												</td>
												<td>
												...
												<td>$2,15,000</td>
												<td>$0</td>
												<td><span class="badge badge-pill badge-status bg-warning">Partially
														Paid</span></td>
												<td>
													<div class="dropdown table-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="javascript:void(0);"><i
																...
																Invoices</a>
															<a class="dropdown-item" href="javascript:void(0);"><i
																	class="ti ti-checks text-success"></i> Mark as
																Paid</a>
															<a class="dropdown-item" href="javascript:void(0);"><i
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">BlueSky Industries</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
												...
												<td>$1,45,000</td>
												<td>$0</td>
												<td><span class="badge badge-pill badge-status bg-success">Paid</span>
												</td>
												<td>
													<div class="dropdown table-action">
														<a href="#" class="action-icon " data-bs-toggle="dropdown"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">Silver Hawk</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">Summit Peak</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">RiverStone Ventur</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
												...
												<td>$0</td>
												<td>$2,12,000</td>
												<td><span class="badge badge-pill badge-status bg-danger">Unpaid</span>
												</td>
												<td>
													<div class="dropdown table-action">
														<a href="#" class="action-icon " data-bs-toggle="dropdown"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">CoastalStar Co.</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">HarborView</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
												...
												<td>$1,23,000</td>
												<td>$1,23,000</td>
												<td><span class="badge badge-pill badge-status bg-violet">Overdue</span>
												</td>
												<td>
													<div class="dropdown table-action">
														<a href="#" class="action-icon " data-bs-toggle="dropdown"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">Golden Gate Ltd</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															class="d-flex flex-column">Redwood Inc</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
									...
									<div class="mb-0">
										...
										<div class="upload-signature ">
											...
											<a href="#" class="text-start">
												<?php echo $this->Html->image('signature.png', [
													'alt' => 'Image'
												]); ?>
											</a>
										</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="invoices" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
