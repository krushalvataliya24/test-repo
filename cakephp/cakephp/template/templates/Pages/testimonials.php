							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="testimonials" data-bs-toggle="tooltip" data-bs-placement="top"
												...
												<div class="border-top pt-3">
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>User Name</p>
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Content</p>
														<div class="status-toggle">
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" data-bs-toggle="collapse"
																	...
																	aria-controls="collapseTwo">Owner</a>
															</div>
							...
							<div class="mb-3">
								<div class="profile-upload">
									<div class="profile-upload-img">
                                        ...
                                        <?php echo $this->Html->image('profiles/avatar-20.jpg', ['alt' => 'Image','class'=>'preview1']); ?>
							...
							<div class="mb-3">
								<div class="profile-upload">
									<div class="profile-upload-img">
                                        ...
                                        <?php echo $this->Html->image('profiles/avatar-20.jpg', ['alt' => 'img','class'=>'preview1']); ?>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								<a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="testimonials" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
