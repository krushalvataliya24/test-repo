							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="invoice_settings" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="invoice_settings" class="fw-medium active">Invoice
													Settings</a>
														...
														<div class="profile-upload">
															<div class="profile-upload-img">
																<span><i class="ti ti-photo"></i></span>
                                                                    ...
                                                                    <?php echo $this->Html->image('theme/theme-01.jpg', ['alt' => 'img','class'=>'preview1','id'=>'ImgPreview']); ?>
															...
															<div class="profile-upload-content">
																...
																<p>Upload Logo of your company to display in website(JPG
																	or PNG). Max size of 800K</p>
															</div>
														</div>
													</div>
												</div>
