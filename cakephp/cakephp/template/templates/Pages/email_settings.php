							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="email_settings" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="email_settings" class="fw-medium active">Email
													Settings</a>
								...
								<div class="card">
									<div class="card-body">
										<div class="d-flex align-items-center justify-content-between mb-4">
											...
											<a href="javascript:void(0)" class="btn-add" data-bs-toggle="modal"
												data-bs-target="#add_mail"><i class="ti ti-mail"></i></a>
										</div>
										<div class="row">
												...
												<div class="border rounded p-3 mb-4">
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
                                                                        ...
                                                                        <?php echo $this->Html->image('icons/mail-01.svg', ['alt' => '','class'=>'w-auto h-auto']); ?>
															...
															<div
																...
																<div>
																	<a href="javascript:void(0);"
																		...
																		class="info-icon me-3 text-default"><i
																			class="ti ti-info-circle-filled me-1"></i></a>
																	<a href="#" class="btn btn-light"
																		data-bs-toggle="modal"
																		data-bs-target="#add_phpmail"><i
													...
													<div class="collapse" id="php-mail">
														<div class="mail-collapse">
															<p>PHPMailer is a third-party PHP library that provides a
													...
													<div class="row gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
                                                                        ...
                                                                        <?php echo $this->Html->image('icons/mail-02.svg', ['alt' => '','class'=>'w-auto h-auto']); ?>
														...
														<div class="col-sm-7">
															<div
																...
																<div>
																	<a href="javascript:void(0);"
																		class="me-3 text-default"><i
																			class="ti ti-info-circle-filled me-1"></i></a>
																	<a href="#" class="btn btn-light"
																		data-bs-toggle="modal"
																		data-bs-target="#add_smtp"><i
																			class="ti ti-tool me-1"></i>View
																		Integration</a>
																</div>
																<div class="status-toggle">
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
                                                                        ...
                                                                        <?php echo $this->Html->image('icons/mail-03.svg', ['alt' => '','class'=>'w-auto h-auto']); ?>
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="email_settings">
						<div class="modal-body">
							<div class="mb-0">
								<label class="col-form-label">Enter Email Address <span
										class="text-danger">*</span></label>
								<input type="text" class="form-control">
							</div>
						</div>
