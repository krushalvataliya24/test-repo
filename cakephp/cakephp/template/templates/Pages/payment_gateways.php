							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="payment_gateways" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="payment_gateways" class="fw-medium active">Payment
													Gateways</a>
												<a href="bank_accounts" class="fw-medium">Bank Accounts</a>
												<a href="tax_rates" class="fw-medium">Tax Rates</a>
												<a href="currencies" class="fw-medium">Currencies</a>
											</div>
										</div>
									</div>
								</div>
											...
											<div class="col-md-12">
												...
												<div class="border rounded p-3 mb-4">
													<div class="row gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
															 ...
															 <?php echo $this->Html->image('icons/payment-01.svg', ['alt' => '']); ?> 
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-success">Connected</a>
																</div>
															</div>
														</div>
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail1" class="check"
																		checked="">
													...
													<div class="collapse pt-3 mt-3 border-top" id="php-mail">
														<div>
															<p>PayPal Holdings, Inc. is an American multinational
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-02.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-purple text-purple">Not
																		Connected</a>
																</div>
															</div>
														</div>
															...
															<div
																...
																<div>
																	...
																	<a href="#" class="btn btn-primary"><i
																			class="ti ti-plug-connected me-1"></i>Connect
																		Now</a>
																</div>
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail2" class="check"
																		checked="">
													...
													<div class="collapse pt-3 mt-3 border-top" id="collapse1">
														<div>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
																...
																viverra non eros in, condimentum vulputate libero.
																Phasellus eu orci et felis maximus posuere.</p>
														</div>
													</div>
												</div>
												<!-- /Payment -->
													...
													<div class="row  gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-03.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-purple text-purple">Not
														...
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail3" class="check"
																		checked="">
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-04.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-success">Connected</a>
													...
													<div class="row  gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-05.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-purple text-purple">Not
														...
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail5" class="check"
																		checked="">
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-06.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-success">Connected</a>
													...
													<div class="row  gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-07.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-purple text-purple">Not
														...
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail7" class="check"
																		checked="">
													...
													<div class="row  gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-08.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-success">Connected</a>
														...
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail8" class="check"
																		checked="">
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-09.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-success">Connected</a>
													...
													<div class="row  gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span
                                                                    ...
                                                                    <?php echo $this->Html->image('icons/payment-10.svg', ['alt' => '']); ?>
																</span>
																<div class="ms-2">
																	<a href="javascript:void(0);"
																		class="badge bg-soft-purple text-purple">Not
														...
														<div class="col-sm-7">
															<div
																...
																<div class="status-toggle ms-auto">
																	<input type="checkbox" id="mail10" class="check"
																		checked="">
		...
		<div class="modal fade" id="add_paypal" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="payment_gateways">
						<div class="modal-body">
							<div class="mb-3">
								<label class="col-form-label">From Email Address <span
