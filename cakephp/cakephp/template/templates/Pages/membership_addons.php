					...
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="membership_addons" data-bs-toggle="tooltip"
						...
						<div class="card">
							<div class="card-body">
								...
								<form action="membership_addons">
									<div class="row">
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Addon Name <span
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Contacts <span
														class="text-danger">*</span></label>
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Compaigns <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Leads <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Tasks <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Companies <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Pipelines <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Projects <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
										...
										<div class="col-lg-4 col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Activities <span
														class="text-danger">*</span></label>
												<div class="d-flex align-items-center">
													<input type="text" class="form-control" value="0-100">
													<div class="status-toggle ms-3">
