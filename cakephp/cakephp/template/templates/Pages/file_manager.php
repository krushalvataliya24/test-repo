...
<body>
						...
						<aside class="card file-manager-sidebar mb-0">
							...
							<div class="dropdown">
								<a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false"
									...
									<span class="me-1 w-auto btn-icon d-flex align-items-center"><i
											data-feather="plus-circle" class="feather-16"></i></span>New
								</a>
							...
							<ul class="mb-3">
								<li><a href="file_manager" class="active"><span class="me-2 btn-icon"><i
								...
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="file"
												class="feather-16"></i></span>Shared With Me</a></li>
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="file"
												class="feather-16"></i></span>Document</a></li>
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="clock"
												class="feather-16"></i></span>Recent</a></li>
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="star"
												class="feather-16"></i></span>Favourites</a></li>
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="target"
												class="feather-16"></i></span>Archived</a></li>
								<li><a href="javascript:void(0);"><span class="me-2 btn-icon"><i data-feather="trash-2"
												class="feather-16"></i></span>Deleted</a></li>
									...
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center">
													<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Folder']); ?>
</span>
										</a>
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center"><?php echo $this->Html->image('icons/pdf-02.svg', ['alt' => 'Folder']); ?>
													</span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											...
											<span class="d-flex align-items-center justify-content-center">
													<?php echo $this->Html->image('icons/image.svg', ['alt' => 'Folder']); ?>
												</span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											class="d-flex align-items-center justify-content-center bg-light-red bg p-4">
											<span class="d-flex align-items-center justify-content-center">
													<?php echo $this->Html->image('icons/video.svg', ['alt' => 'Folder']); ?></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
								...
								<div class="col-sm-6 col-md-3">
									<div class="detail">
										<a href="javascript:void(0);"
											class="d-flex align-items-center justify-content-center bg-light-orange bg p-4">
											<span class="d-flex align-items-center justify-content-center">
													<?php echo $this->Html->image('icons/audio.svg', ['alt' => 'Folder']); ?></span>
										</a>
										<div class="d-flex align-items-center justify-content-between info">
									...
									<div class="accordion-body">
										<div class="owl-carousel folders-carousel owl-theme">
											<div class="folders p-3">
												<div class="d-flex align-items-center justify-content-between head">
													<div class="d-flex align-items-center">
															...
															<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Folder','class'=>'me-2']); ?></span>
													...
													<div class="group-avatar">
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																...
																<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 2"
																data-bs-original-title="Member 2">
																	<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Avatar']); ?>
																</a>
														</span>
											...
											<div class="folders p-3">
												<div class="d-flex align-items-center justify-content-between head">
													<div class="d-flex align-items-center">
															...
															<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Folder','class'=>'me-2']); ?>
														<h6 class="popup-toggle"><a href="javascript:void(0);">Project
																Details</a></h6>
													</div>
													<div class="dropdown">
												...
												<div
													...
													<div class="group-avatar">
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 1"
																data-bs-original-title="Member 1"><?php echo $this->Html->image('profiles/avatar-06.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 2"
																data-bs-original-title="Member 2"><?php echo $this->Html->image('profiles/avatar-14.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 3"
																data-bs-original-title="Member 3"><?php echo $this->Html->image('profiles/avatar-15.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 4"
																data-bs-original-title="Member 4"><?php echo $this->Html->image('profiles/avatar-16.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 5"
																data-bs-original-title="Member 5"><?php echo $this->Html->image('profiles/avatar-17.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="count d-block">
											...
											<div class="folders p-3">
												<div class="d-flex align-items-center justify-content-between head">
													<div class="d-flex align-items-center">
														<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Avatar','class'=>'me-2']); ?>
														<h6 class="popup-toggle"><a href="javascript:void(0);">Project
																Details</a></h6>
													</div>
													<div class="dropdown">
												...
												<div
													...
													<div class="group-avatar">
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 1"
																data-bs-original-title="Member 1"><?php echo $this->Html->image('profiles/avatar-18.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 2"
																data-bs-original-title="Member 2"><?php echo $this->Html->image('profiles/avatar-05.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="count d-block">
															<a href="javascript:void(0);">
																+2 Members</a>
													...
													<div class="group-avatar">
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 1"
																data-bs-original-title="Member 1">
																	<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 2"
																data-bs-original-title="Member 2"><?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 3"
																data-bs-original-title="Member 3"><?php echo $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="avatar">
															<a href="javascript:void(0);" data-bs-toggle="tooltip"
																data-bs-placement="right" aria-label="Member 4"
																data-bs-original-title="Member 4"><?php echo $this->Html->image('profiles/avatar-04.jpg', ['alt' => 'Avatar']); ?></a>
														</span>
														<span class="count d-block">
															<a href="javascript:void(0);">1 Members</a>
														</span>
											...
											<div class="folders p-3">
												<div class="d-flex align-items-center justify-content-between head">
													<div class="d-flex align-items-center">
														...
														<?php echo $this->Html->image('icons/pdf-02.svg', ['alt' => 'File','class'=>'me-2']); ?>
											...
											<div class="folders p-3">
												<div class="d-flex align-items-center justify-content-between head">
													<div class="d-flex align-items-center">
														...
														<?php echo $this->Html->image('icons/xls.svg', ['alt' => 'File','class'=>'me-2']); ?>
														<h6 class="popup-toggle"><a
							...
							<div class="accordion-item mb-4">
								<h4 class="accordion-header d-flex align-items-center justify-content-between"
									...
									<a href="javascript:void(0);" class="accordion-button w-auto"
										...
										aria-expanded="false" aria-controls="panelsStayOpen-collapseThree"></a>
								</h4>
									...
									<div class="accordion-body">
										<div class="owl-carousel video-section">
											...
											<div class="item">
												<div>
													<video width="100" height="100" class="js-player" crossorigin
														playsinline poster=
														"<?php echo $this->Url->build('/img/file-manager/video1.jpg'); ?>">
														<source
												...
												<div class="info">
													<div class="d-flex align-items-center justify-content-between">
														<h6 class="popup-toggle"><a
																href="javascript:void(0);">Demo_dw</a></h6>
														<div class="d-flex align-items-center">
															<a href="javascript:void(0);"
																class="d-flex align-items-center"><i data-feather="star"
																	class="feather-16 me-2"></i></a>
															<div class="dropdown">
																<a href="javascript:void(0);" data-bs-toggle="dropdown"
																	aria-expanded="false" class="dropset">
																	<i class="fa fa-ellipsis-v"></i>
											...
											<div class="item">
												<div>
													<video class="js-player" crossorigin playsinline
														poster=
														"<?php echo $this->Url->build('/img/file-manager/video2.jpg'); ?>">
														<source
															src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
															type="video/mp4">
													</video>
											...
											<div class="item">
												<div>
													<video class="js-player" crossorigin playsinline
														poster="<?php echo $this->Url->build('/img/file-manager/video3.jpg'); ?>">
														<source
															src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-720p.mp4"
															type="video/mp4">
													</video>
										...
										<tr>
											...
											<td class="productimgname">
												<a href="javascript:void(0);"
													...
													<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Product','class'=>'me-2']); ?>
													<span>Digimed</span>
												</a>
											</td>
											...
											<td>
												<a href="javascript:void(0);"
													class="product-img d-flex align-items-center">
														...
														<?php echo $this->Html->image('profiles/avatar-06.jpg', ['alt' => 'Product','class'=>'me-2 rounded-circle']); ?>
										...
										<tr>
											...
											<td class="productimgname">
												<a href="javascript:void(0);"
													...
													<?php echo $this->Html->image('icons/xls.svg', ['alt' => 'Product','class'=>'me-2']); ?>
											...
											<td>
												<a href="javascript:void(0);"
													class="product-img d-flex align-items-center">
														...
														<?php echo $this->Html->image('profiles/avatar-05.jpg', ['alt' => 'Product','class'=>'me-2 rounded-circle']); ?>
										...
										<tr>
											...
											<td class="productimgname">
												<a href="javascript:void(0);"
													...
													<?php echo $this->Html->image('icons/pdf-02.svg', ['alt' => 'Product','class'=>'me-2']); ?>
													<span>Intro.pdf</span>
												</a>
											</td>
											<td>27 July 2023</td>
											...
											<td>
												<a href="javascript:void(0);"
													class="product-img d-flex align-items-center">
														...
														<?php echo $this->Html->image('profiles/avatar-10.jpg', ['alt' => 'Product','class'=>'me-2 rounded-circle']); ?>
													<span>Me</span>
												</a>
											</td>
											<td class="text-end">
										...
										<tr>
											...
											<td class="productimgname">
												<a href="javascript:void(0);"
													...
													<?php echo $this->Html->image('icons/video.svg', ['alt' => 'Product','class'=>'me-2']); ?>
											...
											<td>
												<a href="javascript:void(0);"
													class="product-img d-flex align-items-center">
														...
														<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Product','class'=>'me-2 rounded-circle']); ?>
													<span>Daniel</span>
												</a>
											</td>
											<td>
										...
										<tr>
											...
											<td class="productimgname">
												<a href="javascript:void(0);"
													...
													<?php echo $this->Html->image('icons/audio.svg', ['alt' => 'Product','class'=>'me-2']); ?>
													<span>voice.mp3</span>
												</a>
											</td>
											<td>27 July 2023</td>
											...
											<td>
												<a href="javascript:void(0);"
													class="product-img d-flex align-items-center">
													<?php echo $this->Html->image('profiles/avatar-07.jpg', ['alt' => 'Product','class'=>'me-2 rounded-circle']); ?>
	...
	<div class="toggle-sidebar">
		...
		<div class="text-center">
			<a href="javascript:void(0);">
			<?php echo $this->Html->image('file-manager/folder-lg.png', ['alt' => 'Folder']); ?></a>
					...
					<div class="avatar-access d-flex align-items-center mb-4">
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
								aria-label="Member 1" data-bs-original-title="Member 1">
									<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
								aria-label="Member 2" data-bs-original-title="Member 2">
									<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
								aria-label="Member 3" data-bs-original-title="Member 3">
									<?php echo $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
								aria-label="Member 4" data-bs-original-title="Member 4">
									<?php echo $this->Html->image('profiles/avatar-04.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
						</span>
						<span>
							<a href="javascript:void(0);"
			...
			<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
				...
				<ul class="mb-4">
					<li class="mb-4">
						...
						<p class="d-flex align-items-center location border-0">
								<?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Folder','class'=>'me-2']); ?>Website Backup for the Design team</p>
					</li>
					<li class="mb-4">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
				...
				<ul class="mb-4">
					...
					<li class="mb-4">
						...
						<p class="d-flex align-items-center location border-0"><?php echo $this->Html->image('icons/folder.svg', ['alt' => 'Folder','class'=>'me-2']); ?>Website Backup for the Design team</p>
					</li>
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3">
					...
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><?php echo $this->Html->image('profiles/avatar-04.jpg', ['alt' => 'Avatar','class'=>'avatar-md']); ?></a>
							<div>
								<p class="mb-0 text-secondary">Drake</p>
								<p class="mb-0">Editor</p>
							</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="drag-drop text-center mb-4">
						<div class="upload">
							<a href="#">
							<?php echo $this->Html->image('icons/drag-drop.svg', ['alt' => '']); ?></a>
					...
					<ul>
						...
						<li class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center w-85">
								...
								<?php echo $this->Html->image('icons/xls.svg', ['alt' => 'Folder','class'=>'me-2']); ?>
								<div class="flex-fill">
						...
						<li class="d-flex align-items-center justify-content-between">
							<div class="d-flex align-items-center w-85">
								...
								<?php echo $this->Html->image('icons/zip.svg', ['alt' => 'Folder','class'=>'me-2']); ?>
								<div class="flex-fill">
	...
	<!-- Upload Folder -->
	<div class="modal fade custom-modal file-manager-modal upload-modal" id="upload-folder"
	...
	<!-- Upload Folder -->
	<div class="modal fade custom-modal file-manager-modal upload-message" id="upload-message"
	...
	<!-- Create Folder -->
	<div class="modal fade custom-modal file-manager-modal" id="create-folder" aria-labelledby="create-folder">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5>Create Folder</h5>
