							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="manage_users" data-bs-toggle="tooltip" data-bs-placement="top"
										...
										<div class="dropdown me-2">
											...
											<div class="dropdown-menu  dropdown-menu-md-end dropdown-md p-3">
												...
												<div class="border-top pt-3">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Last Activity</p>
														<div class="status-toggle">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="manage_users" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
