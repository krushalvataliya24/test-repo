			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-12">
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="invoice_grid" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="col-sm-8">
								<div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
									<div class="dropdown me-2">
										<a href="javascript:void(0);" class="dropdown-toggle bg-white"
						...
						<!-- Filter -->
						<div
							class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 border-top mt-4 pt-4 mb-4">
							<div class="d-flex align-items-center flex-wrap row-gap-2">
								<div class="sort-dropdown drop-down task-drops me-3">
									<a href="javascript:void(0);" class="dropdown-toggle bg-transparent"
							...
							<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="invoice_grid" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="view-icons">
									<a href="invoices"><i class="ti ti-list-tree"></i></a>
									<a href="invoice_grid" class="active"><i class="ti ti-grid-dots"></i></a>
								</div>
							</div>
						</div>
						<!-- /Filter -->
								...
								<div class="card border">
									<div class="card-body">
											...
											<div class="dropdown table-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="javascript:void(0);"><i
														...
														Invoices</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-checks text-success"></i> Mark as Paid</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-file text-tertiary"></i> Mark as Partially
														Paid</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-sticker text-blue"></i> Mark ad Unpaid</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);"
														class="avatar avatar-sm border flex-shrink-0 me-2">
											...
											<div class="mb-3">
												<p class="d-flex align-items-center mb-2"><span
														class="avatar avatar-xs border me-2 text-dark"><i
															class="ti ti-moneybag fs-12"></i></span>Total Value :
													$2,04,214</p>
												<p class="d-flex align-items-center mb-2"><span
														class="avatar avatar-xs border me-2 text-dark"><i
															class="ti ti-calendar-event fs-12"></i></span>Due Date : 15
													May 2024</p>
												<p class="d-flex align-items-center mb-2"><span
														class="avatar avatar-xs border me-2 text-dark"><i
															class="ti ti-calendar-stats fs-12"></i></span>Paid Amount :
													2,15,000</p>
												<p class="d-flex align-items-center"><span
														class="avatar avatar-xs border me-2 text-dark"><i
															class="ti ti-calendar-stats fs-12"></i></span>Balance Amount
													: 2,15,000</p>
											</div>
										</div>
										<div class="bg-light-400 rounded p-2">
											<div class="d-flex align-items-center">
												<a href="javascript:void(0);"
													class="avatar avatar-sm bg-white border me-2">
									...
									<div class="card-body">
										...
										<div class="bg-light-400 rounded p-2">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column">
													<span class="d-block">Client</span>
													<a href="javascript:void(0);" class="text-default">RiverStone
														Ventur</a>
												</div>
											</div>
										</div>
						...
						<div class="load-btn text-center pb-4">
							<a href="javascript:void(0);" class="btn btn-primary">Load More Invoices<i
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="invoice_grid" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
