                ...
                <div class="d-flex align-items-center justify-content-center flex-fill flex-wrap vh-100 overflow-auto">
                    <div class="login-shapes">
                        <div class="login-right-shape">
                            ...
                            <?php echo $this->Html->image('authentication/shape-01.png', ['alt' => 'Shape']); ?>
                        </div>
                        <div class="login-left-shape">
                            
                            <?php echo $this->Html->image('authentication/shape-02.png', ['alt' => 'Shape']); ?>
                        </div>
                    </div>
                    <div class="container">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xxxl rounded-circle mb-4">
                                                                <?php echo $this->Html->image('profiles/avatar-14.jpg', ['alt' => 'Profile','class'=>'img-fluid rounded-circle']); ?></span>
