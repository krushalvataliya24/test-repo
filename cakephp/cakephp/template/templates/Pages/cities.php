							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="cities" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="col-sm-8">
										<div
											...
											<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
												data-bs-target="#add_city"><i
													class="ti ti-square-rounded-plus me-2"></i>Add City</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
										...
										<div class="dropdown me-2">
											...
											<div class="dropdown-menu  dropdown-menu-md-end dropdown-md p-3">
												...
												<div class="border-top pt-3">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>State Name</p>
														<div class="status-toggle">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>City Name</p>
														<div class="status-toggle">
												...
												<div class="filter-set-view">
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" class="collapsed" data-bs-toggle="collapse"
																	...
																	aria-controls="Status">State Name</a>
															</div>
															<div class="filter-set-contents accordion-collapse collapse"
																id="State" data-bs-parent="#accordionExample">
																<div class="filter-content-list">
																	<ul>
																		<li>
																			<div class="filter-checks">
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" class="collapsed" data-bs-toggle="collapse"
																	...
																	aria-controls="Status">City Name</a>
															</div>
															<div class="filter-set-contents accordion-collapse collapse"
																id="City" data-bs-parent="#accordionExample">
																<div class="filter-content-list">
																	<ul>
																		<li>
																			<div class="filter-checks">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="cities" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="text-center">
							...
							<h4 class="mb-2">Remove City?</h4>
							<p class="mb-0">Are you sure you want to remove it</p>
							<div class="d-flex align-items-center justify-content-center mt-4">
								<a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="cities" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
