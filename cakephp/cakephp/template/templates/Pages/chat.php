...
<head>
	...
	<!-- Swiper CSS -->
	<?php echo $this->Html->css('plugins/swiper/swiper.min.css') ?>
</head>
...
<body class="main-chat-blk">
										...
										<div class="swiper-slide">
											<div class="top-contacts-box">
												<div class="profile-img online">
													...
													<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => '']); ?>
												</div>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="top-contacts-box">
												<div class="profile-img online">
													...
													<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => '']); ?>
												</div>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="top-contacts-box">
												<div class="profile-img online">
													...
													<?php echo $this->Html->image('profiles/avatar-07.jpg', ['alt' => '']); ?>
												</div>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="top-contacts-box">
												<div class="profile-img online">
													...
													<?php echo $this->Html->image('profiles/avatar-05.jpg', ['alt' => '']); ?>
												</div>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="top-contacts-box">
												<div class="profile-img online">
													...
													<?php echo $this->Html->image('profiles/avatar-03.jpg', ['alt' => '']); ?>
												</div>
											</div>
										</div>
										<div class="swiper-slide">
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar avatar-online">
												...
												<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar ">
												...
												<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar avatar-online">
												...
												<?php echo $this->Html->image('profiles/avatar-05.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar avatar-online">
												...
												<?php echo $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>Horace Keene</h5>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar">
												...
												<?php echo $this->Html->image('profiles/avatar-04.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>James Albert</h5>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar avatar-online">
												...
												<?php echo $this->Html->image('profiles/avatar-09.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>Debra Jones</h5>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar ">
												...
												<?php echo $this->Html->image('profiles/avatar-07.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>Dina Brown</h5>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar avatar-online">
												...
												<?php echo $this->Html->image('profiles/avatar-08.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>Judy Mercer</h5>
									...
									<li class="user-list-item">
										<a href="javascript:void(0);">
											<div class="avatar">
												...
												<?php echo $this->Html->image('profiles/avatar-06.jpg', ['alt' => 'image', 'class' => 'rounded-circle']); ?>
											</div>
											<div class="users-list-body">
												<div>
													<h5>Richard Ohare</h5>
						...
						<div class="chat-header">
							...
							<div class="chat-options ">
								<ul class="list-inline">
									...
									<li class="list-inline-item">
										<a href="video_call" class="btn btn-outline-light" data-bs-toggle="tooltip"
											data-bs-placement="bottom" title="Video Call">
											<i class="bx bx-video"></i>
										</a>
									</li>
									<li class="list-inline-item">
										<a href="audio_call" class="btn btn-outline-light" data-bs-toggle="tooltip"
							...
							<div class="messages">
								<div class="chats">
									<div class="chat-avatar">
										...
										<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'image', 'class' => 'rounded-circle dreams_chat']); ?>
									</div>
														...
														<div class="emoj-group-list">
															<ul>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-01.svg', ['alt' => 'Icon']); ?>
																	</a></li>
																<li><a href="javascript:void(0);"><?php echo $this->Html->image('icons/emoj-icon-02.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-03.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-04.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-05.svg', ['alt' => 'Icon']); ?></a></li>
								...
								<div class="chats chats-right">
									<div class="chat-content">
										...
										<div class="message-content ">
											<div class="emoj-group rig-emoji-group">
												<ul>
													<li class="emoj-action"><a href="javascript:void(0);"><i
														...
														<div class="emoj-group-list">
															<ul>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-01.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-02.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-03.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-04.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"> <?php echo $this->Html->image('icons/emoj-icon-05.svg', ['alt' => 'Icon']); ?></a></li>
											...
											<div class="chat-voice-group">
												<ul>
													<li><a href="javascript:void(0);"><span> <?php echo $this->Html->image('icons/play-01.svg', ['alt' => 'image']); ?></span></a></li>
													<li><?php echo $this->Html->image('icons/voice.svg', ['alt' => 'image']); ?></li>
													<li>0:05</li>
												</ul>
											</div>
										</div>
									...
									<div class="chat-avatar">
										...
										<?php echo $this->Html->image('profiles/avatar-10.jpg', ['alt' => 'image', 'class' => 'rounded-circle dreams_chat']); ?>
									</div>
								</div>
								<div class="chats">
									<div class="chat-avatar">
									...
									<div class="chat-content">
										...
										<div class="message-content award-link chat-award-link">
											...
											<?php echo $this->Html->image('sending-img.png', ['alt' => 'img']); ?>
											<div class="emoj-group">
												<ul>
													<li class="emoj-action"><a href="javascript:void(0);"><i
																class="bx bx-smile"></i></a>
														<div class="emoj-group-list">
															<ul>
																...
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-02.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-03.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"><?php echo $this->Html->image('icons/emoj-icon-04.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);"><?php echo $this->Html->image('icons/emoj-icon-05.svg', ['alt' => 'Icon']); ?></a></li>
																<li class="add-emoj"><a href="javascript:void(0);"><i
																			class="bx bx-plus"></i></a></li>
												...
												<ul class="nav mb-0">
													<li>
														<div class="image-download-col">
															<?php echo $this->Html->link(
																$this->Html->image('media/media-02.jpg', ['alt' => 'Img']),
																'/img/media/media-02.jpg',
																['data-fancybox' => 'gallery', 'class' => 'fancybox', 'escape' => false]
															); ?>
														</div>
													</li>
													<li>
														<div class="image-download-col ">
															<?php echo $this->Html->link(
																$this->Html->image('media/media-03.jpg', ['alt' => 'Img']),
																'/img/media/media-03.jpg',
																['data-fancybox' => 'gallery', 'class' => 'fancybox', 'escape' => false]
															); ?>
													...
													<li>
														<div class="image-download-col image-not-download">
															<?php echo $this->Html->link(
																$this->Html->image('media/media-01.jpg', ['alt' => 'Img']) . '<span>10+</span>',
																'/img/media/media-01.jpg',
																['data-fancybox' => 'gallery', 'class' => 'fancybox', 'escape' => false]
															); ?>
									...
									<div class="chat-content">
										...
										<div class="message-content review-files">
											<p class="d-flex align-items-center">Please check and review the files<span
													class="ms-1 d-flex">
													<?php echo $this->Html->image('icons/smile-chat.svg', ['alt' => 'Icon']); ?></span></p>
												...
												<ul>
													<li class="emoj-action"><a href="javascript:void(0);"><i
														...
														<div class="emoj-group-list">
															<ul>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-01.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-02.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-03.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-04.svg', ['alt' => 'Icon']); ?></a></li>
																<li><a href="javascript:void(0);">
																		<?php echo $this->Html->image('icons/emoj-icon-05.svg', ['alt' => 'Icon']); ?></a></li>
																<li class="add-emoj"><a href="javascript:void(0);"><i
																			class="bx bx-plus"></i></a></li>
															</ul>
														</div>
										...
										<div class="like-chat-grp">
											<ul>
												<li class="like-chat"><a href="javascript:void(0);">2
														<?php echo $this->Html->image('icons/like.svg', ['alt' => 'Icon']); ?></a></li>
												<li class="comment-chat"><a href="javascript:void(0);">2
														<?php echo $this->Html->image('icons/heart.svg', ['alt' => 'Icon']); ?></a></li>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="mt-0 right_sidebar_logo">
									<div class="text-center right-sidebar-profile">
										...
										<div class="chat-options chat-option-profile">
											<ul class="list-inline">
												<li class="list-inline-item">
													<a href="audio_call" class="btn btn-outline-light "
												...
												<li class="list-inline-item ">
													<a href="video_call" class="btn btn-outline-light profile-open"
														data-bs-toggle="tooltip" data-bs-placement="bottom"
														title="Video Call">
														<i class="bx bx-video"></i>
													</a>
									...
									<div class="tab-content pt-0" id="nav-tabContent">
										<div class="tab-pane fade show active" id="info">
											<ul class="nav share-media-img mb-0">
												<li>
													<a href="assets/img/media/media-01.jpg" data-fancybox="gallery"
														class="fancybox">

														<?php echo $this->Html->image('media/media-01.jpg', ['alt' => '']); ?>
													</a>
												</li>
												<li>
													<a href="assets/img/media/media-02.jpg" data-fancybox="gallery"
														class="fancybox">

														<?php echo $this->Html->image('media/media-02.jpg', ['alt' => '']); ?>
													</a>
												</li>
												<li>
													<a href="assets/img/media/media-03.jpg" data-fancybox="gallery"
														class="fancybox">

														<?php echo $this->Html->image('media/media-03.jpg', ['alt' => '']); ?>
													</a>
												</li>
												<li>
													<a href="assets/img/media/media-04.jpg" data-fancybox="gallery"
														class="fancybox">

														<?php echo $this->Html->image('media/media-04.jpg', ['alt' => '']); ?>
													</a>
												</li>
												<li>
													<a href="assets/img/media/media-05.jpg" data-fancybox="gallery"
														class="fancybox">

														<?php echo $this->Html->image('media/media-05.jpg', ['alt' => '']); ?>
													</a>
												</li>
												<li class="blur-media">
													<a href="assets/img/media/media-02.jpg" data-fancybox="gallery"
											...
											<ul class="nav share-media-img mb-0">
												<li>
													<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox
														...
														<?php echo $this->Html->image('media/media-01.jpg', ['alt' => 'img']); ?>
												...
												<li>
													<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox
														...
														<?php echo $this->Html->image('media/media-02.jpg', ['alt' => 'img']); ?>
														<span><i class="bx bx-play-circle"></i></span>
													</a>
												</li>
												<li>
													<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox
														...
														<?php echo $this->Html->image('media/media-03.jpg', ['alt' => 'img']); ?>
														<span><i class="bx bx-play-circle"></i></span>
													</a>
												</li>
												<li>
													<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox
														...
														<?php echo $this->Html->image('media/media-04.jpg', ['alt' => 'img']); ?>
														<span><i class="bx bx-play-circle"></i></span>
													</a>
												</li>
												<li>
													<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox
														...
														<?php echo $this->Html->image('media/media-05.jpg', ['alt' => 'img']); ?>
														<span><i class="bx bx-play-circle"></i></span>
													</a>
												</li>
												<li class="blur-media">
										...
										<div class="tab-pane fade" id="link">
											<div class="media-link-grp">
												<div class="link-img">
													<a href="javascript:void(0);">
														<?php echo $this->Html->image('media/media-link-01.jpg', ['alt' => 'img']); ?></a>
												</div>
											...
											<div class="media-link-grp mb-0">
												<div class="link-img">
													<a href="javascript:void(0);">
														<?php echo $this->Html->image('media/media-link-02.jpg', ['alt' => 'Img']); ?></a>
												</div>
												<div class="media-link-detail">
											...
											<div class="input-blocks">
												...
												<div class="input-groupicon">
													...
													<div class="addonset">
														...
														<?php echo $this->Html->image('icons/scanners.svg', ['alt' => 'img']); ?>
													</div>
												</div>
											</div>
										</div>
													...
													<table class="table">
														...
														<tbody>
															<tr>
																<td>
																	<div class="productimgname">
																		<a href="javascript:void(0);"
																			...
																			<?php echo $this->Html->image('supplier/stock-img-01.png', ['alt' => 'product']); ?>
																		</a>
																...
																<td>
																	<a class="delete-set">
																		<?php echo $this->Html->image('icons/delete.svg', ['alt' => 'svg']); ?></a>
																</td>
															</tr>
														</tbody>
													</table>
						...
						<div class="modal-body custom-modal-body">
									...
									<div class="input-blocks image-upload-down">
										...
										<div class="image-upload download">
											...
											<div class="image-uploads">
												...
												<?php echo $this->Html->image('download-img.png', ['alt' => 'img']); ?>
							...
							<div class="col-lg-12">
								<div class="modal-footer-btn">
									<a href="javascript:void(0);" class="btn btn-cancel me-2"
										data-bs-dismiss="modal">Cancel</a>
									<a href="purchase_list" class="btn btn-submit">Submit</a>
								</div>
							</div>
						</div>
					</div>
	...
	<!-- Swiper JS -->
	<?php echo $this->Html->script('plugins/swiper/swiper.min.js') ?>
