    ...
    <div class="account-content">
            <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden account-bg-01">
                <div
                    ...
                    <form action="home" class="flex-fill">
                        <div class="mx-auto mw-450">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                ...
                                <div class="text-end">
                                    <a href="forgot_password" class="text-primary fw-medium link-hover">Forgot
                                        Password?</a>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <h6>New on our platform?<a href="register" class="text-purple link-hover"> Create
                                        an account</a></h6>
                            </div>
