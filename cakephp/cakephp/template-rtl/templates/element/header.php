	...
	<div class="header">
		...
		<div class="header-left active">
			<a href="home" class="logo logo-normal">
				...
				<?php echo $this->Html->image('white-logo.svg', [
					'alt' => 'Logo',
					'class' => 'white-logo'
				]); ?>
			</a>
			<a href="home" class="logo-small">
				<?php echo $this->Html->image('logo-small.svg', [
					'alt' => 'Logo'
				]); ?>
			</a>
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item nav-list">
					<ul class="nav">
						...
						<li class="nav-item">
							<a href="lead_reports" class="btn btn-chart-pie">
				...
				<li class="nav-item dropdown nav-item-box">
					...
					<div class="dropdown-menu dropdown-menu-end notification-dropdown">
						...
						<div class="topnav-dropdown-footer">
							<a href="activities" class="view-link">View all</a>
