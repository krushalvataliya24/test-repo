                    ...
                    <div class="col-md-12">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h4 class="page-title">
                                        Contacts<span class="count-title">123</span>
                                    </h4>
                                </div>
                            ...
                            <div
                                ...
                                <div class="dropdown me-2">
                                    ...
                                    <div
                                        ...
                                        <p class="mb-3">
                                            Please drag and drop your column
                                            to reorder your table and enable
                                ...
                                <div class="view-icons">
                                    <a href="contacts" class="active"><i class="ti ti-list-tree"></i></a>
                                    <a href="contact_grid"><i class="ti ti-grid-dots"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- /Filter -->
                                ...
                                <div class="accordion-body border-top">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label
                                                    class="col-form-label">Job Title
                                                    <span
                                                        class="text-danger">*</span></label>
                                                <input
                                                    type="text"
