...
<body>
									...
									<div class="tab-content twitter-bs-wizard-tab-content">
										...
										<div class="tab-pane fade" id="bank-detail">
											<div>
												...
												<ul class="pager wizard twitter-bs-wizard-pager-link">
													<li class="previous"><a href="javascript: void(0);" class="btn btn-primary" onclick="nextTab()"><i class="bx bx-chevron-left me-1"></i> Previous</a></li>
													<li class="float-end"><a href="form-wizard.html" class="btn btn-primary">Save
															Changes</a></li>
												</ul>
											</div>
										</div>
	...
	<!-- Wizard JS -->
	<?php echo $this->Html->script('plugins/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js'); ?>
	<?php echo $this->Html->script('plugins/twitter-bootstrap-wizard/prettify.js'); ?>
	<?php echo $this->Html->script('plugins/twitter-bootstrap-wizard/form-wizard.js'); ?>
