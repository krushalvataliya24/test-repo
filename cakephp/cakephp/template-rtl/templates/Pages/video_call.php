									...
									<div class="meeting-list">
										<div class="recession-meet-blk">
											...
											<div class="partispant-blk">
												...
												<span class="partispant-chat me-2"><a href="javascript:void(0);"
														id="show-message"><i
															class="bx bx-message-alt-dots"></i></a></span>
										...
										<div class="join-contents horizontal-view fade-whiteboard">
											<div class="join-video user-active">
                                                ...
                                                <?php echo $this->Html->image('join-call.jpg', ['alt' => 'Logo','class'=>'img-fluid']); ?>
											...
											<div class="owl-carousel video-slide owl-theme">
												<div class="join-video single-user">
                                                        ...
                                                        <?php echo $this->Html->image('users/user-01.jpg', ['alt' => 'Logo','class'=>'img-fluid']); ?>
												...
												<div class="join-video single-user">
                                                        ...
                                                        <?php echo $this->Html->image('users/user-02.jpg', ['alt' => 'Logo','class'=>'img-fluid']); ?>
													<div class="part-name sub-part-name">
														<h4>Linnea</h4>
													</div>
													<div class="more-icon">
												...
												<div class="join-video single-user">
                                                        ...
                                                        <?php echo $this->Html->image('users/user-05.jpg', ['alt' => 'Logo','class'=>'img-fluid']); ?>
													<div class="part-name sub-part-name">
														<h4>Richard</h4>
													</div>
													<div class="more-icon">
												...
												<div class="join-video single-user">
                                                        ...
                                                        <?php echo $this->Html->image('users/user-03.jpg', ['alt' => 'Logo','class'=>'img-fluid']); ?>
													<div class="part-name sub-part-name">
														<h4>Freda</h4>
													</div>
													<div class="more-icon">
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-02.jpg', ['alt' => 'image']); ?>
																</div>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-03.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Benjamin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-04.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Kaitlin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-05.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Alwin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-06.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Freda</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-08.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>John Doe</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-09.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>John Blair</h5>
														...
														<li>
															<div class="user-list-item mb-0">
																<div class="avatar ">
                                                                    ...
                                                                    <?php echo $this->Html->image('users/user-10.jpg', ['alt' => 'image']); ?>
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
												...
												<div class="chat-msg-blk ">
													<div class="chats">
														<div class="chat-avatar">
                                                                ...
                                                                <?php echo $this->Html->image('users/user-01.jpg', ['alt' => 'image','class'=>'dreams_chat']); ?>
														</div>
													...
													<div class="chats chats-right">
														...
														<div class="chat-avatar">
                                                                ...
                                                                <?php echo $this->Html->image('users/user-02.jpg', ['alt' => 'image','class'=>'dreams_chat']); ?>
														</div>
													</div>
													<div class="chats">
														<div class="chat-avatar">
