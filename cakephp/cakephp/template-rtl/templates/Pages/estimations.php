	...
	<div class="main-wrapper">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="estimations" data-bs-toggle="tooltip" data-bs-placement="top"
										...
										<div
											...
											<a href="javascript:void(0);" class="btn btn-primary"
												data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
													class="ti ti-square-rounded-plus me-2"></i>Add Estimations</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap mb-4 row-gap-2">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="border-top pt-3">
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Estimations ID</p>
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Project</p>
														<div class="status-toggle">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Expiry Date</p>
														<div class="status-toggle">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Estimations By</p>
														<div class="status-toggle">
												...
												<div class="filter-set-view">
													...
													<div class="accordion" id="accordionExample">
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" data-bs-toggle="collapse"
																	...
																	aria-controls="collapse">Client</a>
															</div>
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" class="collapsed" data-bs-toggle="collapse"
																	data-bs-target="#estimate" aria-expanded="false"
																	aria-controls="estimate">Estimated by</a>
															</div>
															<div class="filter-set-contents accordion-collapse collapse"
																id="estimate" data-bs-parent="#accordionExample">
																<div class="filter-content-list">
																	<div class="mb-2 icon-form">
																		<span class="form-icon"><i
																				class="ti ti-search"></i></span>
										...
										<div class="view-icons">
											<a href="estimations" class="active"><i
													class="ti ti-list-tree"></i></a>
											<a href="estimations_kanban"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- /Filter -->
									...
									<table class="table datatable">
										...
										<tbody>
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center">
														...
														<a href="company_details">NovaWave LLC</a>
													</h2>
												</td>
												<td>$2,15,000</td>
												<td>
												...
												<td>
													<h2 class="d-flex align-items-center">
														...
														<a href="javascript:void(0);" class="d-flex flex-column">Darlee
															Robertson<span class="text-default">Facility Manager </span>
														</a>
													</h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-violet">Sent</span>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center">
														...
														<a href="company_details">BlueSky Industries</a>
													</h2>
												</td>
												<td>$1,45,000</td>
												<td>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Sharon Roy<span
																class="text-default">Installer </span></a></h2>
												</td>
												<td><span
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															class="avatar avatar-sm border me-2">
															<?php echo $this->Html->image('icons/company-icon-03.svg', [
															'alt' => 'Image',
															'class' => 'w-auto h-auto'
														]); ?></a><a
															href="company_details">Silver Hawk</a></h2>
												</td>
												<td>$2,15,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Vaughan<span
																class="text-default">Senior Manager </span></a></h2>
												</td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">Summit Peak</a></h2>
												</td>
												<td>$4,80,380</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Jessica<span
																class="text-default">Test Engineer </span></a></h2>
												</td>
												<td><span
														class="badge badge-pill badge-status bg-success">Accepted</span>
												</td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">RiverStone Ventur</a></h2>
												</td>
												<td>$2,12,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Carol Thomas<span
																class="text-default">UI /UX Designer </span></a></h2>
												</td>
												<td><span
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">CoastalStar Co.</a></h2>
												</td>
												<td>$3,50,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Dawn Mercha<span
																class="text-default">Technician </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-warning">Draft</span>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">HarborView</a></h2>
												</td>
												<td>$1,23,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															class="avatar avatar-sm border me-2">
															<?php echo $this->Html->image('priority/project-02.svg', [
															'alt' => 'Image',
															'class' => 'w-auto h-auto'
														]); ?></a><a href="#">Doccure</a></h2>
												</td>
												<td>07 Dec 2023</td>
												<td>05 Nov 2026</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Rachel Hampton<span
																class="text-default">Software Developer </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-violet">Sent</span>
												</td>
												<td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">Golden Gate Ltd</a></h2>
												</td>
												<td>$3,12,50</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Jonelle Curtiss<span
																class="text-default">Supervisor </span></a></h2>
												</td>
												<td><span
														class="badge badge-pill badge-status bg-success">Accepted</span>
												</td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Jonathan<span
																class="text-default">Team Lead Dev </span></a></h2>
												</td>
												<td><span
														class="badge badge-pill badge-status bg-danger">Declined</span>
												</td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="company_details"
															...
															href="company_details">NovaWave LLC</a></h2>
												</td>
												<td>$4,80,380</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#"
															...
															class="d-flex flex-column">Brook<span
																class="text-default">Team Lead Dev </span></a></h2>
												</td>
												<td><span
														class="badge badge-pill badge-status bg-success">Accepted</span>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="estimations">
					<div>
						<div class="row">
							<div class="mb-3">
								<div class="d-flex align-items-center justify-content-between">
									<label class="col-form-label">Client</label>
									<a href="#" class="label-add" data-bs-toggle="modal" data-bs-target="#add_client"><i
							...
							<div class="mb-3">
								<div class="d-flex align-items-center justify-content-between">
									...
									<a href="#" class="label-add" data-bs-toggle="modal" data-bs-target="#save_view"><i
											class="ti ti-square-rounded-plus"></i>Add New</a>
								</div>
								<select class="select">
									<option>Choose</option>
							...
							<div class="col-md-6">
								<div class="mb-3">
									<label class="col-form-label">Estimate Date <span
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input class="input-tags form-control" type="text" data-role="tagsinput"
										name="Label" value="Tag 1, Tag 2, Tag 3">
								</div>
							</div>
							<div class="mb-3">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="estimations" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
