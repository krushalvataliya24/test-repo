							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="membership_plans" data-bs-toggle="tooltip" data-bs-placement="top"
										...
										<div class="text-sm-end">
											<a href="javascript:void(0);" class="btn btn-primary"
												data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
													class="ti ti-square-rounded-plus me-1"></i>Add Membership</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
									...
									<div class="card border">
										<div class="card-body">
											<div class="text-center border-bottom pb-3 mb-3">
												<span>Basic</span>
												<h2 class="d-flex align-items-end justify-content-center mt-1">$50 <span
														class="fs-14 fw-medium ms-2">/ month</span></h2>
											</div>
											<div class="d-block">
												<div>
													...
													<p class="d-flex align-items-center fs-16 fw-medium text-dark mb-2">
														<span
															class="bg-danger d-flex align-items-center justify-content-center fs-12 wh-14 me-1 rounded"><i
																class="ti ti-x"></i>
														</span>Deals
													</p>
													<p class="d-flex align-items-center fs-16 fw-medium text-dark mb-2">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									<div class="d-flex justify-content-between align-items-center">
										<label class="col-form-label">Plan Price <span
												class="text-danger">*</span></label>
										<span class="text-danger"><i class="ti ti-info-circle me-2"></i>Set 0 for
											free</span>
									</div>
									<select class="select">
										<option>Choose</option>
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<label class="checkboxs mt-2"><input type="checkbox"><span
											class="checkmarks mem-plane-check"></span>Unlimited</label>
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
