								...
								<tbody>
									<tr>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-01.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td class="phone-call-icon"><i data-feather="phone"
												...
												class="income-success me-1"></i>Incoming Call</td>
										<td>00.25</td>
									...
									<tr>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-02.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td>+1 93016 81932</td>
										<td class="phone-call-icon"><i data-feather="phone"
												class="income-calls me-1"></i><i data-feather="arrow-up-right"
												class="income-success-missed me-1"></i>Missed Call</td>
										<td>00.00</td>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-03.jpg', ['alt' => 'product']); ?>
												</a>
												<a href="javascript:void(0);">Benjamin</a>
											</div>
										</td>
										<td>+1 25182 94528</td>
										<td class="phone-call-icon"><i data-feather="video"
												class="income-calls me-1"></i><i data-feather="arrow-down-left"
												class="income-success me-1"></i>Incoming Call</td>
										<td>00.15</td>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-04.jpg', ['alt' => 'product']); ?>
												</a>
									...
									<tr>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-05.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td class="phone-call-icon"><i data-feather="video"
												class="income-calls me-1"></i><i data-feather="arrow-up-right"
												class="income-success me-1"></i>Outgoing Call</td>
										<td>00.45</td>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-08.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-06.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-07.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-10.jpg', ['alt' => 'product']); ?>
												</a>
										...
										<td>
											<div class="userimgname">
												<a href="javascript:void(0);" class="product-img">
													...
													<?php echo $this->Html->image('users/user-12.jpg', ['alt' => 'product']); ?>
												</a>
					...
					<div class="content">
						<div class="text-center right-sidebar-profile mb-3">
							<figure class="avatar">
								...
								<?php echo $this->Html->image('users/user-23.jpg', ['alt' => 'image']); ?>
							</figure>
							<div class="chat-options chat-option-profile">
								<ul class="list-inline">
									...
									<li class="list-inline-item">
										<a href="chat" class="btn btn-outline-light" data-bs-toggle="tooltip"
											data-bs-placement="bottom" title="" data-bs-original-title="Chat">
