					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-sm-4">
									<h4 class="page-title">Leads Overview </h4>
								</div>
								<div class="col-sm-8 text-sm-end">
									<div class="head-icons">
										<a href="leads_details" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="leads"><i class="ti ti-arrow-narrow-left"></i>Leads</a></li>
								...
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="leads_details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="leads_details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											...
											<p class="mb-0"><i class="ti ti-map-pin-pin me-1"></i>22, Ave Street,
												Newyork, USA</p>
										</div>
									</div>
									<div class="contacts-action">
										...
										<div class="dropdown mb-2">
											<a href="#" class="bg-success text-white py-1 px-2"
												data-bs-toggle="dropdown" aria-expanded="false">
												Closed<i class="ti ti-chevron-down ms-2"></i>
											</a>
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item"
													href="javascript:void(0);"><span>Closed</span></a>
												<a class="dropdown-item"
													href="javascript:void(0);"><span>Opened</span></a>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="leads_details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
