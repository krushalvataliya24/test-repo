					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-sm-8">
									<h4 class="page-title">Leads Report <span class="count-title">123</span></h4>
								</div>
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="lead_reports" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="row">
									...
									<div class="col-md-7 col-sm-8">
										<div class="text-sm-end">
											<a href="download_report" class="btn btn-primary" data-bs-toggle="modal"
										...
										<div class="dropdown me-2">
											...
											<div class="dropdown-menu  dropdown-menu-md-end dropdown-md p-3">
												...
												<div class="border-top pt-3">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Source</p>
														<div class="status-toggle">
