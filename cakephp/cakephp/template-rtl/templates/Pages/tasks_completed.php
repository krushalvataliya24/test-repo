							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="tasks_completed" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									<div class="sort-dropdown drop-down task-drops">
										<a href="javascript:void(0);" class="dropdown-toggle"
											data-bs-toggle="dropdown">Completed</a>
															...
															<div class="dropdown table-action">
																...
																<div class="dropdown-menu dropdown-menu-right">
																	<a class="dropdown-item" data-bs-toggle="offcanvas"
																		data-bs-target="#offcanvas_edit" href="#"><i
										...
										<ul>
											<li class="task-wrap  success">
												<div class="task-info">
													...
													<span class="badge badge-pill badge-status bg-blue"><i
