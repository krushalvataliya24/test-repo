							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="projects" data-bs-toggle="tooltip" data-bs-placement="top"
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="view-icons">
											<a href="projects" class="active"><i class="ti ti-list-tree"></i></a>
											<a href="project_grid"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>
								</div>
								<!-- /Filter -->
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="projects" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
