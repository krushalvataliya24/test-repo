...
<head>
	...
	<!-- Title -->
	<title>Roles Permission | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="roles_permissions" data-bs-toggle="tooltip"
									...
									<div class="col-sm-8">
										<div class="text-sm-end">
											...
											<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
												data-bs-target="#add_role"><i
													class="ti ti-square-rounded-plus me-2"></i>Add New Roles</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
