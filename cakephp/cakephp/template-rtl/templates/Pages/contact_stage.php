							...
							<div class="row align-items-center">
								...
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="contact_stage" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="col-sm-8">
										<div class="text-sm-end">
											<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal"
												data-bs-target="#add_contact_stage"><i
													class="ti ti-square-rounded-plus me-2"></i>Add New Stages</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								<a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="contact_stage" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
