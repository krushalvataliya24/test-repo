					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-8">
									<h4 class="page-title">Deals Overview </h4>
								</div>
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="deals_details" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="row align-items-center">
								<div class="col-sm-8">
									<ul class="contact-breadcrumb">
										<li><a href="deals"><i class="ti ti-arrow-narrow-left"></i>Deals</a></li>
								...
								<div class="col-sm-4 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="deals_details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="deals_details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="card-body pb-2">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											<h5 class="mb-1">Tremblay and Rath <span class="star-icon"><i
														class="fa-solid fa-star"></i></span></h5>
											<p class="mb-1"><i class="ti ti-building"></i> Google Inc</p>
											<p class="mb-0"><i class="ti ti-map-pin-pin"></i> 22, Ave Street, Newyork,
												USA</p>
										</div>
									</div>
									<div class="contacts-action">
										...
										<div class="dropdown mb-2">
											<a href="#"
												class="text-white bg-success py-1 px-2 d-inline-flex align-items-center"
												data-bs-toggle="dropdown" aria-expanded="false">
												<i class="ti ti-thumb-up me-2"></i>Won<i
													class="ti ti-chevron-down ms-2"></i>
											</a>
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="javascript:void(0);"><span>Won</span></a>
												<a class="dropdown-item"
													href="javascript:void(0);"><span>Lost</span></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-xl-3 theiaStickySidebar">
						<div class="card">
							<div class="card-body p-3">
								...
								<ul>
									<li class="row mb-3"><span class="col-6">Date Created</span><span class="col-6">10
											Jan 2024, 10:00 am</span></li>
									<li class="row mb-3"><span class="col-6">Value</span><span
											class="col-6">$25,11,145</span></li>
									<li class="row mb-3"><span class="col-6">Due Date</span><span class="col-6">20 Jan
											2024, 10:00 am</span></li>
									<li class="row mb-3"><span class="col-6">Follow Up</span><span class="col-6">20 Jan
											2024</span></li>
									<li class="row mb-3"><span class="col-6">Source</span><span
											class="col-6">Google</span></li>
								</ul>
								<hr>
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<h6 class="mb-3 fw-semibold">Owner</h6>
									<a href="javascript:void(0);" class="link-purple fw-medium mb-3"
										data-bs-toggle="modal" data-bs-target="#owner"><i
								...
								<a href="javascript:void(0);" class="badge bg-light-300 text-default me-2 mb-2">Devops
									Design</a>
								<a href="javascript:void(0);" class="badge bg-light-300 text-default mb-2">Margrate
									Design</a>
								<hr>
									...
									<div class="dropdown">
										<a href="#" class="dropdown-toggle" data-bs-toggle="dropdown"
											aria-expanded="false"><span><i
													class="ti ti-square-rounded-filled me-1 text-danger circle"></i>High</span><i
												class="ti ti-chevron-down me-1"></i></a>
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="javascript:void(0);">
												<span><i
														class="ti ti-square-rounded-filled me-1 text-danger circle"></i>High</span>
											</a>
											<a class="dropdown-item" href="javascript:void(0);">
												<span><i
														class="ti ti-square-rounded-filled me-1 text-success circle"></i>Low</span>
											</a>
										</div>
									</div>
								</div>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<a href="javascript:void(0);" class="link-purple mb-3 fw-medium"
										data-bs-toggle="modal" data-bs-target="#add_contact"><i
											class="ti ti-circle-plus me-1"></i>Add New</a>
								</div>
								<div class="d-flex align-items-center mb-3">
									<div class="avatar avatar-md me-2">
								...
								<ul>
									...
									<li class="row mb-0"><span class="col-6">Modified By</span>
										<span class="col-6">
											<span class="avatar avatar-xs me-1"><?php echo $this->Html->image('profiles/avatar-19.jpg', [
																					'alt' => 'img',
																					'class' => 'avatar-xs'
													...
													<div class="d-flex">
														...
														<div>
															<h6
																...
																Meeting With <span class="avatar avatar-xs mx-2"><?php echo $this->Html->image('profiles/avatar-19.jpg', [
																														'alt' => 'Image'
																													]); ?></span> Abraham</h6>
																...
																<div class="row">
																	...
																	<div class="col-sm-4">
																		...
																		<div class="dropdown">
																			<a href="#" class="dropdown-toggle"
																				data-bs-toggle="dropdown"
																				aria-expanded="false"><?php echo $this->Html->image('profiles/avatar-19.jpg', [
																											'alt' => 'img',
																											'class' => 'avatar-xs'
																										]); ?> John<i
																					class="ti ti-chevron-down ms-1"></i></a>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="deals_details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
				...
				<form action="deals">
					...
					<div class="d-flex align-items-center justify-content-end">
						...
						<button type="button" class="btn btn-primary" data-bs-toggle="modal"
							data-bs-target="#create_pipeline">Create</button>
					</div>
				</form>
			</div>
