...
<head>
	...
	<!-- Summernote CSS -->
	<?php echo $this->Html->css('plugins/summernote/summernote-bs4.min');?>
    <!-- Owl Carousel -->
							...
							<div class="notes-top-head-submenu">
								<div class="nav flex-column nav-pills todo-inbox" id="v-pills-tab" role="tablist"
									...
									<button class="nav-link todo-tab todo-inbox active d-flex align-items-center"
										...
										<i data-feather="inbox" class="feather-inbox"></i>All Notes
										<span class="ms-auto">
											<span>2</span>
										</span>
									</button>
										...
										<div class="col-md-12" id="notes-important">
											<div class="notes-slider owl-carousel">
														...
														<div class="notes-logo">
															<a href="javascript:void(0);">
																<span>
																		...
																		<?php echo $this->Html->image('profiles/avatar-01.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>

																</span>
															</a>
															<div class="d-flex">
																<span class="low-square"><i
												...
												<div class="notes-card medium">
													<div class="notes-card-body">
														<p class="badged medium"><i class="fas fa-circle"></i> Medium
														</p>
														...
														<div class="notes-logo">
															<a href="javascript:void(0);">
																<span>
																		...
																		<?php echo $this->Html->image('profiles/avatar-02.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
																</span>
															</a>
															<div class="d-flex">
												...
												<div class="notes-card high">
													...
													<div class="notes-slider-content">
														...
														<p>Calligraphy, the art of beautiful handwriting. The term may
															derive from the Greek words. </p>
													</div>
													<div class="notes-slider-widget">
														<div class="notes-logo">
															<a href="javascript:void(0);">
																<span>
																		...
																		<?php echo $this->Html->image('profiles/avatar-03.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
																</span>
															</a>
															<div class="d-flex">
																<span class="high-square"><i
																		class="fas fa-square"></i></span>
													...
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-26.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="medium-square"><i
										...
										<div class="col-md-4 d-flex">
											<div class="notes-card notes-card-details w-100">
												...
												<div class="notes-wrap-content">
													...
													<p>Server log is a text document that contains a record of all
														activity.</p>
												</div>
												<div class="notes-slider-widget notes-widget-profile">
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-27.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="high-square"><i
													...
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-28.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="low-square"><i
										...
										<div class="col-md-4 d-flex">
											<div class="notes-card notes-card-details w-100">
												...
												<div class="notes-wrap-content">
													...
													<p>Compost pile refers to fruit and vegetable scraps, used tea,
														coffee grounds etc..</p>
												</div>
												<div class="notes-slider-widget notes-widget-profile">
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-29.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="high-square"><i
										...
										<div class="col-md-4 d-flex">
											<div class="notes-card notes-card-details w-100">
												...
												<div class="notes-wrap-content">
													...
													<p>Hiking involves a long energetic walk in a natural environment.
													</p>
												</div>
												<div class="notes-slider-widget notes-widget-profile">
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-30.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="low-square"><i
										...
										<div class="col-md-4 d-flex">
											<div class="notes-card notes-card-details w-100">
												...
												<div class="notes-wrap-content">
													...
													<p>Research a topic interested by listen actively and attentively.
													</p>
												</div>
												<div class="notes-slider-widget notes-widget-profile">
													<div class="notes-logo">
														<a href="javascript:void(0);">
															<span>
																	...
																	<?php echo $this->Html->image('users/user-31.jpg', ['alt' => 'Profile','class'=>'img-fluid']); ?>
															</span>
														</a>
														<div class="d-flex">
															<span class="medium-square"><i
