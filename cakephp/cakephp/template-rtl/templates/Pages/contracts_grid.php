...
<body>
	...
	<div class="main-wrapper">
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="contracts_grid" data-bs-toggle="tooltip" data-bs-placement="top"
						...
						<div
							...
							<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="contracts_grid" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="view-icons">
									<a href="contracts"><i class="ti ti-list-tree"></i></a>
									<a href="contracts_grid" class="active"><i class="ti ti-grid-dots"></i></a>
								</div>
							</div>
						</div>
						<!-- /Filter -->
								...
								<div class="card border">
									<div class="card-body">
											...
											<div class="dropdown table-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="#" data-bs-toggle="modal"
														data-bs-target="#delete_contracts"><i
															class="ti ti-trash text-danger"></i> Delete</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-copy text-blue-light"></i> Clone</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-clipboard-copy text-blue-light"></i> View
														Contract</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-checks text-blue-light"></i> Mark as Signed</a>
													<a class="dropdown-item" href="javascript:void(0);"><i
															class="ti ti-printer text-blue-light"></i> Print</a>
												</div>
											</div>
										</div>
										<div class="d-block">
											...
											<div class="mb-3">
												<p class="d-flex align-items-center mb-2"><span
														class="avatar avatar-xs border text-dark me-2"><i
															class="ti ti-calendar-event fs-12"></i></span>Date : 25 May
													2024</p>
												<p class="d-flex align-items-center"><span
														class="avatar avatar-xs border text-dark me-2"><i
															class="ti ti-calendar-stats"></i></span>Open till : 31 Jun
													2024</p>
											</div>
											<div class="bg-light-200 border rounded d-flex align-items-center p-2 mb-3">
												<a href="javascript:void(0);"
													class="avatar avatar-sm border bg-white me-2">
										...
										<div class="d-flex justify-content-between pt-3 border-top">
											<div>
												<span class="badge badge-purple"> <i class="ti ti-moneybag me-1"></i>
													Value : $2,04,214</span>
											</div>
											<a href="javascript:void(0);"
												class="avatar avatar-xs bg-danger-light text-danger"> <i
													class="ti ti-file-dots fs-12"></i> </a>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="d-block">
											...
											<div class="bg-light-200 border rounded d-flex align-items-center p-2 mb-3">
												...
												<div class="d-flex flex-column">
													<span class="d-block">Customer</span>
													<a href="javascript:void(0);"
														class="text-default">Unconscionable</a>
												</div>
											</div>
										</div>
										<div class="d-flex justify-content-between pt-3 border-top">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="contracts_grid" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<!-- Create Contact -->
		<div class="modal custom-modal fade" id="create_success
		" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
