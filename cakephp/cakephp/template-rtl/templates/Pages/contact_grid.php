							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="contact_grid" data-bs-toggle="tooltip" data-bs-placement="top"
										...
										<div
											...
											<a href="javascript:void(0);" class="btn btn-primary"
												data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
													class="ti ti-square-rounded-plus me-2"></i>Add Contacts</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="view-icons">
											<a href="contacts"><i class="ti ti-list-tree"></i></a>
											<a href="contact_grid" class="active"><i
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Darlee
																	Robertson</a></h6>
													...
													<div class="dropdown table-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="contact_details"><i
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Sharon
																	Roy</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details"
																	class="fw-medium">Vaughan</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Carol
																	Thomas</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Dawn
																	Mercha</a></h6>
												...
												<div class="d-block">
													<div class="d-flex flex-column mb-3">
														...
														<p class="text-default d-inline-flex align-items-center"><i
																class="ti ti-map-pin-pin text-dark me-1"></i>Japan</p>
													</div>
													<div class="d-flex align-items-center">
														<span
															class="badge badge-tag badge-success-light me-2">Collab</span>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Rachel
																	Hampton</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Jonelle
																	Curtiss</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Eric
																	Adams</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="contact_details" class="fw-medium">Richard
																	Cooper</a></h6>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="contact_grid" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="#" class="btn btn-light" data-bs-dismiss="modal">Cancel</a>
								<a href="contact_details" class="btn btn-primary">View Details</a>
							</div>
						</div>
					</div>
				</div>
