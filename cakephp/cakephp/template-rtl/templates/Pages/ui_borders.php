				...
				<div class="row">
					...
					<div class="col-xl-6">
						<div class="card">
							...
							<div class="card-body">
								<?php echo $this->Html->image('profiles/avatar-01.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-02.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-top', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-03.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-end', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-07.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-bottom', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-04.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-start', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-05.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-circle', 'alt' => 'img']); ?>
								<?php echo $this->Html->image('profiles/avatar-06.jpg', ['class' => 'avatar-xxl avatar bd-placeholder-img rounded-pill', 'alt' => 'img']); ?>
							</div>
						</div>
					</div>
					<!-- /Borders Radius -->
