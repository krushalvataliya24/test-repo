					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-sm-4">
									<h4 class="page-title">Contacts<span class="count-title">123</span></h4>
								</div>
								<div class="col-sm-8 text-sm-end">
									<div class="head-icons">
										<a href="contact_details" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="row align-items-center">
								...
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="contact_details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="contact_details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
									...
									<div class="d-flex align-items-center mb-2">
										...
										<div>
											...
											<div class="d-flex align-items-center">
												<span class="badge badge-light bg-light-600 text-default me-3"><i
														class="ti ti-lock me-1"></i>Private</span>
												<p class="d-inline-flex align-items-center mb-0"><i
														class="fa-solid fa-star text-warning me-1"></i> 5.0</p>
											</div>
										</div>
									</div>
									<div class="contacts-action">
										<a href="#" class="btn-icon rating"><i class="fa-solid fa-star"></i></a>
										<a href="#" class="btn btn-danger" data-bs-toggle="offcanvas"
										...
										<a href="chat" class="btn-icon">
											<i class="ti ti-brand-hipchat"></i>
										</a>
										<a href="#" class="btn-icon" data-bs-toggle="offcanvas"
											data-bs-target="#offcanvas_edit"><i class="ti ti-edit-circle"></i></a>
										<div class="act-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="javascript:void(0);"
													data-bs-toggle="modal" data-bs-target="#delete_contact"><i
					...
					<div class="col-xl-3 theiaStickySidebar">
						<div class="card">
							<div class="card-body p-3">
								...
								<ul>
									<li class="row mb-3"><span class="col-6">Language</span><span
											class="col-6">English</span></li>
									<li class="row mb-3"><span class="col-6">Currency</span><span class="col-6">United
											States dollar</span></li>
									<li class="row mb-3"><span class="col-6">Last Modified</span><span class="col-6">27
											Sep 2023, 11:45 pm</span></li>
									<li class="row mb-3"><span class="col-6">Source</span><span class="col-6">Paid
											Campaign</span></li>
								</ul>
								<hr>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<a href="javascript:void(0);" class="link-purple mb-3" data-bs-toggle="offcanvas"
										data-bs-target="#offcanvas_add"><i class="ti ti-circle-plus me-1"></i>Add
										New</a>
								</div>
								<div class="mb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-lg rounded me-2 border">
											<?php echo $this->Html->image('icons/google-icon.svg', [
												'alt' => 'img',
												'class' => 'img-fluid w-auto h-auto'
											]); ?>
										</span>
										<div>
											<h6 class="fw-medium mb-1">Google. Inc <i
													class="fa-solid fa-circle-check text-success"></i></h6>
											<p>www.google.com</p>
										</div>
									</div>
								</div>
								...
								<div class="mb-0">
									<a href="javascript:void(0);" class="d-block mb-3"><i
											class="ti ti-share-2 me-1"></i>Share Contact</a>
									<a href="javascript:void(0);" class="d-block mb-3"><i
											class="ti ti-star me-1"></i>Add to Favourite</a>
									<a href="javascript:void(0);" class="d-block mb-0" data-bs-toggle="modal"
										data-bs-target="#delete_contact"><i class="ti ti-trash-x me-1"></i>Delete
										Contact</a>
								</div>
							</div>
						</div>
								...
								<ul class="nav nav-tabs nav-tabs-bottom" role="tablist">
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#activities"
											class="nav-link active"><i class="ti ti-alarm-minus me-1"></i>Activities</a>
									</li>
									<li class="nav-item" role="presentation">
										...
										<div class="card border shadow-none mb-3">
											<div class="card-body p-3">
												<div class="d-flex">
													...
													<div>
														<h6 class="fw-medium mb-1">Denwar responded to your appointment
				...
				<div class="modal-content">
					<div class="modal-body">
						<div class="text-center">
							...
							<p class="mb-0">Are you sure you want to remove <br> contact you selected.</p>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="contact_details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="accordion" id="main_accordion_2">
						...
						<div class="accordion-item rounded mb-3">
							<div class="accordion-header">
								<a href="#"
									...
									data-bs-toggle="collapse" data-bs-target="#basic-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i
											class="ti ti-user-plus fs-20"></i></span>
									Basic Info
								</a>
							</div>
							<div class="accordion-collapse collapse show" id="basic-2"
										...
										<div class="col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Phone 1 <span
														class="text-danger">*</span></label>
												<input type="text" class="form-control" value="6234567890">
											</div>
										</div>
										<div class="col-md-6">
											<div class="mb-3">
												<label class="col-form-label">Phone 2</label>
												<input type="text" class="form-control" value="7234567899">
											</div>
										</div>
										<div class="col-md-6">
											<div class="mb-3">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#"
									...
									data-bs-toggle="collapse" data-bs-target="#address-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i
											class="ti ti-map-pin-cog fs-20"></i></span>
									Address Info
								</a>
							</div>
							<div class="accordion-collapse collapse" id="address-2" data-bs-parent="#main_accordion_2">
								<div class="accordion-body border-top">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#"
									class="accordion-button accordion-custom-button rounded bg-white fw-medium text-dark"
									data-bs-toggle="collapse" data-bs-target="#social-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i
											class="ti ti-social fs-20"></i></span>
									Social Profile
								</a>
							</div>
							<div class="accordion-collapse collapse" id="social-2" data-bs-parent="#main_accordion_2">
								<div class="accordion-body border-top">
									<div class="row">
										<div class="col-md-6">
											<div class="mb-3">
						...
						<div class="accordion-item border-top rounded mb-3">
							<div class="accordion-header">
								<a href="#"
									class="accordion-button accordion-custom-button rounded bg-white fw-medium text-dark"
									data-bs-toggle="collapse" data-bs-target="#access-info-2">
									<span class="avatar avatar-md rounded text-dark border me-2"><i
											class="ti ti-accessible fs-20"></i></span>
									Access
								</a>
							</div>
							<div class="accordion-collapse collapse" id="access-info-2"
								data-bs-parent="#main_accordion_2">
								<div class="accordion-body border-top">
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<div class="d-flex flex-wrap">
													<div class="me-2">
														<input type="radio" class="status-radio" id="public2"
															name="visible">
														<label for="public2">Public</label>
													</div>
													<div class="me-2">
														<input type="radio" class="status-radio" id="private2"
															name="visible">
														<label for="private2">Private</label>
													</div>
													<div data-bs-toggle="modal" data-bs-target="#access_view">
														<input type="radio" class="status-radio" id="people2"
															name="visible">
											...
											<div class="mb-0">
												...
												<div class="d-flex flex-wrap">
													<div class="me-2">
														<input type="radio" class="status-radio" id="active2"
															name="status" checked="">
														<label for="active2">Active</label>
													</div>
													<div>
														<input type="radio" class="status-radio" id="inactive2"
															name="status">
