							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="sources" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="col-sm-8">
										<div class="text-sm-end">
											<a href="javascript:void(0);" class="btn btn-primary "
												data-bs-toggle="modal" data-bs-target="#add_source"><i
													class="ti ti-square-rounded-plus me-2"></i>Add New Sources</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								<a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="sources" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
