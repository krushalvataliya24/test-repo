							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="page" data-bs-toggle="tooltip" data-bs-placement="top"
										...
										<div
											...
											<a href="javascript:void(0);" class="btn btn-primary"
												data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
													class="ti ti-square-rounded-plus me-2"></i>Add New Page</a>
										</div>
									</div>
								</div>
								<!-- /Search -->
												...
												<div class="border-top pt-3">
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Page</p>
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<p class="mb-0 d-flex align-items-center"><i
																class="ti ti-grip-vertical me-2"></i>Page Slug</p>
														<div class="status-toggle">
												...
												<div class="filter-set-view">
														...
														<div class="filter-set-content">
															<div class="filter-set-content-head">
																<a href="#" class="collapsed" data-bs-toggle="collapse"
																	...
																	aria-controls="owner">Page Slug</a>
															</div>
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="page" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
			...
			<div class="offcanvas-body">
				<form action="page">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<div class="d-flex align-items-center">
									<div class="me-2">
										<input type="radio" class="status-radio" id="top-menu1" name="export-type"
											checked="">
					...
					<div class="d-flex align-items-center justify-content-end">
						...
						<a href="#" data-bs-toggle="modal" data-bs-target="#create_page"
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<div class="d-flex align-items-center">
									<div class="me-2">
										<input type="radio" class="status-radio" id="top-menu" name="export-type"
											checked="">
						...
						<div class="col-md-6">
							<div class="mb-3">
								...
								<div class="d-flex align-items-center">
									<div class="me-2">
										<input type="radio" class="status-radio" id="showa" name="export-type"
											checked="">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="page" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
