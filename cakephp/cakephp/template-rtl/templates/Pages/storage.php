							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="storage" data-bs-toggle="tooltip" data-bs-placement="top"
									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="storage" class="fw-medium active">Storage</a>
												<a href="ban_ip_address" class="fw-medium">Ban IP Address</a>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-xxl-4 col-sm-6">
												<div
													class="border rounded p-3 d-flex align-items-center justify-content-between mb-4">
													<div class="d-flex align-items-center">
														<span
															class="avatar avatar-lg bg-light-100 border flex-shrink-0 me-2">
													 <?php echo $this->Html->image('icons/storage-icon-01.svg', ['alt' => '','class'=>'w-auto h-auto']); ?>  
														</span>
													...
													<div class="d-flex align-items-center">
														<span
															class="avatar avatar-lg bg-light-100 border flex-shrink-0 me-2">
                                                                ...
                                                                <?php echo $this->Html->image('icons/storage-icon-02.svg', ['alt' => '','class'=>'w-auto h-auto']); ?>
														</span>
														<h6 class="fw-semibold">AWS</h6>
													</div>
													<div class="d-flex align-items-center">
														<a href="javascript:void(0);" class="me-2"
															data-bs-toggle="modal" data-bs-target="#add_settings"><i
																class="ti ti-settings fs-20"></i></a>
														<div class="status-toggle">
