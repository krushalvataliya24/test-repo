							...
							<div class="row align-items-center">
								...
								<div class="col-sm-8 text-sm-end">
									<div class="head-icons">
										<a href="project_details" data-bs-toggle="tooltip" data-bs-placement="top"
							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="projects"><i class="ti ti-arrow-narrow-left"></i>Project</a>
										</li>
										<li>Kofejob</li>
									</ul>
								</div>
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="project_details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="project_details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<div class="d-flex align-items-center mb-2">
										<div class="avatar avatar-xxl me-3 flex-shrink-0 border p-2">
											<?php echo $this->Html->image('priority/project-03.svg', [
												'alt' => 'img'
											]); ?>
										</div>
										<div>
											...
											<span class="priority badge badge-tag badge-danger-light"><i
													class="ti ti-square-rounded-filled"></i>High</span>
									...
									<div class="contacts-action">
										...
										<div class="dropdown action-drops">
											<a href="#" class="bg-success py-1 px-2" data-bs-toggle="dropdown"
												aria-expanded="false">
												<i class="ti ti-thumb-up me-2"></i>Completed<i
													class="ti ti-chevron-down ms-2"></i>
											</a>
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item"
													href="javascript:void(0);"><span>Completed</span></a>
												<a class="dropdown-item"
													href="javascript:void(0);"><span>Develop</span></a>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-xl-3 theiaStickySidebar">
						<div class="card">
							<div class="card-body p-3">
								...
								<ul>
									<li class="row mb-3"><span class="col-6">Start Date</span><span class="col-6">27 Sep
											2023, 11:45 pm</span></li>
									<li class="row mb-3"><span class="col-6">Due Date</span><span class="col-6">27 Sep
											2024, 11:45 pm</span></li>
									<li class="row mb-3"><span class="col-6">Value</span><span
											class="col-6">$25,11,145</span></li>
									<li class="row mb-3"><span class="col-6">Project Type</span><span
											class="col-6">Mobile Application</span></li>
									<li class="row mb-3"><span class="col-6">Project Timing</span><span
											class="col-6">Hourly</span></li>
								</ul>
								<hr>
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<h6 class="mb-3 fw-semibold">Client</h6>
									<a href="javascript:void(0);" class="link-purple mb-3"><i
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<a href="javascript:void(0);" class="link-purple mb-3" data-bs-toggle="modal"
										data-bs-target="#access_view"><i class="ti ti-circle-plus me-1"></i>Add New</a>
								</div>
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									...
									<span class="priority badge badge-tag badge-danger-light mb-3"><i
											class="ti ti-square-rounded-filled"></i>High</span>
								</div>
								<hr class="mt-0">
								<div class="d-flex align-items-center justify-content-between flex-wrap">
									<h6 class="mb-3 fw-semibold">Pipeline</h6>
									<h6 class="mb-3"><i class="ti ti-timeline-event-text me-1"></i>Marketing Pipeline
									</h6>
								</div>
								<hr class="mt-0">
								<ul>
									<li class="row mb-3"><span class="col-6">Last Modified</span><span class="col-6">10
											Jan 2024, 10:00 am</span></li>
							...
							<div class="card-body pb-0">
								...
								<ul class="nav nav-tabs nav-tabs-bottom" role="tablist">
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#tasks"
											class="nav-link active"><i class="ti ti-subtask me-1"></i>Tasks</a>
									</li>
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#activities"
											class="nav-link"><i class="ti ti-alarm-minus me-1"></i>Activities</a>
									</li>
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#notes" class="nav-link"><i
												class="ti ti-notes me-1"></i>Notes</a>
									</li>
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#calls" class="nav-link"><i
												class="ti ti-phone me-1"></i>Calls</a>
									</li>
									<li class="nav-item" role="presentation">
										<a href="#" data-bs-toggle="tab" data-bs-target="#files" class="nav-link"><i
												class="ti ti-file me-1"></i>Files</a>
									</li>
									<li class="nav-item" role="presentation">
										...
										<div class="d-inline-flex align-items-center text-end">
											...
											<a href="javascript:void(0);" class="btn btn-primary"
												data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i
													class="ti ti-circle-plus me-1"></i>Add New Task</a>
										</div>
									</div>
									<div class="card-body">
										<div class="tasks-activity">
											<div
												class="card border border-end-0 border-top-0 border-bottom-0 border-start border-3 border-danger mb-3">
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Add a form
																	to Update Task</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
																<span
																	class="priority badge badge-tag badge-danger-light mb-2"><i
																		class="ti ti-square-rounded-filled me-1"></i>High</span>
															</div>
														</div>
														<div class="col-md-6">
															<div
																class="d-flex align-items-center flex-wrap float-md-end">
																<div
																	class="d-flex align-items-center text-gray-9 mb-2 me-3">
																	<i class="ti ti-clock-record me-1"></i>25 Hrs
																</div>
																<div
																	class="d-flex align-items-center text-gray-9 mb-2 me-3">
																	<i class="ti ti-calendar-exclamation me-1"></i>25
																	Oct 2023
																</div>
																<div class="d-flex align-items-center mb-2">
												...
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Make all
																	strokes thinner</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
												...
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Update
																	orginal content</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
												...
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Use only
																	component colours</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
												...
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Add images
																	to the cards section</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
																<span
												...
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Design
																	description banner & landing page</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
																<span
											...
											<div
												class="card border border-end-0 border-top-0 border-bottom-0 border-start border-3 border-danger mb-0">
												<div class="card-body pb-2">
													<div class="row align-items-center">
														<div class="col-md-6">
															<div class="d-flex align-items-center flex-wrap">
																<p class="mb-2 me-3 text-gray-9"><i
																		class="ti ti-grip-vertical me-2"></i>Make sure
																	all the padding should be 24px</p>
																<span
																	class="badge badge-pill badge-status bg-green mb-2 me-2"><i
																		class="ti ti-phone me-1"></i>Calls</span>
																<span
									...
									<div class="card-body">
										<div class="contact-activity">
											<div class="badge badge-soft-purple fs-14 fw-normal shadow-none mb-3"><i
													class="ti ti-calendar-check me-1"></i>29 Aug 2023</div>
											<div class="card border shadow-none mb-3">
												<div class="card-body p-3">
													<div class="d-flex">
														...
														<div>
															<h6 class="fw-medium mb-1">You sent 1 Message to the
																contact.</h6>
															<p>10:25 pm</p>
														</div>
													</div>
													...
													<div class="d-flex">
														...
														<div>
															...
															<p class="mb-1">Please accept my apologies for the
																inconvenience caused. It would be much appreciated if
																it's possible to reschedule to 6:00 PM, or any other day
																that week.</p>
															<p>10.00 pm</p>
														</div>
													</div>
											...
											<div class="badge badge-soft-purple fs-14 fw-normal shadow-none mb-3"><i
													class="ti ti-calendar-check me-1"></i>28 Feb 2024</div>
											<div class="card border shadow-none mb-3">
												<div class="card-body p-3">
													<div class="d-flex">
														<span
														...
														<div>
															<h6
																...
																Meeting With <span class="avatar avatar-xs mx-2">
																	<?php echo $this->Html->image('profiles/avatar-19.jpg', [
																		'alt' => 'img'
																	]); ?></span> Abraham</h6>
											...
											<div class="card border shadow-none mb-3">
												<div class="card-body p-3">
													<div class="d-flex">
														...
														<div>
															<h6 class="fw-medium mb-1">Drain responded to your
											...
											<div class="badge badge-soft-purple fs-14 fw-normal shadow-none mb-3"><i
													class="ti ti-calendar-check me-1"></i>Upcoming Activity</div>
																	...
																	<div class="col-sm-4">
																		...
																		<div class="dropdown">
																			...
																			<div
																				...
																				<a class="dropdown-item"
																					href="javascript:void(0);">1 hr</a>
																				<a class="dropdown-item"
																					href="javascript:void(0);">10 hr</a>
																			</div>
																		</div>
																	</div>
																	<div class="col-sm-4">
									...
									<div
										...
										<div class="d-inline-flex align-items-center">
											...
											<a href="javascript:void(0);" data-bs-toggle="modal"
												data-bs-target="#add_notes" class="link-purple fw-medium"><i
													class="ti ti-circle-plus me-1"></i>Add New</a>
										</div>
									</div>
									<div class="card-body">
										<div class="notes-activity">
														...
														<div class="text-end">
															<a href="javascript:void(0);"
																class="add-comment link-purple fw-medium"><i
																	class="ti ti-square-plus me-1"></i>Add Comment</a>
														</div>
													</div>
												</div>
											</div>
											<div class="card mb-3">
												<div class="card-body">
													...
													<p>A project plan typically contains a list of the essential
														...
														typically lists the information based on the assignment.</p>
													<div class="d-inline-flex align-items-center flex-wrap">
														<div class="note-download me-3">
															<div class="note-info">
																<span class="note-icon bg-secondary-success">
													...
													<div class="reply-box">
														<p>The best way to get a project done faster is to start sooner.
														...
														<p>Commented by <span class="text-purple">Aeron</span> on 15 Sep
															2023, 11:15 pm</p>
														<a href="#" class="btn"><i
											...
											<div class="card mb-0">
												<div class="card-body">
													...
													<p>Projects play a crucial role in the success of organizations, and
														their importance cannot be overstated. Whether it's launching a
														new product, improving an existing</p>
													<div class="notes-editor">
														<div class="note-edit-wrap">
															<div class="summernote">Write a new comment, send your team
																notification by typing @ followed by their name</div>
							...
							<div class="tab-pane fade" id="calls">
								<div class="card">
									<div
										...
										<div class="d-inline-flex align-items-center">
											<a href="javascript:void(0);" data-bs-toggle="modal"
												data-bs-target="#create_call" class="link-purple fw-medium"><i
													class="ti ti-circle-plus me-1"></i>Add New</a>
										</div>
									</div>
									<div class="card-body">
											...
											<div class="card-body">
												<div class="d-sm-flex align-items-center justify-content-between pb-2">
													<div class="d-flex align-items-center mb-2">
														...
														<p><span class="text-dark fw-medium">Darlee Robertson</span>
															logged a call on 23 Jul 2023, 10:00 pm</p>
													</div>
													<div class="d-inline-flex align-items-center mb-2">
														<div class="dropdown me-2">
															<a href="#" class="bg-danger py-1" data-bs-toggle="dropdown"
															...
															<div class="dropdown-menu dropdown-menu-right">
																...
																<a class="dropdown-item" href="javascript:void(0);">Left
																	Voice Message</a>
																<a class="dropdown-item"
											...
											<div class="card-body">
												<div class="d-sm-flex align-items-center justify-content-between pb-2">
													<div class="d-flex align-items-center mb-2">
														...
														<p><span class="text-dark fw-medium">Sharon Roy</span> logged a
															call on 28 Jul 2023, 09:00 pm</p>
													</div>
													<div class="d-inline-flex align-items-center mb-2">
														<div class="dropdown me-2">
															<a href="#" class="bg-pending py-1"
																data-bs-toggle="dropdown" aria-expanded="false">No
																Answer<i class="ti ti-chevron-down ms-2"></i></a>
															<div class="dropdown-menu dropdown-menu-right">
																<a class="dropdown-item"
																	href="javascript:void(0);">Busy</a>
																<a class="dropdown-item" href="javascript:void(0);">No
												...
												<p>A project plan typically contains a list of the essential elements of
													a project, such as stakeholders, scope, timelines, estimated cost
													and communication methods. The project manager typically lists the
													information based on the assignment.</p>
											</div>
										</div>
										<div class="card mb-0">
											<div class="card-body">
												<div class="d-sm-flex align-items-center justify-content-between pb-2">
													<div class="d-flex align-items-center mb-2">
														...
														<p><span class="text-dark fw-medium">Vaughan</span> logged a
															call on 30 Jul 2023, 08:00 pm</p>
													</div>
													<div class="d-inline-flex align-items-center mb-2">
														<div class="dropdown me-2">
															<a href="#" class="bg-pending py-1"
												...
												<p>Projects play a crucial role in the success of organizations, and
													their importance cannot be overstated. Whether it's launching a new
													product, improving an existing</p>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="project_details" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
						...
						<form action="project_details">
							<div class="row">
								<div class="col-md-12">
									...
									<div class="mb-3">
										<label class="col-form-label">Follow Up Date <span class="text-danger">
												*</span></label>
										<div class="icon-form">
								...
								<form action="project_details">
									<div class="contact-input-set">
										<div class="row">
											<div class="col-md-12">
												<div class="mb-3">
													<label class="col-form-label">Choose Deal <span
															class="text-danger">*</span></label>
													<select class="select">
														<option>Select</option>
											...
											<div class="col-md-6">
												<div class="mb-3">
													<label class="col-form-label">Locale <span
															class="text-danger">*</span></label>
													<select class="select">
														<option>Select</option>
														<option>en</option>
											...
											<div class="col-lg-12">
												<div class="signature-wrap">
													...
													<ul class="nav sign-item">
														<li class="nav-item">
															<span class=" mb-0" data-bs-toggle="tab"
																data-bs-target="#nosign">
																<input type="radio" class="status-radio" id="sign1"
																	name="email">
																<label for="sign1"><span class="sign-title">No
														...
														<li class="nav-item">
															<span class="active mb-0" data-bs-toggle="tab"
																...
																<input type="radio" class="status-radio" id="sign2"
																	name="email" checked>
																<label for="sign2"><span class="sign-title">Use
																		e-signature</span>This document require
													...
													<div class="tab-content">
														<div class="tab-pane show active" id="use-esign">
															<div class="input-block mb-0">
																<label class="col-form-label">Document Signers <span
																		class="text-danger">*</span></label>
															</div>
											...
											<div class="col-md-12">
												<div class="input-block mb-3">
													<label class="col-form-label">Content <span class="text-danger">
															*</span></label>
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="signature-wrap">
													...
													<div class="input-block mb-0">
														<label class="col-form-label">Recipients (Additional
															recipients)</label>
													</div>
													<div class="sign-content">
														<div class="row">
											...
											<div class="col-lg-12">
												<div class="mb-3">
													<label class="col-form-label">Message Subject <span
															class="text-danger"> *</span></label>
													<input class="form-control" type="text" placeholder="Enter Subject">
												</div>
												<div class="mb-3">
													<label class="col-form-label">Message Text <span
															class="text-danger"> *</span></label>
													<textarea class="form-control" rows="3"
												...
												<div class="send-success">
													<p><i class="ti ti-circle-check"></i> Document sent successfully to
														the selected recipients</p>
												</div>
											</div>
											<div class="col-lg-12 text-end form-wizard-button modal-btn">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="col-lg-12 text-end modal-btn">
							...
							<button class="btn btn-primary" data-bs-target="#success_mail" data-bs-toggle="modal"
								data-bs-dismiss="modal">Connect Account</button>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="project_details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
						...
						<form action="#">
							...
							<div class="mb-3">
								<div class="text-center">
									...
									<button class="btn btn-primary" type="button"><span>Draft</span> <i
											class="fa-regular fa-floppy-disk ms-1"></i></button>
									<button class="btn btn-primary" type="button"><span>Delete</span> <i
