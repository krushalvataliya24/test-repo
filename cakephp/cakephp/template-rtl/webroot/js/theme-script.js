            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="lightTheme">
                            <img src="${ baseUrl}img/theme/theme-01.svg" alt="img">
                            <span class="w-100">
                                <span>Light</span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="darkTheme">
                            <img src="${ baseUrl}img/theme/theme-02.svg" alt="img">
                            <span class="w-100">
                                <span>Dark</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="lightSidebar">
                            <img src="${ baseUrl}img/theme/theme-03.svg" alt="img">
                            <span class="w-100">
                                <span>Light</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="darkSidebar">
                            <img src="${ baseUrl}img/theme/theme-04.svg" alt="img">
                            <span class="w-100">
                                <span>Dark</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="blueSidebar">
                            <img src="${ baseUrl}img/theme/theme-05.svg" alt="img">
                            <span class="w-100">
                                <span>Blue</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="greenSidebar">
                            <img src="${ baseUrl}img/theme/theme-06.svg" alt="img">
                            <span class="w-100">
                                <span>Green</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="sidebarBg1">
                            <img src="${ baseUrl}img/theme/theme-07.svg" alt="img">
                            <span class="w-100">
                                <span>Bg-1</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="sidebarBg2">
                            <img src="${ baseUrl}img/theme/theme-08.svg" alt="img">
                            <span class="w-100">
                                <span>Bg-2</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="sidebarBg3">
                            <img src="${ baseUrl}img/theme/theme-09.svg" alt="img">
                            <span class="w-100">
                                <span>Bg-3</span>
                                <span class="checkboxs-theme"></span>
                            </span>
                ...
                <div class="col-lg-6">
                    <div class="input-themeselect">
                        ...
                        <label for="sidebarBg4">
                            <img src="${ baseUrl}img/theme/theme-10.svg" alt="img">
                            <span class="w-100">
                                <span>Bg-4</span>
                                <span class="checkboxs-theme"></span>
                            </span>
