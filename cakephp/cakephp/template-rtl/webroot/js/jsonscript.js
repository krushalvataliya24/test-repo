	...
	if ($('#categorieslist').length > 0) {
		$('#categorieslist').DataTable({
			...
			"data": [
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-19.jpg",
					...
					"rating": "4.2",
					"owner": "Hendry",
					"owner_image": baseUrl + "img/profiles/avatar-14.jpg",
					"status": "0",
					"Action": ""
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-20.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-21.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-23.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-16.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-22.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-24.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-25.jpg",
				...
				},
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-26.jpg",
				...
				,
				{
					...
					"select": "",
					"customer_name": "Brook",
					"customer_image": baseUrl + "img/profiles/avatar-01.jpg",
					"customer_no": "Team Lead Dev ",
					"phone": "+1 278907145",
				...
				,
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-06.jpg",
				...
				,
				{
					...
					"customer_image": baseUrl + "img/profiles/avatar-05.jpg",
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="contact_details" class="avatar avatar-sm me-2"><img class="img-fluid" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact_details" class="d-flex flex-column">' + row['customer_name'] + ' <span class="text-default">' + row['customer_no'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if ($('#companieslist').length > 0) {
		$('#companieslist').DataTable({
			...
			"data": [
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-01.svg",
					"phone": "+1 875455453",
					"email": "robertson@example.com",
					"location": "Germany",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-02.svg",
					"phone": "+1 989757485",
					"email": "sharon@example.com",
					"location": "USA",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-03.svg",
					"phone": "+1 546555455",
					"email": "vaughan12@example.com",
					"location": "Canada",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-04.svg",
					"phone": "+1 454478787",
					"email": "jessica13@example.com",
					"location": "India",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-05.svg",
					"phone": "+1 124547845",
					"email": "caroltho3@example.com",
					"location": "China",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-06.svg",
					"phone": "+1 478845447",
					"email": "dawnmercha@example.com",
					"location": "Japan",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-07.svg",
					"phone": "+1 215544845",
					"email": "rachel@example.com",
					"location": "Indonesia",
					"tag": "0",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-08.svg",
					"phone": "+1 121145471",
					"email": "jonelle@example.com",
					"location": "Cuba",
					"tag": "2",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-09.svg",
					"phone": "+1 321454789",
					"email": "jonathan@example.com",
					"location": "Isreal",
					"tag": "2",
				...
				},
				{
					...
					"company_image": baseUrl + "img/icons/company-icon-10.svg",
					"phone": "+1 278907145",
					"email": "brook@example.com",
					"location": "Colombia",
					"tag": "2",
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border rounded p-1 me-2"><img class="w-auto h-auto" src="' + row['company_image'] + '" alt="User Image"></a><a href="company_details" class="d-flex flex-column fw-medium">' + row['company_name'] + '</a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if ($('#leads_list').length > 0) {
		$('#leads_list').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<a href="leads_details" class="title-name">' + row['lead_name'] + '</a>';
					}
				},
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border rounded p-1 me-2"><img class="w-auto h-auto" src="' + row['company_image'] + '" alt="User Image"></a><a href="company_details" class="d-flex flex-column">' + row['company_name'] + '<span class="text-default">' + row['company_address'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if ($('#recent-project').length > 0) {
		$('#recent-project').DataTable({
			...
			"data": [
				{
					...
					"priority_img": baseUrl + "img/priority/truellysel.svg",
					"recent_name": "NovaWave LLC",
					"recent_img": baseUrl + "img/icons/company-icon-01.svg",
					"client": "1",
				...
				},
				{
					...
					"priority_img": baseUrl + "img/priority/dreamchat.svg",
					"recent_name": "BlueSky Industries",
					"recent_img": baseUrl + "img/icons/company-icon-02.svg",
					"client": "2",
				...
				},
				{
					"id": 3,
					"priority_name": "Truelysell",
					"priority_img": baseUrl + "img/priority/truellysell.svg",
					"recent_name": "SilverHawk",
					"recent_img": baseUrl + "img/icons/company-icon-03.svg",
					"client": "",
				...
				},
				{
					...
					"priority_img": baseUrl + "img/priority/servbook.svg",
					"recent_name": "SummitPeak",
					"recent_img": baseUrl + "img/icons/company-icon-04.svg",
					"client": "1",
				...
				},
				{
					...
					"priority_img": baseUrl + "img/priority/dream-pos.svg",
					"recent_name": "RiverStone Ventur",
					"recent_img": baseUrl + "img/icons/company-icon-05.svg",
					"client": "2",
			...
			"columns": [
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="project_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['priority_img'] + '" alt="User Image"></a><a href="project_details">' + row['priority_name'] + '</a></h2>';
					}
				},
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['recent_img'] + '" alt="User Image"></a><a href="company_details">' + row['recent_name'] + '</a></h2>';
					}
				},
				{
					"render": function (data, type, row) {
	...
	if ($('#lead-project').length > 0) {
		$('#lead-project').DataTable({
			...
			"data": [
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-01.svg",
					"phone": "+1 875455453",
					"status": "1"
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-02.svg",
					"phone": "+1 989757485",
					"status": "2"
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-03.svg",
					"phone": "+1 546555455",
					"status": ""
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-04.svg",
					"phone": "+1 454478787",
					"status": "1"
				}
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['lead_img'] + '" alt="User Image"></a><a href="company_details" class="d-flex flex-column">' + row['lead_name'] + '<span class="text-default">' + row['lead_city'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{
			...
			"data": [
				{
					...
					"mem_image1": baseUrl + "img/profiles/avatar-14.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-15.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-16.jpg",
				...
				},
				{
					...
					"mem_image1": baseUrl + "img/profiles/avatar-03.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-05.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-06.jpg",
				...
				},
				{
					...
					"mem_image1": baseUrl + "img/profiles/avatar-04.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-01.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-16.jpg",
				...
				},
				{
					...
					"type": "Brand",
					"mem_image1": baseUrl + "img/profiles/avatar-12.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-15.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-13.jpg",
				...
				},
				{
					...
					"type": "Sales",
					"mem_image1": baseUrl + "img/profiles/avatar-10.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-11.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-16.jpg",
				...
				},
				{
					...
					"type": "Media",
					"mem_image1": baseUrl + "img/profiles/avatar-14.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-09.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-08.jpg",
				...
				},
				{
					...
					"type": "Rebranding",
					"mem_image1": baseUrl + "img/profiles/avatar-06.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-07.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-16.jpg",
				...
				},
				{
					...
					"mem_image1": baseUrl + "img/profiles/avatar-04.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-15.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-05.jpg",
	...
	if ($('#project-list').length > 0) {
		$('#project-list').DataTable({
			...
			"data": [
				{
					...
					"name": "Truelysell",
					"client": "NovaWave LLC",
					"pro_img": baseUrl + "img/priority/truellysel.svg",
					"client_img": baseUrl + "img/icons/company-icon-01.svg",
					"piority": "0",
					"start_date": "25 Sep 2023",
				...
				},
				{
					...
					"pro_img": baseUrl + "img/priority/dreamchat.svg",
					"client_img": baseUrl + "img/icons/company-icon-02.svg",
					"piority": "0",
				...
				},
				{
					...
					"name": "Truelysell",
					"client": "SilverHawk",
					"pro_img": baseUrl + "img/priority/truellysell.svg",
					"client_img": baseUrl + "img/icons/company-icon-03.svg",
					"piority": "0",
				...
				},
				{
					...
					"name": "Servbook",
					"client": "SummitPeak",
					"pro_img": baseUrl + "img/priority/servbook.svg",
					"client_img": baseUrl + "img/icons/company-icon-04.svg",
					"piority": "0",
				...
				},
				{
					...
					"pro_img": baseUrl + "img/priority/dream-pos.svg",
					"client_img": baseUrl + "img/icons/company-icon-05.svg",
					"piority": "0",
				...
				},
				{
					...
					"pro_img": baseUrl + "img/priority/project-01.svg",
					"client_img": baseUrl + "img/icons/company-icon-06.svg",
					"piority": "0",
				...
				},
				{
					...
					"name": "Doccure",
					"client": "HarborView",
					"pro_img": baseUrl + "img/priority/project-02.svg",
					"client_img": baseUrl + "img/icons/company-icon-07.svg",
					"piority": "0",
				...
				},
				{
					...
					"pro_img": baseUrl + "img/priority/best.svg",
					"client_img": baseUrl + "img/icons/company-icon-08.svg",
					"piority": "0",
				...
				},
				{
					...
					"value": "$03,64,000",
					"hrs": "60",
					"mem_image1": baseUrl + "img/profiles/avatar-08.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-12.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-04.jpg",
					"budget": "$200000",
				...
				},
				{
					...
					"client": "Redwood Inc",
					"pro_img": baseUrl + "img/priority/servbook.svg",
					"client_img": baseUrl + "img/icons/company-icon-09.svg",
					"piority": "0",
					...
					"hrs": "56",
					"mem_image1": baseUrl + "img/profiles/avatar-12.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-14.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-01.jpg",
					"budget": "$300000",
				...
				},
				{
					...
					"name": "Dreamchat",
					"client": "Redwood Inc",
					"pro_img": baseUrl + "img/priority/sports.svg",
					"client_img": baseUrl + "img/icons/company-icon-09.svg",
					"piority": "0",
					...
					"mem_image1": baseUrl + "img/profiles/avatar-08.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-15.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-12.jpg",
					"budget": "$400000",
					"currently_spend": "$200000 ",
					"Action": ""
				},
				{
					...
					"value": "$01,23,000",
					"hrs": "63",
					"mem_image1": baseUrl + "img/profiles/avatar-01.jpg",
					"mem_image2": baseUrl + "img/profiles/avatar-11.jpg",
					"mem_image3": baseUrl + "img/profiles/avatar-14.jpg",
					"budget": "$300000",
					"currently_spend": "$100000 ",
					"Action": ""
				}
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="project_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['pro_img'] + '" alt="User Image"></a><a href="project_details">' + row['name'] + '</a></h2>';
					}
				},
				{
					"render": function (data, type, row) {
		...
		$('#estimations-list').DataTable({
			...
			"data": [
				...
				},
				{
					...
					"Amount": "$4,18,000",
					"pro_img": baseUrl + "img/priority/project-01.svg",
					"client_img": baseUrl + "img/icons/company-icon-10.svg",
	...
	if ($('#contracts-list').length > 0) {
		$('#contracts-list').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['client_img'] + '" alt="User Image"></a><a href="company_details">' + row['customer'] + '</a></h2>';
					}
				},
				{ "data": "contract_value" },
				{ "data": "contract_type" },
	...
	if ($('#analytic-contact').length > 0) {
		$('#analytic-contact').DataTable({
			...
			"data": [
				{
					...
					"lead_img": baseUrl + "img/profiles/avatar-16.jpg",
					"phone": "+1 124547845",
				...
				},
				{
					...
					"lead_img": baseUrl + "img/profiles/avatar-22.jpg",
					"phone": "+1 478845447",
				...
				},
				{
					...
					"lead_img": baseUrl + "img/profiles/avatar-23.jpg",
					"phone": "+1 215544845",
				...
				},
				{
					...
					"lead_img": baseUrl + "img/profiles/avatar-24.jpg",
					"phone": "+1 124547845",
				...
				},
				{
					...
					"lead_city": "Installer",
					"lead_img": baseUrl + "img/profiles/avatar-20.jpg",
					"phone": "+1 466701256",
					"email": "sharon@example.com",
			...
			"columns": [
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="contact_details" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="' + row['lead_img'] + '" alt="User Image"></a><a href="contact_details" class="d-flex flex-column">' + row['lead_name'] + '<span class="text-default">' + row['lead_city'] + ' </span></a></h2>';
					}
				},
				{ "data": "email" },
				{ "data": "phone" },
		...
		$('#analytic-company').DataTable({
			...
			"data": [
				...
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-05.svg",
					"phone": "+1 124547845",
					"email": "joe@example.com",
					"date": "17 Oct 2023, 11:34 am"
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-07.svg",
					"phone": "+1 124547845",
					"email": "joe@example.com",
					"date": "17 Oct 2023, 11:34 am"
				},
				{
					...
					"lead_img": baseUrl + "img/icons/company-icon-10.svg",
					"phone": "+1 466701256",
					"email": "sharon@example.com",
					"date": "15 Nov 2023, 07:26 pm"
				}
			...
			"columns": [
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['lead_img'] + '" alt="User Image"></a><a href="company_details">' + row['lead_name'] + '</a></h2>';
					}
				},
				{ "data": "email" },
				{ "data": "phone" },
	...
	if ($('#analytic-lead').length > 0) {
		$('#analytic-lead').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="leads_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['lead_img'] + '" alt="User Image"></a><a href="leads_details" class="d-flex flex-column">' + row['lead_name'] + '<span class="text-default">' + row['lead_city'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{
			...
			"data": [
				{
					...
					"checkbox": "",
					"rating": "",
					"lang_img": baseUrl + "img/icons/flag-01.svg",
					"language": "English",
					"code": "en",
					"total": "3481",
					"done": "2861",
				...
				},
				{
					...
					"checkbox": "",
					"rating": "",
					"lang_img": baseUrl + "img/icons/flag-02.svg",
					"language": "Arabic",
					"code": "ar",
					"total": "4815",
					"done": "4815",
				...
				},
				{
					...
					"checkbox": "",
					"rating": "",
					"lang_img": baseUrl + "img/icons/flag-03.svg",
					"language": "Chinese",
					"code": "zh",
					"total": "2590",
					"done": "250",
				...
				},
				{
					...
					"checkbox": "",
					"rating": "",
					"lang_img": baseUrl + "img/icons/flag-04.svg",
					"language": "Hindi",
					"code": "hi",
					"total": "1892",
					"done": "387",
			...
			"data": [
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-02.jpg",
				...
				},
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-01.jpg",
				...
				},
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-04.jpg",
				...
				},
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-03.jpg",
				...
				},
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-05.jpg",
					"assigned_date": "22 Sep 2023",
					"created": "25 Sep 2023, 12:12 pm",
					"due_date": "25 Dec 2023",
					"customer_name": "Carol Thomas",
				...
				},
				{
					...
					"assigned_image": baseUrl + "img/profiles/avatar-06.jpg",
					"assigned_date": "30 Sep 2023",
			...
			"data": [
				{
					...
					"country_image": baseUrl + "img/flags/as.png",
					"state": "Swains Island",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/ad.png",
				...
				},
				{
					...
					"country_image": baseUrl + "img/flags/ao.png",
					"state": "Benguella",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/ai.png",
					"state": "The Valley",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/qa.png",
					"state": "Victoria Land",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/ag.png",
					"state": "Saint Paul",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/ar.png",
					"state": "Santa Fe",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/au.png",
					"state": "Queensland",
					"Action": ""
				},
				{
					...
					"country_image": baseUrl + "img/flags/at.png",
					"state": "Tyrol",
					"Action": ""
				}
				,
				{
					...
					"country_image": baseUrl + "img/flags/az.png",
					"state": "Karabakh",
					"Action": ""
				}
	...
	if ($('#contact-reports').length > 0) {
		$('#contact-reports').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="contact_details" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact_details" class="d-flex flex-column">' + row['customer_name'] + ' <span class="text-default">' + row['customer_no'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['company_image'] + '" alt="User Image"></a><a href="company_details">' + row['company_name'] + '</a></h2>';
					}
				},
				{ "data": "industry" },
				{ "data": "type" },
	...
	if ($('#leads_reports').length > 0) {
		$('#leads_reports').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="company_details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="' + row['company_image'] + '" alt="User Image"></a><a href="company_details" class="d-flex flex-column">' + row['company_name'] + '<span class="text-default">' + row['company_address'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
			...
			"data": [
				{
					...
					"status": "1",
					"created_date": "25 Sep 2023, 01:22 pm",
					"img": baseUrl + "img/profiles/avatar-14.jpg",
