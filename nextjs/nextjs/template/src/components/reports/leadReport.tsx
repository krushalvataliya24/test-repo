...
import LeadsReportChart1 from "../charts/LeadsReportchart1";
import LeadsReportChart2 from "../charts/LeadsReportchart2";

const LeadReportComponent = () => {
...
export default LeadReportComponent;
