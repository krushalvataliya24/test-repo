...
import CountriesModal from "../../core/modals/countriesModal";
import Table from "../../core/common/dataTable/index";
import CollapseHeader from "../../core/common/collapse-header";
import { all_routes } from "@/data/all_routes";
import { CountriesData } from "@/data/json/countries_data";
...
const CountryComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a: any, b: any) => a.country_code.length - b.country_code.length,
    },

    {
      title: "Country ID",
      dataIndex: "country_id",
      sorter: (a: any, b: any) => a.country_id.length - b.country_id.length,
    },
    {
      title: "Country Name",
