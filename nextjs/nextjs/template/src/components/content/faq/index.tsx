...
import { faqData } from '@/data/json/faq';
        ...
        },
        {
            ...
            render: () => (
                <div className="dropdown table-action">
                    <Link href="#" className="action-icon" data-bs-toggle="dropdown" aria-expanded="true">
                    ...
                    <div className="dropdown-menu dropdown-menu-right" style={{ position: 'absolute', inset: '0px auto auto 0px', margin: '0px', transform: 'translate3d(-99.3333px, 35.3333px, 0px)' }} data-popper-placement="bottom-start">
                        <Link className="dropdown-item edit-popup" href="#" 
                        ...
                        <Link className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_page">
