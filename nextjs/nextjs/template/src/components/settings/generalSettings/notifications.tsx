          ...
          <div className="col-md-12">
            ...
            <div className="card">
              ...
              <ul className="nav nav-tabs nav-tabs-bottom">
                      ...
                      <li  className="nav-item me-3">
                        <Link href={route.companySettings} className='nav-link px-0'>
                          <i className="ti ti-world-cog" /> Website Settings
                        </Link>
                      </li>
                      <li  className="nav-item me-3">
                        <Link href={route.invoiceSettings} className='nav-link px-0'>
                      ...
                      <li  className="nav-item me-3">
                        <Link href={route.paymentGateways} className='nav-link px-0'>
      ...
      <div className="card-body">
        <div className="settings-sidebar">
          ...
          <div className="list-group list-group-flush settings-sidebar">
            ...
            <Link href={route.notification} className="fw-medium active">
              Notifications
            </Link>
            <Link href={route.connectedApps} className="fw-medium">
              Connected Apps
            </Link>
          </div>
        </div>
          ...
          <div className="modal-body">
            <div className="success-message text-center">
              ...
              <div className="col-lg-12 text-center modal-btn">
                ...
                <Link href={route.security} className="btn btn-danger">Yes, Delete it</Link>
              </div>
            </div>
          </div>
        </div>
