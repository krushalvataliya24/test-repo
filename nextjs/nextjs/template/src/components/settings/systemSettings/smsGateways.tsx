          ...
          <div className="col-md-12">
            ...
            <div className="card">
              ...
              <ul className="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li className="nav-item me-3">
                      <Link href={route.emailSettings} className="nav-link px-0 active">
      ...
      <div className="card-body">
        <div className="settings-sidebar">
          ...
          <div className="list-group list-group-flush settings-sidebar">
            <Link href={route.emailSettings} className="fw-medium">
              Email Settings
            </Link>
            <Link href={route.smsGateways} className="fw-medium active">
              SMS Gateways
            </Link>
            <Link href={route.gdprCookies} className="fw-medium">
              GDPR Cookies
            </Link>
          </div>
        </div>
