      ...
      <div className="card-body">
        <div className="settings-sidebar">
          ...
          <div className="list-group list-group-flush settings-sidebar">
            <Link href={route.invoiceSettings} className="fw-medium">
              Invoice Settings
            </Link>
            <Link href={route.printers} className="fw-medium active">
              Printer
            </Link>
            <Link href={route.customFields} className="fw-medium">
              Custom Fields
            </Link>
          </div>
        </div>
...
export default PrintersComponent