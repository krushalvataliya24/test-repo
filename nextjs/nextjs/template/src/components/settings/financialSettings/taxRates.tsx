      ...
      <div className="card-body">
        <div className="settings-sidebar">
          ...
          <div className="list-group list-group-flush settings-sidebar">
            <Link href={route.paymentGateways} className="fw-medium">
              Payment Gateways
            </Link>
            <Link href={route.bankAccounts} className="fw-medium">
              Bank Accounts
            </Link>
            <Link href={route.taxRates} className="fw-medium active">
              Tax Rates
            </Link>
            <Link href={route.currencies} className="fw-medium">
              Currencies
            </Link>
          </div>
        </div>
          ...
          <div className="col-md-4">
            <div className="mb-3">
              ...
              <div className="icon-form-end">
                <Link href="#" data-bs-toggle="modal" data-bs-target="#edit_tax">
