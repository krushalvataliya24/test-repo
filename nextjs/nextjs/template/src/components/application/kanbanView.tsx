...
const initialColumns = {
  ...
  column4: {
    title: "Completed",
    tasks: [
      { id: "task8", content: "Task 7", priority: "Medium" },
    ],
  },
};
const initialColumns2 = {
  ...
  column3: {
    title: "On-hold",
    tasks: [
      { id: "task12", content: "Task 5", priority: "High" },
    ],
  },
  column4: {
    title: "Completed",
    tasks: [
      { id: "task13", content: "Task 6", priority: "Medium" },
    ],
  },
};
const initialColumns3 = {
  column1: {
    title: "New",
    tasks: [
      { id: "task14", content: "Task 1", priority: "Medium" },
    ],
  },
  column2: {
    title: "Inprogress",
  ...
  column3: {
    title: "On-hold",
    tasks: [
      { id: "task18", content: "Task 5", priority: "Medium" },
    ],
  },
  column4: {
    title: "Completed",
    tasks: [
      { id: "task19", content: "Task 7", priority: "Medium" },
    ],
  },
};
const initialColumns4 = {
  ...
  column3: {
    title: "On-hold",
    tasks: [
      { id: "task25", content: "Task 5", priority: "Low" },
    ],
  },
  column4: {
    title: "Completed",
    tasks: [
      { id: "task28", content: "Task 7", priority: "Medium" },
    ],
  },
};
const KanbanViewComponent = () => {
  ...
  const [columns3, setColumns3] = useState(initialColumns3);
  const [columns4, setColumns4] = useState(initialColumns4);
                                  ...
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column.title === 'New' ? "bg-soft-pink" : column.title === 'Inprogress' ? 'bg-soft-skyblue' : column.title === 'Completed' ?"bg-soft-success": "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column.title === 'New' ? 'bg-pink' : column.title === 'Inprogress' ? 'bg-skyblue' :column.title === 'Completed' ?"bg-success": 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                                            ...
                                            <div className="card-body">
                                              <div className="d-flex align-items-center justify-content-between mb-3">
                                                <div className="d-flex align-items-center">
                                                  ...
                                                  <span className={`badge ${task.priority === "Low" ? 'bg-success' : task.priority === 'Medium'? "bg-warning" :"bg-purple"}  badge-xs d-flex align-items-center justify-content-center`}>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column2.title === 'New' ? "bg-soft-pink" : column2.title === 'Inprogress' ? "bg-soft-skyblue" : column2.title === 'Completed' ?"bg-soft-success": "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column2.title === 'New' ? 'bg-pink' : column2.title === 'Inprogress' ? 'bg-skyblue' :column2.title === 'Completed' ?"bg-success": 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                                        <h5 className="me-2">{column2.title}</h5>
                                        <span className="badge bg-light rounded-pill">
                                          02
                                        </span>
                                      </div>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column3.title === 'New' ? "bg-soft-pink" : column3.title === 'Inprogress' ? "bg-soft-skyblue" : column3.title === 'Completed' ?"bg-soft-success": "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column3.title === 'New' ? 'bg-pink' : column3.title === 'Inprogress' ? 'bg-skyblue' : column3.title === 'Completed' ?"bg-soft-success": 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                                        <h5 className="me-2">{column3.title}</h5>
                                        <span className="badge bg-light rounded-pill">
                                          02
                                        </span>
                                      </div>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column4.title === 'New' ? "bg-soft-pink" : column4.title === 'Inprogress' ? "bg-soft-skyblue" : column4.title === 'Completed' ?"bg-soft-success": "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column4.title === 'New' ? 'bg-pink' : column4.title === 'Inprogress' ? 'bg-skyblue' :column4.title === 'Completed' ?"bg-success": 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                                        <h5 className="me-2">{column4.title}</h5>
                                        <span className="badge bg-light rounded-pill">
                                          02
                                        </span>
                                      </div>
