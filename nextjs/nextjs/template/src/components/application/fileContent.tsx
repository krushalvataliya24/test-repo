              ...
              <div className="video-section d-flex">
                <div className="item me-2">
                  <div className="js-player">
                    <img src="assets/img/file-manager/video3.jpg" />
                  </div>

                  <div className="info">
                    <div className="d-flex align-items-center justify-content-between">
                      <h6 className="popup-toggle">
                        <Link href="#">Demoparticles.mp4</Link>
                      </h6>
                      <div className="d-flex align-items-center">
                ...
                <div className="item me-2">
                  <div className="js-player">
                    <img src="assets/img/file-manager/video2.jpg" />
                  </div>

                  <div className="info">
                    <div className="d-flex align-items-center justify-content-between">
                      <h6 className="popup-toggle">
                        <Link href="#">Android_bike.mp4</Link>
                      </h6>
                      <div className="d-flex align-items-center">
                        <Link href="#" className="d-flex align-items-center">
                          <Star className="feather-16 me-2" />
