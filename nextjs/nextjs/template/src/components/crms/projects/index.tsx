...
import { projectData } from "@/data/json/projectsData";
    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <div className="table-avatar d-flex align-items-center">
          <Link href={route.projectDetails} className="avatar avatar-sm border me-2">
            <img
      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          >
           ...
           <Link className="dropdown-item" href="#" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit"><i className="ti ti-edit text-blue"></i> Edit</Link>
            <Link
                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                      ...
                      <div className="d-flex align-items-center flex-wrap row-gap-2">
                        ...
                        <div className="view-icons">
                          <Link href={route.projects} className="active">
                            <i className="ti ti-list-tree" />
                          </Link>
                          <Link href={route.projectsGrid}>
