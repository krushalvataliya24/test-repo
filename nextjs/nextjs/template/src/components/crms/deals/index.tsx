...
import { DealsInterface } from "../../../data/interface/index";
...
import { dealsData } from "@/data/json/dealsData";
...
const DealsComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: any) => (
        <div>
          <div><Link href={route.dealsDetails} className="title-name">{text}</Link></div>
        </div>
      ),
                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                    <div className="d-flex align-items-center flex-wrap row-gap-2">
                      ...
                      <div className="icon-form">
                        <span className="form-icon custom-daterange">
                    ...
                    <div className="d-flex align-items-center flex-wrap row-gap-2">
                          ...
                          <div className="filter-set-view">
                            ...
                            <div className="filter-reset-btns">
                              <div className="row">
                                ...
                                <div className="col-6">
                                  <Link href={route.deals} className="btn btn-primary">
                                    Filter
                                  </Link>
                                </div>
                              </div>
                      ...
                      <div className="view-icons">
                        <Link href={route.deals} className="active">
                          <i className="ti ti-list-tree" />
                        </Link>
                        <Link href={route.dealsKanban}>
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <Link href="" className="label-add " data-bs-toggle="offcanvas" data-bs-target="#offcanvas_pipeline">
            ...
            <div className="modal-body">
              <div className="text-center">
                ...
                <div className="d-flex align-items-center justify-content-center mt-4">
                  ...
                  <Link href={route.deals} data-bs-dismiss="modal" className="btn btn-danger">
                    Yes, Delete it
                  </Link>
                </div>
              </div>
