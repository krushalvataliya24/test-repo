                ...
                <div className="card mb-3">
                  <div className="card-body pb-0">
                    ...
                    <div className="pipeline-list">
                      <ul>
                        <li>
                          <Link href="#" className="bg-pending">
                            Quality To Buy
                          </Link >
                        </li>
                        <li>
                          <Link href="#" className="bg-info">
                            Contact Made
                          </Link>
                        </li>
                        <li>
                          <Link href="#" className="bg-warning">
                            Presentation
                          </Link>
                        </li>
                        <li>
              ...
              <div className="modal-body">
                <div className="text-center">
                  ...
                  <div className="d-flex align-items-center justify-content-center mt-4">
                    ...
                    <Link href={route.contactList} className="btn btn-danger">
                      Yes, Delete it
                    </Link>
                  </div>
                </div>
