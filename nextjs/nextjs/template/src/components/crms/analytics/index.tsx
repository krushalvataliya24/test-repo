...
import DealsByCharts from "@/components/charts/analytics/dealsByChart";
import WonChartComponent from "@/components/charts/analytics/wonChart";
import LeadsChartComponent from "@/components/charts/analytics/leadsChart";
import LostChartComponent2 from "@/components/charts/analytics/lostChart2";
import LostChartComponent from "@/components/charts/analytics/lostChart";
                ...
                <div className="card-header d-flex justify-content-between align-items-center flex-wrap">
                  ...
                  <div className="card-select">
                    <ul>
                      ...
                      <li>
                      <Link href="#" className="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add" ><i className="ti ti-square-rounded-plus me-2"></i>Add New Activity</Link>
                      </li>
                    </ul>
                  </div>
                </div>
