          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 border-top mt-4 pt-4 mb-4">
            ...
            <div className="d-flex align-items-center flex-wrap row-gap-2">
                ...
                <div className="filter-dropdown-menu dropdown-menu  dropdown-menu-md-end p-4">
                  <div className="filter-set-view">
                    ...
                    <div className="filter-reset-btns">
                      <div className="row">
                        <div className="col-6">
                          <Link href={route.InvoiceList} className="btn btn-light">
                            Reset
                          </Link>
                        </div>
                        <div className="col-6">
                          <Link
                            href={route.InvoiceGrid}
                            className="btn btn-primary"
                          >
                            Filter
                          </Link>
              ...
              <div className="view-icons">
                <Link href={route.InvoiceList}>
                  <i className="ti ti-list-tree" />
                </Link>
                <Link href={route.InvoiceGrid} className="active">
              ...
              <div className="modal-body">
                <div className="text-center">
                  ...
                  <div className="d-flex align-items-center justify-content-center mt-4">
                    ...
                    <Link href="{route.InvoiceList}" className="btn btn-danger">
                      Yes, Delete it
                    </Link>
                  </div>
                </div>
