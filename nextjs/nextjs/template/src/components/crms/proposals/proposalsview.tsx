...
import { proposalsview } from "@/data/json/proposalsview";
        ...
        <div className={"toggle-popup"
          ...
          <div className="sidebar-layout d-none">
            <div className="sidebar-header">
              ...
              <Link href="#" className="sidebar-close toggle-btn">
                <i className="ti ti-x" />
             </Link>
            </div>
                ...
                <div className="card-body">
                  <div className="details-propsal">
                    ...
                    <ul>
                      ...
                      <li>
                        <h5>Status</h5>
                        <Link href="#" className="badge badge-secondary">
                          Sent
                       </Link>
                      </li>
                    </ul>
                    ...
                    <div className="tab-pane fade" id="comments">
                      ...
                      <div className="renewal-content">
                        ...
                        <div className="renewal-content-btn">
                          <Link href="#" className="btn btn-primary add-popups">
                            Renew Now
                         </Link>
                        </div>
                      </div>
        ...
        <div  className={ "toggle-popup1"
          ...
          <div className="sidebar-layout">
            <div className="sidebar-header">
              ...
              <Link href="#" className="sidebar-close2 toggle-btn">
                <i className="ti ti-x" />
             </Link>
            </div>
            <div className="toggle-body">
        ...
        <div className={
          ...
          <div className="sidebar-layout">
            <div className="sidebar-header">
              ...
              <Link href="#" className="sidebar-close1 toggle-btn">
                <i className="ti ti-x" />
             </Link>
            </div>
            <div className="toggle-body">
              <form  className="toggle-height">
                ...
                <div className="submit-button text-end">
                  <Link href="#" className="btn btn-light sidebar-close1">
                    Cancel
                 </Link>
                  <button type="submit" className="btn btn-primary">
                    Save Changes
              ...
              <div className="modal-body">
                <div className="success-message text-center">
                  ...
                  <div className="col-lg-12 text-center modal-btn">
                    ...
                    <Link href={route.activities} className="btn btn-danger">
                      Yes, Delete it
                   </Link>
                  </div>
                </div>
                        ...
                        <label className="checkboxs">
                          ...
                          <span className="people-profile">
                            <img
                              ...
                              alt=""
                            />
                            <Link href="#">RiverStone Ventur</Link>
                          </span>
                        </label>
                      </li>
                      <li className="select-people-checkbox">
