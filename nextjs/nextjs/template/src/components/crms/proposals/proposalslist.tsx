...
import { proposallistData } from "@/data/json/proposallist";
...
const Proposalslist = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <h2 className="table-avatar d-flex align-items-center">
          <Link href="#" className="avatar avatar-sm border me-2">
            <img
              className="w-auto h-auto"
              src={record.pro_img}
              alt="User Image"
          ...
          <Link href="#" className="profile-split d-flex flex-column">
            Truelysell
          </Link>
        </h2>
      ),
    ...
    },
    {
      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          <Link className="dropdown-item" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit" href="#"><i className="ti ti-edit text-blue"></i> Edit</Link>
                      ...
                      <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                        ...
                        <div className="d-flex align-items-center flex-wrap row-gap-2">
                          ...
                          <div className="view-icons">
                            <Link href={route.ProposalsList} className="active">
                              <i className="ti ti-list-tree" />
                            </Link>
                            <Link href={route.ProposalsGrid}>
