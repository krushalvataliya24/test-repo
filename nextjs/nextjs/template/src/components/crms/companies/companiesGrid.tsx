                ...
                <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                  ...
                  <div className="d-flex align-items-center flex-wrap row-gap-2">
                    ...
                    <div className="view-icons">
                      ...
                      <Link href={route.companiesGrid} className="active">
        ...
        <div className="card-body">
          <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <h6>
                  <Link href={route.companyDetails} className="fw-medium">
                    NovaWave LLC
                  </Link>
                </h6>
            ...
            <div className="dropdown table-action">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                ...
                <Link className="dropdown-item" href={route.companyDetails}>
          ...
          <div className="d-flex justify-content-between align-items-center flex-wrap row-gap-2 border-top pt-3 mt-3">
            ...
            <div className="d-flex align-items-center grid-social-links">
              ...
              <Link href="#" className="avatar avatar-xs text-dark rounded-circle">
...
<div className="success-message text-center">
  ...
  <div className="col-lg-12 text-center modal-btn">
    ...
    <Link href={route.companyDetails} className="btn btn-primary">
      View Details
    </Link>
  </div>
</div>
