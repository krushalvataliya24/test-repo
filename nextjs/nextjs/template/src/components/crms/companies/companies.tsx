...
import { companiesData } from "@/data/json/companiesData";
      ...
      render: () => (
        <div className="dropdown table-action">
          ...
          <div className="dropdown-menu dropdown-menu-right">
            ...
            <Link className="dropdown-item" href={route.companyDetails}><i className="ti ti-eye text-blue-light"></i> Preview</Link>
          </div>
        </div>
      ),
    },
