...
import { estimationListData } from "@/data/json/estimationList";
    ...
    },
    {
      ...
      render: (text: any, record: any) => (
        <div className="table-avatar d-flex align-items-center table-padding">
          ...
          <Link href={route.companyDetails} className="profile-split">
            {record.client}
          </Link>
        </div>
      ),
    ...
    },
    {
      ...
      render: (text: string, record: any) => (
        <div className="table-avatar d-flex align-items-center">
          <Link href={route.contactDetails} className="avatar avatar-sm me-2">
            <img
              className="w-auto h-auto"
              src={record.img3}
              alt={text}
                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap mb-4 row-gap-2">
                      ...
                      <div className="d-flex align-items-center flex-wrap row-gap-2">
                        ...
                        <div className="view-icons">
                          <Link  href={route.estimationList} className="active">
                            <i className="ti ti-list-tree" />
                          </Link>
                          <Link  href={route.estimationKanban}>
