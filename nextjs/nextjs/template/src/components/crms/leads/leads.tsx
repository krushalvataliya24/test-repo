...
const LeadsComponent = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "lead_name",
      render: (text: any) => (
        <Link href={route.leadsDetails} className="title-name">
          {text}
        </Link>
      ),
                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                      ...
                      <div className="d-flex align-items-center flex-wrap row-gap-2">
                        ...
                        <div className="view-icons">
                          <Link href={route.leads} className="active">
                            <i className="ti ti-list-tree" />
                          </Link>
                          <Link href={route.leadsKanban}>
          ...
          <div className="modal-body">
            <div className="success-message text-center">
              ...
              <div className="col-lg-12 text-center modal-btn">
                ...
                <Link href={route.leadsDetails} onClick={() => setOpenModal2(false)} className="btn btn-primary">
                  View Details
                </Link>
              </div>
            </div>
          ...
          <div className="modal-body">
            <div className="success-message text-center">
              ...
              <div className="col-lg-12 text-center modal-btn">
                ...
                <Link href={route.companyDetails} onClick={() => setOpenModal(false)} className="btn btn-primary">
                  View Details
                </Link>
              </div>
            </div>
