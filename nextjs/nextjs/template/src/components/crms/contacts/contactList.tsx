  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string, record: any, index: number) => (
        ...
        <Link href={route.contactDetails} className="d-flex flex-column">
      ...
      render: (index: number) => (
        <div className="dropdown table-action" key={index}>
          ...
          >
            ...
            <Link className="dropdown-item" href={route.contactDetails}><i className="ti ti-eye text-blue-light"></i> Preview</Link>
          </div>
        </div>
      ),
    },
              ...
              <div className="modal-body">
                <div className="success-message text-center">
                  ...
                  <div className="col-lg-12 text-center modal-btn">
                    ...
                    <Link href={route.contactDetails} className="btn btn-primary">
                      View Details
                    </Link>
                  </div>
                </div>
