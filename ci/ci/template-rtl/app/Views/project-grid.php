										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/truellysel.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Truelysell</a></h5>
															<p>Web App</p>
														</div>
													</div>
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-14.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-15.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-01.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>NovaWave LLC</p>
														</div>
													</div>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/dreamchat.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Dreamschat</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-01.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-02.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-02.svg" class="w-auto h-auto" alt="img">
															</span>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/truellysell.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Truelysell</a></h5>
															<p>Web App</p>
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-04.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-05.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-03.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>SilverHawk</p>
														</div>
													</div>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/servbook.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Servbook</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-07.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-08.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-04.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>SilverHawk</p>
														</div>
													</div>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/dream-pos.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">DreamPOS</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-10.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-11.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-05.svg" class="w-auto h-auto" alt="img">
															</span>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/project-01.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Kofejob</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															...
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-16.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img src="<?php echo base_url();?>assets/img/profiles/avatar-17.jpg" alt="img">
															</span>
															<a class="avatar text-default bg-white border avatar-rounded fs-12" href="javascript:void(0);">
																+03
															</a>
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-06.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>CoastalStar Co.</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Doccure</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-18.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-19.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-07.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>HarborView</p>
														</div>
													</div>
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/best.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Best@laundry</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-21.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-22.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-08.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>Golden Gate Ltd</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">POS</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-24.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-25.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-09.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>CoastalStar Inc</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-27.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-28.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
														...
														<div class="d-flex align-items-center">
															<span class="avatar avatar-sm border flex-shrink-0 me-2">
																<img src="<?php echo base_url();?>assets/img/icons/company-icon-10.svg" class="w-auto h-auto" alt="img">
															</span>
															<p>Redwood Inc</p>
														</div>
													</div>
											...
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Dreamchat</a></h5>
															<p>Meeting</p>
														</div>
													</div>
													<div class="dropdown table-action">
												...
												<div class="d-block">
													...
													<div class="d-flex align-items-center justify-content-between mb-3">
														<div class="avatar-list-stacked avatar-group-xs">
															...
															<span class="avatar avatar-rounded">
																<img class="border border-white" src="<?php echo base_url();?>assets/img/profiles/avatar-12.jpg" alt="img">
															</span>
															<span class="avatar avatar-rounded">
										...
										<div class="card border">
											<div class="card-body">
												...
												<div class="d-flex align-items-center justify-content-between bg-light-200 rounded p-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>project-details" class="avatar avatar-lg border bg-white flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/priority/sports.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h5 class="fw-semibold"><a href="<?php echo base_url();?>project-details">Sports</a></h5>
															<p>Web App</p>
														</div>
													</div>
													<div class="dropdown table-action">
