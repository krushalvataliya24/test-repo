							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="<?php echo base_url();?>estimations" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap mb-4 row-gap-2">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="<?php echo base_url();?>estimations" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="view-icons">
											<a href="<?php echo base_url();?>estimations" class="active"><i class="ti ti-list-tree"></i></a>
											<a href="<?php echo base_url();?>estimations-kanban"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>	
								</div>
								<!-- /Filter -->
										...
										<tbody>
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center">
														<a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2">
															<img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-01.svg" alt="User Image">
														</a>
														<a href="<?php echo base_url();?>company-details">NovaWave LLC</a>
													</h2>
												</td>
												<td>$2,15,000</td>
												<td>
													<h2 class="d-flex align-items-center">
														<a href="#" class="avatar avatar-sm border me-2">
															<img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/truellysel.svg" alt="User Image">
														</a>
														<a href="#">Truelysell</a>
													</h2>
												</td>
												...
												<td>
													<h2 class="d-flex align-items-center">
														<a href="#" class="avatar avatar-sm me-2">
															<img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-19.jpg" alt="User Image">
														</a>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center">
														<a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2">
															<img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-02.svg" alt="User Image">
														</a>
														<a href="<?php echo base_url();?>company-details">BlueSky Industries</a>
													</h2>
												</td>
												<td>$1,45,000</td>
												<td>
													<h2 class="d-flex align-items-center">
														<a href="#" class="avatar avatar-sm border me-2">
															<img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/dreamchat.svg" alt="User Image">
														</a>
														<a href="#">Dreamschat</a>
													</h2>
												</td>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/profiles/avatar-20.jpg" alt="User Image"></a><a href="javascript:void(0);"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
														class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-03.svg" alt="User Image"></a><a
														href="<?php echo base_url();?>company-details">Silver Hawk</a></h2>
												</td>
												<td>$2,15,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
													src="<?php echo base_url();?>assets/img/priority/truellysell.svg" alt="User Image"></a><a href="#">Truelysell</a></h2>
												</td>
												<td>24 Oct 2023</td>
												<td>20 Oct 2026</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto"
													src="<?php echo base_url();?>assets/img/profiles/avatar-21.jpg" alt="User Image"></a><a href="javascript:void(0);"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-04.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details">Summit Peak</a></h2>
												</td>
												<td>$4,80,380</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/servbook.svg" alt="User Image"></a><a href="#">Servbook</a></h2>
												</td>
												<td>10 Nov 2023</td>
												<td>07 Oct 2028</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/profiles/avatar-23.jpg" alt="User Image"></a><a href="javascript:void(0);"
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-05.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">RiverStone Ventur</a></h2>
												</td>
												<td>$2,12,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/dream-pos.svg" alt="User Image"></a><a href="#">DreamPOS</a></h2>
												</td>
												<td>18 Nov 2023</td>
												<td>10 Oct 2026</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-16.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Carol Thomas<span class="text-default">UI /UX Designer </span></a></h2>
												</td>
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-07.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">CoastalStar Co.</a></h2>
												</td>
												<td>$3,50,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/project-01.svg" alt="User Image"></a><a href="#">Kofejob</a></h2>
												</td>
												<td>20 Nov 2023</td>
												<td>18 Oct 2027</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-22.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Dawn Mercha<span class="text-default">Technician </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-warning">Draft</span></td>
												<td>
													<div class="dropdown table-action">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-08.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">HarborView</a></h2>
												</td>
												<td>$1,23,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/project-02.svg" alt="User Image"></a><a href="#">Doccure</a></h2>
												</td>
												<td>07 Dec 2023</td>
												<td>05 Nov 2026</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-24.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Rachel Hampton<span class="text-default">Software Developer </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-violet">Sent</span></td>
												<td>
													<div class="dropdown table-action">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-09.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">Golden Gate Ltd</a></h2>
												</td>
												<td>$3,12,50</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/best.svg" alt="User Image"></a><a href="#">Best@laundry</a></h2>
												</td>
												<td>14 Dec 2023</td>
												<td>11 Nov 2028</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-24.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Jonelle Curtiss<span class="text-default">Supervisor </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-success">Accepted</span></td>
												<td>
													<div class="dropdown table-action">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-10.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">Golden Gate Ltd</a></h2>
												</td>
												<td>$4,18,000</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/project-01.svg" alt="User Image"></a><a href="#">Dreamsports</a></h2>
												</td>
												<td>22 Dec 2023</td>
												<td>20 Nov 2027</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-26.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Jonathan<span class="text-default">Team Lead Dev </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-danger">Declined</span></td>
												<td>
													<div class="dropdown table-action">
											...
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-01.svg" alt="User Image"></a><a href="<?php echo base_url();?>company-details">NovaWave LLC</a></h2>
												</td>
												<td>$4,80,380</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/priority/truellysel.svg" alt="User Image"></a><a href="#">Truelysell</a></h2>
												</td>
												<td>28 Dec 2023</td>
												<td>25 Nov 2026</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="<?php echo base_url();?>assets/img/profiles/avatar-01.jpg" alt="User Image"></a><a href="javascript:void(0);" class="d-flex flex-column">Brook<span class="text-default">Team Lead Dev </span></a></h2>
												</td>
												<td><span class="badge badge-pill badge-status bg-success">Accepted</span></td>
												<td>
													<div class="dropdown table-action">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>estimations" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
