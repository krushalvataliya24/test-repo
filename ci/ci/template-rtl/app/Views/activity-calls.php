									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
										<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="active-list">													
												<ul class="mb-0">
													<li>
														<a href="<?php echo base_url();?>activity-calls" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Calls"><i class="ti ti-phone"></i></a>
													</li>
													<li>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>activity-calls" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
