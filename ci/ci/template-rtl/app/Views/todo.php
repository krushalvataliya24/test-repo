																...
																<div class="todo-widget">
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			<img src="<?php echo base_url(); ?>assets/img/users/user-24.jpg" alt="Img" class="img-fluid">
																...
																<div class="todo-widget">
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			...
																			<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-02.jpg" alt="Img" class="img-fluid">
																			<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="fas fa-ellipsis-v"></i>
																			</a>
																			<div class="dropdown-menu notes-menu dropdown-menu-end">
																	...
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			<img src="<?php echo base_url(); ?>assets/img/users/user-11.jpg" alt="Img" class="img-fluid">
																			<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="fas fa-ellipsis-v"></i>
																			</a>
																			<div class="dropdown-menu notes-menu dropdown-menu-end">
																	...
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			<img src="<?php echo base_url(); ?>assets/img/users/user-02.jpg" alt="Img" class="img-fluid">
																			<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="fas fa-ellipsis-v"></i>
																			</a>
																			<div class="dropdown-menu notes-menu dropdown-menu-end">
															...
															<div class="accordion-body">
																<div class="todo-widget">
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			<img src="<?php echo base_url(); ?>assets/img/users/user-25.jpg" alt="Img" class="img-fluid">
																			<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="fas fa-ellipsis-v"></i>
																			</a>
																			<div class="dropdown-menu notes-menu dropdown-menu-end">
																	...
																	<div class="todo-wrapper-list">
																		...
																		<div class=" todo-profile d-flex align-items-center">
																			<img src="<?php echo base_url(); ?>assets/img/users/user-04.jpg" alt="Img" class="img-fluid">
																			<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
																				<i class="fas fa-ellipsis-v"></i>
																			</a>
																			<div class="dropdown-menu notes-menu dropdown-menu-end">
										...
										<div class="row">
											<div class="todo-widget">
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-03.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
												...
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" alt="Img" class="img-fluid me-0">
											...
											<div class="todo-widget">
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														...
														<img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
												...
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-06.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
												...
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-07.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
										...
										<div class="row">
											<div class="todo-widget">
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-08.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
												...
												<div class="todo-wrapper-list">
													...
													<div class=" todo-profile d-flex align-items-center">
														<img src="<?php echo base_url(); ?>assets/img/users/user-09.jpg" alt="Img" class="img-fluid">
														<a href="#" data-bs-toggle="dropdown" aria-expanded="false">
															<i class="fas fa-ellipsis-v"></i>
														</a>
														<div class="dropdown-menu notes-menu dropdown-menu-end">
