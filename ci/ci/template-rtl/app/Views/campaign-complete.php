...
<div class="page-wrapper">
				...
				<div class="row">
					...
					<?= $this->include('partials/page-title') ?>
						...
						<div class="campaign-tab">
							<ul class="nav">
								<li>
									<a href="<?php echo base_url();?>campaign">Active Campaign<span>24</span></a>
								</li>
								<li>
									<a href="<?php echo base_url();?>campaign-complete" class="active">Completed Campaign</a>
								</li>
								<li>
									<a href="<?php echo base_url();?>campaign-archieve">Archived Campaign</a>
								</li>
							</ul>
						</div>
						<!-- Campaign Tab -->
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="<?php echo base_url();?>campaign-archieve" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="<?php echo base_url();?>campaign-archieve">
					<div>
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>campaign" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal custom-modal fade" id="save_view" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo base_url();?>campaign">
							<div class="mb-3">
