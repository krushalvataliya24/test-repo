									...
									<div class="meeting-list">
										<div class="recession-meet-blk">
											...
											<div class="partispant-blk">
												<a href="javascript:void(0);" class="btn btn-primary me-2"><i data-feather="plus"></i>Add Participants</a>
												<span class="partispant-chat me-2"><a href="javascript:void(0);" id="show-message"><i class="bx bx-message-alt-dots"></i></a></span>
												<span class="partispant-users"><a href="javascript:void(0);" id="add-partispant"><i class="bx bx-user"></i></a></span>
											</div>
										</div>
										...
										<div class="join-contents horizontal-view fade-whiteboard">
											<div class="join-video user-active">
												<img src="<?php echo base_url(); ?>assets/img/join-call.jpg" class="img-fluid" alt="Logo">
											...
											<div class="owl-carousel video-slide owl-theme">
												<div class="join-video single-user">
													<img src="<?php echo base_url(); ?>assets/img/users/user-01.jpg" class="img-fluid" alt="Logo">
												...
												<div class="join-video single-user">
													<img src="<?php echo base_url(); ?>assets/img/users/user-02.jpg" class="img-fluid" alt="Logo">
													<div class="part-name sub-part-name">
														<h4>Linnea</h4>
													</div>
													<div class="more-icon">
												...
												<div class="join-video single-user">
													<img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" class="img-fluid" alt="Logo">
													<div class="part-name sub-part-name">
														<h4>Richard</h4>
													</div>
													<div class="more-icon">
												...
												<div class="join-video single-user">
													<img src="<?php echo base_url(); ?>assets/img/users/user-03.jpg" class="img-fluid" alt="Logo">
													<div class="part-name sub-part-name">
														<h4>Freda</h4>
													</div>
													<div class="more-icon">
													...
													<ul class="user-list mt-2">
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-02.jpg" alt="image">
																</div>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-03.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Benjamin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-04.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Kaitlin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-05.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Alwin</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-06.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>Freda</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-08.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>John Doe</h5>
														...
														<li>
															<div class="user-list-item">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-09.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
																		<h5>John Blair</h5>
														...
														<li>
															<div class="user-list-item mb-0">
																<div class="avatar ">
																	<img src="<?php echo base_url(); ?>assets/img/users/user-10.jpg" alt="image">
																</div>
																<div class="users-list-body">
																	<div class="name-list-user out-going-call">
