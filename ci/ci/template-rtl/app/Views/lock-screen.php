                                        ...
                                        <div class="card border p-sm-3">
                                            <div class="card-body p-4">
                                                <div class="text-center">
                                                    ...
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xxxl rounded-circle mb-4"><img src="<?php echo base_url();?>assets/img/profiles/avatar-14.jpg" class="img-fluid rounded-circle" alt="Profile"></span>
