...
<head>
	 <!-- Title -->
	 <title>Contacts Grid | CRMS - Advanced Bootstrap 5 Admin Template for Customer Management</title>	
...
<div class="page-wrapper">
							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="<?php echo base_url();?>contracts-grid" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
							...
							<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 border-top mt-4 pt-4 mb-4">
								...
								<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="filter-set-view">
												...
												<div class="filter-reset-btns">
													<div class="row">
														...
														<div class="col-6">
															<a href="<?php echo base_url();?>contracts-grid" class="btn btn-primary">Filter</a>
														</div>
													</div>
												</div>
											</div>
									...
									<div class="view-icons">
										<a href="<?php echo base_url();?>contracts"><i class="ti ti-list-tree"></i></a>
										<a href="<?php echo base_url();?>contracts-grid" class="active"><i class="ti ti-grid-dots"></i></a>
									</div>
								</div>
							</div>
							<!-- /Filter -->
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="<?php echo base_url();?>contracts">
					<div>
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
							...
							<div class="col-md-12">
								<div class="mb-3">
									<label class="col-form-label">Contact Value<span class="text-danger">*</span></label>
									<select class="select2">
										<option>Choose</option>
										<option>Mobile App</option>
										<option>Meeting</option>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>contracts-grid" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
