    ...
    <div class="main-wrapper">
							...
							<div class="row align-items-center">
								...
								<div class="col-8 text-end">
									<div class="head-icons">
										<a href="<?php echo base_url();?>invoices" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh">
								...
								<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
									...
									<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="filter-set-view">
													...
													<div class="filter-reset-btns">
														<div class="row">
															...
															<div class="col-6">
																<a href="<?php echo base_url();?>invoices" class="btn btn-primary">Filter</a>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="view-icons">
											<a href="<?php echo base_url();?>invoices" class="active"><i class="ti ti-list-tree"></i></a>
											<a href="<?php echo base_url();?>invoice-grid"><i class="ti ti-grid-dots"></i></a>
										</div>
									</div>	
								</div>
								<!-- /Filter -->
									...
									<table class="table datatable">
										...
										<tbody>
											<tr>
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-01.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">NovaWave LLC</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/truellysel.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-10.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">BlueSky Industries</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/project-01.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-08.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">Silver Hawk</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/best.svg" alt="User Image"></a><a href="#"
															class="d-flex flex-column">Truelysell</a></h2>
												</td>
												<td>24 Oct 2023</td>
												<td>$2,15,000</td>
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-07.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">Summit Peak</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/project-02.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-05.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">RiverStone Ventur</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/project-01.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
															...
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">CoastalStar Co.</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/dream-pos.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
															...
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">HarborView</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/servbook.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-02.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">Golden Gate Ltd</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/truellysell.svg" alt="User Image"></a><a href="#"
											...
											<tr >
												...
												<td>
													<h2 class="d-flex align-items-center"><a href="<?php echo base_url();?>company-details" class="avatar avatar-sm border me-2"><img
																class="w-auto h-auto" src="<?php echo base_url();?>assets/img/icons/company-icon-09.svg" alt="User Image"></a><a
															href="<?php echo base_url();?>company-details" class="d-flex flex-column">Redwood Inc</a></h2>
												</td>
												<td>
													<h2 class="d-flex align-items-center"><a href="#" class="avatar avatar-sm border me-2"><img class="w-auto h-auto"
																src="<?php echo base_url();?>assets/img/priority/dreamchat.svg" alt="User Image"></a><a href="#"
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="<?php echo base_url();?>invoices">
					<div>
						<div class="row">
							<div class="mb-3">
								<div class="d-flex align-items-center justify-content-between">
									...
									<div class="mb-0">
										...
										<div class="upload-signature ">
											...
											<a href="#" class="text-start">
												<img src="<?php echo base_url();?>assets/img/signature.png" alt="img">
											</a>
										</div>
									</div>
								</div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>invoices" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
