									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="<?php echo base_url();?>email-settings" class="fw-medium active">Email Settings</a>
														...
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
																	<img src="<?php echo base_url();?>assets/img/icons/mail-01.svg" class="w-auto h-auto" alt="">
																</span>
																<div>
												...
												<div class="border rounded p-3 mb-4">
													<div class="row gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
																	<img src="<?php echo base_url();?>assets/img/icons/mail-02.svg" class="w-auto h-auto" alt="">
																</span>
																<div>
												...
												<div class="border rounded p-3">
													<div class="row gy-3">
														<div class="col-sm-5">
															<div class="d-flex align-items-center">
																<span class="avatar avtar-lg border me-2 flex-shrink-0">
																	<img src="<?php echo base_url();?>assets/img/icons/mail-03.svg" class="w-auto h-auto" alt="">
																</span>
																<div>
