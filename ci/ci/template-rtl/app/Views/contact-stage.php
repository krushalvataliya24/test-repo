					...
					<div class="col-md-12">
						...
						<div class="page-header">
							<div class="row align-items-center">
								<div class="col-sm-8">
									<h4 class="page-title">Contact Stages <span class="count-title">123</span></h4>
								</div>
								<div class="col-sm-4 text-sm-end">
									<div class="head-icons">
										<a href="<?php echo base_url();?>contact-stage" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
		...
		<div class="modal fade" id="add_contact_stage" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="<?php echo base_url();?>contact-stage">
						<div class="modal-body">
							<div class="mb-3">
								<label class="col-form-label">Contact Stage <span class="text-danger">*</span></label>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								<a href="#" class="btn btn-light me-2" data-bs-dismiss="modal">Cancel</a>
								<a href="<?php echo base_url();?>contact-stage" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
