									...
									<div class="swiper-container">
										<div class="swiper-wrapper">
											...
											<div class="swiper-slide">
												<div class="top-contacts-box">
													<div class="profile-img online">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-07.jpg" alt="">
													</div>
												</div>
											</div>
											<div class="swiper-slide">
								...
								<div class="sidebar-body chat-body" id="chatsidebar">
									...
									<ul class="user-list">
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div>
													<div class="avatar ">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-01.jpg" class="rounded-circle" alt="image">
													</div>
												</div>
												<div class="users-list-body">
													<div>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div class="avatar avatar-online">
													<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-05.jpg" class="rounded-circle" alt="image">
												</div>
												<div class="users-list-body">
													<div>
									...
									<ul class="user-list">
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div class="avatar avatar-online">
													<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-03.jpg" class="rounded-circle" alt="image">
												</div>
												<div class="users-list-body">
													<div>
														<h5>Horace Keene</h5>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div class="avatar">
													<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-04.jpg" class="rounded-circle" alt="image">
												</div>
												<div class="users-list-body">
													<div>
														<h5>James Albert</h5>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div>
													<div class="avatar avatar-online">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-09.jpg" class="rounded-circle" alt="image">
													</div>
												</div>
												<div class="users-list-body">
													<div>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div>
													<div class="avatar ">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-07.jpg" class="rounded-circle" alt="image">
													</div>
												</div>
												<div class="users-list-body">
													<div>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div>
													<div class="avatar avatar-online">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-08.jpg" class="rounded-circle" alt="image">
													</div>
												</div>
												<div class="users-list-body">
													<div>
										...
										<li class="user-list-item">
											<a href="javascript:void(0);" >
												<div>
													<div class="avatar">
														<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-06.jpg" class="rounded-circle" alt="image">
													</div>
												</div>
												<div class="users-list-body">
													<div>
								...
								<div class="messages">
									<div class="chats">
										<div class="chat-avatar">
											<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-02.jpg" class="rounded-circle dreams_chat" alt="image">
										</div>
													...
													<ul>
														<li class="emoj-action"><a href="javascript:void(0);"  ><i class="bx bx-smile"></i></a>
															<div class="emoj-group-list">
																<ul>
																	<li><a href="javascript:void(0);" ><img src="<?php echo base_url(); ?>assets/img/icons/emoj-icon-01.svg"  alt="Icon"></a></li>
																	<li><a href="javascript:void(0);" ><img src="<?php echo base_url(); ?>assets/img/icons/emoj-icon-02.svg"  alt="Icon"></a></li>
																	<li><a href="javascript:void(0);" ><img src="<?php echo base_url(); ?>assets/img/icons/emoj-icon-03.svg"  alt="Icon"></a></li>
																	<li><a href="javascript:void(0);" ><img src="<?php echo base_url(); ?>assets/img/icons/emoj-icon-04.svg"  alt="Icon"></a></li>
																	<li><a href="javascript:void(0);" ><img src="<?php echo base_url(); ?>assets/img/icons/emoj-icon-05.svg"  alt="Icon"></a></li>
									...
									<div class="chats chats-right">
										<div class="chat-content">
											...
											<div class="message-content ">
												...
												<div class="chat-voice-group">
													<ul>
														<li><a href="javascript:void(0);"><span><img src="<?php echo base_url(); ?>assets/img/icons/play-01.svg" alt="image"></span></a></li>
														<li><img src="<?php echo base_url(); ?>assets/img/icons/voice.svg" alt="image"></li>
														<li>0:05</li>
													</ul>
												</div>
											</div>
										...
										<div class="chat-avatar">
											<img src="<?php echo base_url(); ?>assets/img/profiles/avatar-10.jpg" class="rounded-circle dreams_chat" alt="image">
										</div>
									</div>
									<div class="chats">
										<div class="chat-avatar">
													...
													<ul class="nav mb-0">
														<li>
															<div class="image-download-col">
																<a href="<?php echo base_url(); ?>assets/img/media/media-02.jpg" data-fancybox="gallery" class="fancybox">
																	<img src="<?php echo base_url(); ?>assets/img/media/media-02.jpg" alt="">
																</a>
														...
														<li>
															<div class="image-download-col ">
																<a href="<?php echo base_url(); ?>assets/img/media/media-03.jpg" data-fancybox="gallery" class="fancybox">
																	<img src="<?php echo base_url(); ?>assets/img/media/media-03.jpg" alt="">
																</a>
															</div>
														</li>
														<li>
															<div class="image-download-col image-not-download">
																<a href="<?php echo base_url(); ?>assets/img/media/media-01.jpg" data-fancybox="gallery" class="fancybox">
																	<img src="<?php echo base_url(); ?>assets/img/media/media-01.jpg" alt="">
																	<span>10+</span>
																</a>
															</div>
														</li>
									...
									<div class="chats">
										...
										<div class="chat-content">
											...
											<div class="message-content review-files">
												<p class="d-flex align-items-center">Please check and review the files<span class="ms-1 d-flex"><img src="<?php echo base_url(); ?>assets/img/icons/smile-chat.svg" alt="Icon"></span></p>
											...
											<div class="like-chat-grp">
												<ul>
													<li class="like-chat"><a href="javascript:void(0);">2<img src="<?php echo base_url(); ?>assets/img/icons/like.svg"  alt="Icon"></a></li>
													<li class="comment-chat"><a href="javascript:void(0);">2<img src="<?php echo base_url(); ?>assets/img/icons/heart.svg"  alt="Icon"></a></li>
												</ul>
											</div>
										</div>
									</div>
										...
										<div class="tab-content pt-0" id="nav-tabContent">
											<div class="tab-pane fade show active" id="info">
												<ul class="nav share-media-img mb-0">
													...
													<li>
														<a href="<?php echo base_url(); ?>assets/img/media/media-04.jpg" data-fancybox="gallery" class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-04.jpg" alt="">
														</a>
													</li>
													<li>
														<a href="<?php echo base_url(); ?>assets/img/media/media-05.jpg" data-fancybox="gallery" class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-05.jpg" alt="">
														</a>
													</li>
													<li class="blur-media">
														<a href="<?php echo base_url(); ?>assets/img/media/media-02.jpg" data-fancybox="gallery" class="fancybox">
												...
												<ul class="nav share-media-img mb-0">
													<li>
														<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-01.jpg" alt="img">
															<span><i class="bx bx-play-circle"></i></span>
														</a>
													</li>
													<li>
														<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-02.jpg" alt="img">
															<span><i class="bx bx-play-circle"></i></span>
														</a>
													</li>
													<li>
														<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-03.jpg" alt="img">
															<span><i class="bx bx-play-circle"></i></span>
														</a>
													</li>
													<li>
														<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-04.jpg" alt="img">
															<span><i class="bx bx-play-circle"></i></span>
														</a>
													</li>
													<li>
														<a href="https://www.youtube.com/embed/Mj9WJJNp5wA" data-fancybox class="fancybox">
															<img src="<?php echo base_url(); ?>assets/img/media/media-05.jpg" alt="img">
															<span><i class="bx bx-play-circle"></i></span>
														</a>
													</li>
													<li class="blur-media">
											...
											<div class="tab-pane fade" id="link">
												<div class="media-link-grp">
													<div class="link-img">
														<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/img/media/media-link-01.jpg" alt="Img"></a>
													</div>
												...
												<div class="media-link-grp mb-0">
													<div class="link-img">
														<a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets/img/media/media-link-02.jpg" alt="Img"></a>
													</div>
													<div class="media-link-detail">
																...
																<td>
																	<div class="productimgname">
																		<a href="javascript:void(0);" class="product-img stock-img">
																			<img src="<?php echo base_url(); ?>assets/img/supplier/stock-img-01.png" alt="product">
																		</a>
