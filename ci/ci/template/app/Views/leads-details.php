							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="<?php echo base_url();?>leads"><i class="ti ti-arrow-narrow-left"></i>Leads</a></li>
								...
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="<?php echo base_url();?>leads-details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="<?php echo base_url();?>leads-details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
		...
		<div class="modal custom-modal fade modal-padding" id="add_notes" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo base_url();?>leads-details">
							<div class="mb-3">
				...
				<div class="modal-content">				
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="<?php echo base_url();?>leads-details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
