										...
										<div class="d-flex align-items-center flex-wrap row-gap-2">
											...
											<div class="active-list">													
												<ul class="mb-0">
													...
													<li>
														<a href="<?php echo base_url();?>activity-mail" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
													</li>
													<li>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>activity-mail" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal custom-modal fade" id="add_contacts" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo base_url();?>activity-mail">	
							<div class="mb-2 icon-form">
								<span class="form-icon"><i class="ti ti-search"></i></span>
