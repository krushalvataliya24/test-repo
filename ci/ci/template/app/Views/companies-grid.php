											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>company-details" class="avatar avatar-lg border rounded flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/icons/company-icon-01.svg" class="w-auto h-auto" alt="img">
														</a>
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">NovaWave LLC</a></h6>
												...
												<div class="d-flex justify-content-between align-items-center flex-wrap row-gap-2 border-top pt-3 mt-3">
													<div class="avatar-list-stacked avatar-group-xs">
														<span class="avatar border-0">
															<img src="<?php echo base_url();?>assets/img/profiles/avatar-01.jpg" class="rounded-circle" alt="img">
														</span>
														<span class="avatar border-0">
															<img src="<?php echo base_url();?>assets/img/profiles/avatar-02.jpg" class="rounded-circle" alt="img">
														</span>
														<span class="avatar border-0">
															<img src="<?php echo base_url();?>assets/img/profiles/avatar-03.jpg" class="rounded-circle" alt="img">
														</span>
														<span class="avatar border-0">
															<img src="<?php echo base_url();?>assets/img/profiles/avatar-04.jpg" class="rounded-circle" alt="img">
														</span>
													</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">BlueSky Industries</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">Summit  Peak</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">RiverStone Ventur</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">Bright Bridge Grp</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>5.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">CoastalStar Co.</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">HarborView</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>5.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">Golden Gate Ltd</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">Redwood Inc</a></h6>
															<div class="set-star text-default">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">SilverHawk</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>3.0
															</div>
														</div>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>company-details" class="fw-medium">SummitPeak</a></h6>
															<div class="set-star text-default">
																<i class="fa fa-star filled me-1"></i>3.0
															</div>
														</div>
