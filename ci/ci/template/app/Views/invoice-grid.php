							...
							<div class="row align-items-center">
								...
								<div class="col-4 text-end">
									<div class="head-icons">
										<a href="<?php echo base_url();?>invoice-grid" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Refresh"><i class="ti ti-refresh-dot"></i></a>
						...
						<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 border-top mt-4 pt-4 mb-4">
							...
							<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="<?php echo base_url();?>invoice-grid" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="view-icons">
									<a href="<?php echo base_url();?>invoices"><i class="ti ti-list-tree"></i></a>
									<a href="<?php echo base_url();?>invoice-grid" class="active"><i class="ti ti-grid-dots"></i></a>
								</div>
							</div>	
						</div>
						<!-- /Filter -->
											...
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/truellysel.svg" class="w-auto h-auto" alt="Truelysell"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/dreamchat.svg" class="w-auto h-auto" alt="DreamsChat"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/truellysell.svg" class="w-auto h-auto" alt="Truelysell"> 
													</a>
													<div>
														<h6><a href="javascript:void(0);">Truelysell</a></h6>
													</div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/servbook.svg" class="w-auto h-auto" alt="Servbook"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/dream-pos.svg" class="w-auto h-auto" alt="DreamPOS"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/project-01.svg" class="w-auto h-auto" alt="Project"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/project-02.svg" class="w-auto h-auto" alt="Project"> 
													</a>
													<div>
									...
									<div class="card-body">
										...
										<div class="d-block">
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<a href="javascript:void(0);" class="avatar avatar-sm border flex-shrink-0 me-2"> 
														<img src="<?php echo base_url();?>assets/img/priority/best.svg" class="w-auto h-auto" alt="Project"> 
													</a>
													<div>
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>invoice-grid" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
