											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														<a href="<?php echo base_url();?>contact-details" class="avatar avatar-md flex-shrink-0 me-2">
															<img src="<?php echo base_url();?>assets/img/profiles/avatar-19.jpg" alt="img">
														</a>
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Darlee Robertson</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Sharon Roy</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Vaughan</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Jessica</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Carol Thomas</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Dawn Mercha</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Rachel Hampton</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Jonelle Curtiss</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Jonathan</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Brook</a></h6>
															<p class="text-default">Team Lead Dev</p>
														</div>
													</div>
													<div class="dropdown table-action">
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Eric Adams</a></h6>
											...
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="d-flex align-items-center">
														...
														<div>
															<h6><a href="<?php echo base_url();?>contact-details" class="fw-medium">Richard Cooper</a></h6>
