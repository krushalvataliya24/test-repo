												...
												<div class="modal-content">
													...
													<div class="modal-body">
														<div class="text-center mt-2 mb-4">
															<div class="auth-logo">
																<a href="<?php echo base_url(); ?>index" class="logo logo-dark">
																	<span class="logo-lg">
																		<img src="<?php echo base_url(); ?>assets/img/logo.svg" alt="Logo" height="42">
																	</span>
																</a>
															</div>
														</div>
										...
										<div class="modal fade"  id="modaldemo8">
											<div class="modal-dialog modal-dialog-centered text-center" role="document">
												<div class="modal-content modal-content-demo">
													<div class="modal-header">
														<h4 class="modal-title">Message Preview</h4><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"></button>
													</div>
													...
													<div class="modal-footer">
														<button class="btn btn-primary" >Save changes</button> <button class="btn btn-cancel" data-bs-dismiss="modal" >Close</button>
													</div>
												</div>
											</div>
										</div>
