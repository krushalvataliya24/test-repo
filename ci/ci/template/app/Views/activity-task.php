...
<div class="page-wrapper">
											...
											<div class="d-flex align-items-center flex-wrap row-gap-2">
												...
												<div class="active-list">													
													<ul class="mb-0">
														...
														<li>
															<a href="<?php echo base_url();?>activity-mail" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
														</li>
														<li>
															<a href="<?php echo base_url();?>activity-task" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Task"><i class="ti ti-subtask"></i></a>
														</li>
														<li>
															<a href="<?php echo base_url();?>activity-meeting" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
														</li>
													</ul>
												</div>
											</div>
													...
													<div class="filter-set-view">
														...
														<div class="filter-reset-btns">
															<div class="row">
																...
																<div class="col-6">
																	<a href="<?php echo base_url();?>activities" class="btn btn-primary">Filter</a>
																</div>
															</div>
														</div>
													</div>
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
			...
			<div class="offcanvas-body">
				<form action="<?php echo base_url();?>activities">
					<div>
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
		...
		<div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit">
			...
			<div class="offcanvas-body">
				<form action="<?php echo base_url();?>activity-calls">
					...
					<div class="modal-body">
						<div class="text-center">
							...
							<div class="d-flex align-items-center justify-content-center mt-4">
								...
								<a href="<?php echo base_url();?>activity-task" class="btn btn-danger">Yes, Delete it</a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="modal custom-modal fade" id="add_contacts" role="dialog">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form action="<?php echo base_url();?>activity-task">	
							<div class="mb-2 icon-form">
								<span class="form-icon"><i class="ti ti-search"></i></span>
