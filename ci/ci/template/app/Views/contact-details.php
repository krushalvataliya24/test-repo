							...
							<div class="row align-items-center">
								<div class="col-sm-6">
									<ul class="contact-breadcrumb">
										<li><a href="<?php echo base_url();?>contact-grid"><i class="ti ti-arrow-narrow-left"></i>Contacts</a></li>
								...
								<div class="col-sm-6 text-sm-end">
									<div class="contact-pagination">
										...
										<ul>
											<li>
												<a href="<?php echo base_url();?>contact-details"><i class="ti ti-chevron-left"></i></a>
											</li>
											<li>
												<a href="<?php echo base_url();?>contact-details"><i class="ti ti-chevron-right"></i></a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="mb-3">
									<div class="d-flex align-items-center">
										<span class="avatar avatar-lg rounded me-2 border">
											<img src="<?php echo base_url();?>assets/img/icons/google-icon.svg" alt="" class="img-fluid w-auto h-auto">
										</span>
										<div>
				...
				<div class="modal-content">				
					...
					<div class="modal-body">
						<div class="success-message text-center">
							...
							<div class="col-lg-12 text-center modal-btn">
								<a href="<?php echo base_url();?>contact-details" class="btn btn-primary">Go to email</a>
							</div>
						</div>
					</div>
				</div>
