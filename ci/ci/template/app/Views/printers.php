									...
									<div class="card-body">
										<div class="settings-sidebar">
											...
											<div class="list-group list-group-flush settings-sidebar">
												<a href="<?php echo base_url();?>invoice-settings" class="fw-medium">Invoice Settings</a>
												<a href="<?php echo base_url();?>printers" class="fw-medium active">Printer</a>
							...
							<div class="col-xl-9 col-lg-12">
								...
								<div class="card">
									<div class="card-body">
										...
										<form action="<?php echo base_url();?>printers">
											<!-- Hp -->
