...
class Home extends BaseController
 {
    ...
    {
        $data = [
            'page_title' => view( 'partials/page-title', [ 'title' => 'Settings','li_2' => 'profile' ] )
            ];
    ...
    public function Proposals_Grid()
    {
    ...
    public function Contracts_Grid()
    {
    ...
    public function Estimations_Kanban()
    {
