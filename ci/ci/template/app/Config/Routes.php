...
$routes->get('proposals', 'Home::Proposals');
$routes->get('proposals-grid', 'Home::Proposals_Grid');
$routes->get('contracts', 'Home::Contracts');
$routes->get('contracts-grid', 'Home::Contracts_Grid');
$routes->get('estimations', 'Home::Estimations');
$routes->get('estimations-kanban', 'Home::Estimations_Kanban');
$routes->get('invoices', 'Home::Invoices');
$routes->get('invoice-grid', 'Home::Invoice_Grid');
