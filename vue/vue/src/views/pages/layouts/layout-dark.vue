...
export default {
  ...
  setup() {
    ...
    const layoutType = computed(() => {
      return route.path === "/layouts/layout-dark" ? "dark" : "";
    });
    ...
    const updateLayoutAttribute = () => {
      ...
      document.documentElement.setAttribute("data-theme", layoutType.value);
    };
    ...
    onBeforeUnmount(() => {
      document.documentElement.removeAttribute("data-theme"); // Clean up when the component is destroyed
    });
  },
};
</script>
