            ...
            <div class="col-md-6 d-flex">
              <div class="card flex-fill">
                <div class="card-header border-0 pb-0">
                  ...
                  >
                    <h4>
                      <i class="ti ti-grip-vertical me-1"></i>Recently Created Deals
                    </h4>
                    <div class="dropdown">
                      <a
...
import {
  ...
  wonChart,
  dealsYear,
} from "../dashboard/deals-dashboard/data";
...
export default {
  ...
  setup() {
    ...
    const layoutType = computed(() => {
      if (route.path === "/layouts/layout-mini") {
        return "without-header"; // If path matches, set layout type to detached
      } else if (route.path === "/layouts/layout-mini") {
        return "without-header"; // If path matches, set layout type to horizontal
      } else {
        return "without-header"; // Default layout
      }
    });
