          ...
          <div class="border-top pt-3">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Ticket ID
              </p>
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Assigned
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Assigned Date
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Assignee
              </p>
              <div class="status-toggle">
          ...
          <div class="filter-set-view">
            ...
            <div class="filter-reset-btns">
              <div class="row">
                ...
                <div class="col-6">
                  <router-link to="/support/contact-messages" class="btn btn-primary"
                    >Filter</router-link
                  >
                </div>
              </div>
