        ...
        <div class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <!-- Filter -->
              <div
                class="d-flex align-items-center justify-content-between flex-wrap mb-4 row-gap-2"
              >
                      ...
                      <div class="border-top pt-3">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Title
                          </p>
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Activity Type
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Created at
                          </p>
                          <div class="status-toggle">
                      ...
                      <div class="filter-set-view">
                        ...
                        <div class="filter-reset-btns">
                          <div class="row">
                            ...
                            <div class="col-6">
                              <router-link to="/crm/activities-list" class="btn btn-primary"
                                >Filter</router-link
                              >
                            </div>
                          </div>
