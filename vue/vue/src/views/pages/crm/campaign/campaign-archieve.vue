            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="campaign-tab">
                        <ul class="nav">
                            <li>
                                <router-link to="/crm/campaign">Active Campaign<span>24</span></router-link>
                            </li>
                            <li>
                                <router-link to="/crm/campaign-complete">Completed Campaign</router-link>
                            </li>
                            <li>
                                <router-link to="/crm/campaign-archieve" class="active">Archived Campaign</router-link>
                            </li>
                        </ul>
                    </div>
                    <!-- Campaign Tab -->
                                            ...
                                            <div class="filter-set-view">
                                                ...
                                                <div class="filter-reset-btns">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <router-link to="/crm/campaign-archieve" class="btn btn-primary">Filter</router-link>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
