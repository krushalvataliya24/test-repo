                ...
                <div class="col-sm-8">
                  ...
                  >
                    ...
                    <a
                      ...
                      ><i class="ti ti-square-rounded-plus me-2"></i>Add Contacts</a
                    >
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                  <div class="dropdown me-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-md-end dropdown-md p-3">
                      ...
                      <div class="border-top pt-3">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Phone
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Email
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Location
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Contact
                          </p>
                          <div class="status-toggle">
                            <input
                              type="checkbox"
                      ...
                      <div class="filter-set-view">
                        ...
                        <div class="filter-reset-btns">
                          <div class="row">
                            ...
                            <div class="col-6">
                              <router-link to="/crm/contacts-list" class="btn btn-primary"
                                >Filter</router-link
                              >
                            </div>
                          </div>
                  ...
                  <div class="view-icons">
                    <router-link to="/crm/contacts-list" class="active"
                      ><i class="ti ti-list-tree"></i
                    ></router-link>
                    <router-link to="/crm/contact-grid"
