            ...
            <div class="row align-items-center">
              <div class="col-sm-6">
                <ul class="contact-breadcrumb">
                  <li><router-link to="/crm/contact-grid"><i class="ti ti-arrow-narrow-left"></i>Contacts</router-link></li>
              ...
              <div class="col-sm-6 text-sm-end">
                <div class="contact-pagination">
                  ...
                  <ul>
                    <li>
                      <router-link to="/crm/contact-details"><i class="ti ti-chevron-left"></i></router-link>
                    </li>
                    <li>
                      <router-link to="/crm/contact-details"><i class="ti ti-chevron-right"></i></router-link>
                    </li>
                  </ul>
                </div>
              </div>
