            ...
            <div class="row align-items-center">
              <div class="col-sm-6">
                <ul class="contact-breadcrumb">
                  <li><router-link to="/crm/companies-list"><i class="ti ti-arrow-narrow-left"></i>Company</router-link></li>
                  <li>NovaWave LLC</li>
                </ul>
              </div>
              <div class="col-sm-6 text-sm-end">
                <div class="contact-pagination">
                  ...
                  <ul>
                    <li>
                      <router-link to="/crm/company-details"><i class="ti ti-chevron-left"></i></router-link>
                    </li>
                    <li>
                      <router-link to="/crm/company-details"><i class="ti ti-chevron-right"></i></router-link>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="card-body pb-2">
              <div class="d-flex align-items-center justify-content-between flex-wrap">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div>
                    <h5 class="mb-1">NovaWave LLC</h5>
                    <p class="mb-2"><i class="ti ti-map-pin-pin me-1"></i>22, Ave Street, Newyork, USA</p>
                ...
                <div class="contacts-action">
                  ...
                  <router-link to="/application/chat" class="btn-icon">
          ...
          <div class="card">
            <div class="card-body p-3">
              ...
              <div class="d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="javascript:void(0);" class="com-add link-purple fw-medium mb-3" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i class="ti ti-circle-plus me-1"></i>Add New</a>
              </div>
              <div class="d-flex align-items-center mb-3">
                <span class="avatar avatar-sm border rounded-circle p-1 me-2">
                  <img src="@/assets/img/icons/company-icon-01.svg" alt="Image">
                </span>
                <div>
                  <h6 class="fw-medium">NovaWaveLLC</h6>
                  <p><i class="fa-solid fa-star me-1 text-warning me-1"></i>3.5</p>
                </div>
              </div>
              <div class="d-flex align-items-center mb-0">
                ...
                <div>
                  <h6 class="fw-medium">BlueSky Industries</h6>
                  <p><i class="fa-solid fa-star me-1 text-warning me-1"></i>4.2</p>
                </div>
              </div>
              <hr>
              ...
              <a href="javascript:void(0);" class="d-block mb-3"><i class="ti ti-share-2 me-1"></i>Share Company</a>
              <a href="javascript:void(0);" class="d-block mb-3"><i class="ti ti-star me-1"></i>Add to Favourite</a>
              <a href="javascript:void(0);" class="d-block mb-0" data-bs-toggle="modal" data-bs-target="#delete_contact"><i class="ti ti-trash-x me-1"></i>Delete Company</a>
            </div>
          </div>
        </div>
        <!-- /Contact Sidebar -->
                  ...
                  <div class="notes-activity">
                    <div class="card mb-3">
                      <div class="card-body">
                        ...
                        <div class="notes-editor">
                          <div class="note-edit-wrap" :style="{ display: editMode ? 'block' : 'none' }">
                            <ckeditor
                              :editor="editor"
                              v-model="editorData"
                              :config="editorConfig"
                            ...
                            <div class="text-end note-btns">
                              <a href="javascript:void(0);" class="btn btn-light add-cancel" @click="cancelEdit">Cancel</a>
                              <a href="javascript:void(0);" class="btn btn-primary">Save</a>
                            </div>
                          </div>
                          <div class="text-end">
                            <a href="javascript:void(0);" @click="startEdit" class="add-comment link-purple fw-medium"><i class="ti ti-square-plus me-1"></i>Add Comment</a>
                          </div>
                        </div>
                      </div>
                    </div>	
                    <div class="card mb-3">
                      <div class="card-body">
                        ...
                        <div class="notes-editor">
                          <div class="note-edit-wrap" :style="{ display: editModeOne ? 'block' : 'none' }">
                            <ckeditor
                              :editor="editor"
                              v-model="editorData"
                              :config="editorConfig"
                            ></ckeditor>
                            <div class="text-end note-btns">
                              <a href="javascript:void(0);" class="btn btn-light add-cancel" @click="cancelEditOne">Cancel</a>
                              <a href="javascript:void(0);" class="btn btn-primary">Save</a>
                            </div>
                          </div>
                          <div class="text-end">
                            <a href="javascript:void(0);" @click="startEditOne" class="add-comment link-purple fw-medium"><i class="ti ti-square-plus me-1"></i>Add Comment</a>
                          </div>
                        </div>
                      </div>
                    </div>	
                    <div class="card mb-0">
                      <div class="card-body">
                        ...
                        <div class="notes-editor">
                          <div class="note-edit-wrap" :style="{ display: editModeTwo ? 'block' : 'none' }">
                            <ckeditor
                              :editor="editor"
                              v-model="editorData"
                              :config="editorConfig"
                            ></ckeditor>
                            <div class="text-end note-btns"> 
                              <a href="javascript:void(0);" class="btn btn-light add-cancel" @click="cancelEditTwo">Cancel</a>
                              <a href="javascript:void(0);" class="btn btn-primary">Save</a>
                            </div>
                          </div>
                          <div class="text-end">
                            <a href="javascript:void(0);" @click="startEditTwo" class="add-comment link-purple fw-medium"><i class="ti ti-square-plus me-1"></i>Add Comment</a>
                          </div>
                        </div>
                      </div>
                    </div>	
...
export default {
  data() {
    return {
      ...
      editorData: " Write a new comment, send your team notification by typing @ followed by their name",
      editorConfig: {},
      editMode: false,
      editModeOne: false,
      editModeTwo: false,
  ...
  methods: {
    ...
    startEditOne() {
      this.editModeOne = true;
    },
    cancelEditOne() {
      this.editModeOne = false;
    },
    startEditTwo() {
      this.editModeTwo = true;
    },
    cancelEditTwo() {
      this.editModeTwo = false;
    },
  },
};
</script>
