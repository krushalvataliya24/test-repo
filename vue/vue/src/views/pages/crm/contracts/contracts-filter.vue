  ...
  <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
    ...
    <div class="d-flex align-items-center flex-wrap row-gap-2">
          ...
          <div class="border-top pt-3">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Contract ID
              </p>
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Subject
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Date
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Contract Value
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Contract Type
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>End Date
              </p>
              <div class="status-toggle">
      ...
      <div class="view-icons">
        <router-link to="/crm/contracts-list" class="active"
          ><i class="ti ti-list-tree"></i
        ></router-link>
        <router-link to="/crm/contracts-grid"
