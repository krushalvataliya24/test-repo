<template>
              ...
              <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                      ...
                      <div class="filter-set-view">
                        ...
                        <div class="filter-reset-btns">
                          <div class="row">
                            ...
                            <div class="col-6">
                              <router-link to="/crm/leads-list" class="btn btn-primary">Filter</router-link>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="view-icons">
                    <router-link to="/crm/leads-list" class="active"><i class="ti ti-list-tree"></i></router-link>
                    <router-link to="/crm/leads-kanban"><i class="ti ti-grid-dots"></i></router-link>
                  </div>
                </div>
              </div>
              <!-- /Filter -->
  ...
  <leads-list-modal></leads-list-modal>
  <!-- /Page Wrapper -->
</template>
