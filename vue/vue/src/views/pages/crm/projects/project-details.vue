            ...
            <div class="row align-items-center">
              <div class="col-sm-6">
                <ul class="contact-breadcrumb">
                  <li><router-link to="/crm/projects-list"><i class="ti ti-arrow-narrow-left"></i>Project</router-link></li>
                  <li>Kofejob</li>
                </ul>
              </div>
              <div class="col-sm-6 text-sm-end">
                <div class="contact-pagination">
                  ...
                  <ul>
                    <li>
                      <router-link to="/crm/project-details"><i class="ti ti-chevron-left"></i></router-link>
                    </li>
                    <li>
                      <router-link to="/crm/project-details"><i class="ti ti-chevron-right"></i></router-link>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div class="d-flex align-items-center justify-content-between flex-wrap">
                <div class="d-flex align-items-center mb-2">
                  ...
                  <div>
                    ...
                    <span class="priority badge badge-tag badge-danger-light me-2"><i class="ti ti-square-rounded-filled"></i>High</span>
