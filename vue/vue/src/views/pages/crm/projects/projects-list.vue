<template>
              ...
              >
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                  <div class="dropdown me-2">
                    ...
                    <div class="dropdown-menu dropdown-menu-md-end dropdown-md p-3">
                      ...
                      <div class="border-top pt-3">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Client
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Priority
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Start Date
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Due Date
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Type
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Pipeline Stage
                          </p>
                          <div class="status-toggle">
                            <input type="checkbox" id="col-rate" class="check" />
                            <label for="col-rate" class="checktoggle"></label>
                      ...
                      <div class="filter-set-view">
                        ...
                        <div class="filter-reset-btns">
                          <div class="row">
                            ...
                            <div class="col-6">
                              <router-link to="/crm/projects-list" class="btn btn-primary">Filter</router-link>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="view-icons">
                    <router-link to="/crm/projects-list" class="active"
                      ><i class="ti ti-list-tree"></i
                    ></router-link>
                    <router-link to="/crm/project-grid"
  ...
  <projects-list-modal></projects-list-modal>
</template>
