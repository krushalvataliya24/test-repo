                ...
                <div class="col-sm-8">
                  ...
                  >
                    ...
                    <a
                      ...
                      ><i class="ti ti-square-rounded-plus me-2"></i>Add Deals</a
                    >
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-2">
                      ...
                      <div class="border-top pt-3">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Deal Name
                          </p>
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Stage
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Deal Value
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Tags
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Expected Closed Date
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Rating
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Owner
                          </p>
                          <div class="status-toggle">
                        ...
                        >
                          <p class="mb-0 d-flex align-items-center">
                            <i class="ti ti-grip-vertical me-2"></i>Probability
                          </p>
                          <div class="status-toggle">
                            <input
                              type="checkbox"
                      ...
                      <div class="filter-set-view">
                        ...
                        <div class="filter-reset-btns">
                          <div class="row">
                            ...
                            <div class="col-6">
                              <router-link to="/crm/deals-list" class="btn btn-primary"
                                >Filter</router-link
                              >
                            </div>
                          </div>
                  ...
                  <div class="view-icons">
                    ...
                    ></router-link>
                    <router-link to="/crm/deals-kanban"
