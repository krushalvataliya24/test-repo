<template>
            ...
            <div class="row align-items-center">
              <div class="col-sm-8">
                <ul class="contact-breadcrumb">
                  <li><router-link to="/crm/deals-list"><i class="ti ti-arrow-narrow-left"></i>Deals</router-link></li>
              ...
              <div class="col-sm-4 text-sm-end">
                <div class="contact-pagination">
                  ...
                  <ul>
                    <li>
                      <router-link to="/crm/leads-details"><i class="ti ti-chevron-left"></i></router-link>
                    </li>
                    <li>
                      <router-link to="/crm/leads-details"><i class="ti ti-chevron-right"></i></router-link>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="card-body p-3">
              ...
              <div class="d-flex align-items-center mb-3">
                <div class="avatar avatar-md me-2">
                  <img src="@/assets/img/profiles/avatar-21.jpg" alt="Image">
                </div>
                <p>Vaughan</p>
              </div>
              ...
              <ul>
                ...
                <li class="row mb-0"><span class="col-6">Modified By</span>
                  <span class="col-6">
                    <span class="avatar avatar-xs me-1"><img src="@/assets/img/profiles/avatar-19.jpg" class="avatar-xs" alt="img"></span>Darlee Robertson
                  </span>
                </li>
              </ul>	
            </div>
  ...
  <deals-details-modal></deals-details-modal>
</template>
...
export default {
  data() {
    return {
      ...
      Marketing: ["Marketing Pipeline", "Sales Pipeline"],
