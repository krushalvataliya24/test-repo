      ...
      >
        ...
        <div class="d-sm-flex align-items-center">
          <div class="form-sort owned-by w-auto">
            ...
            <vue-select :options="Anyone" id="filenot" placeholder="Owned By Me" />
          </div>
          <a
              ...
              <div class="section-bulk-wrap">
                ...
                >
                  <div class="form-sort me-3">
                    ...
                    <vue-select :options="Recent" id="filealllast" placeholder="Recent" />
                  </div>
                  <div class="form-sort">
                  ...
                  <div class="row mt-3">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                      <div class="folders p-3 mb-4">
                        <div
                          class="d-flex align-items-center justify-content-between head"
                        >
                          ...
                          <div class="group-avatar">
                            ...
                            <span class="avatar">
                              <a
                                ...
                                ><img src="@/assets/img/profiles/avatar-01.jpg" alt="Avatar"
                              /></a>
                            </span>
                            <span class="count">
