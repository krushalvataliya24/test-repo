            ...
            <div class="group-avatar">
              <span class="avatar">
                <a
                  ...
                  ><img :src="require(`@/assets/img/profiles/${item.Image}`)" alt="Avatar"
                /></a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img
                    :src="require(`@/assets/img/profiles/${item.Image_Two}`)"
                    alt="Avatar"
                /></a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img
                    :src="require(`@/assets/img/profiles/${item.Image_Three}`)"
                    alt="Avatar"
                /></a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img
                    :src="require(`@/assets/img/profiles/${item.Image_Four}`)"
                    alt="Avatar"
                /></a>
              </span>
              <span class="avatar">
                <a
                  ...
                  ><img
                    :src="require(`@/assets/img/profiles/${item.Image_Five}`)"
                    alt="Avatar"
                /></a>
              </span>
              <span class="count">
