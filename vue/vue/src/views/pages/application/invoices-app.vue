                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <router-link to="/applications/invoice-details" class="tb-data"
                          >INV-1454</router-link
                        >
                      </td>
                      <td>
                        <div class="d-flex align-items-center">
                          <router-link
                            to="/applications/invoice-details"
                            class="avatar avatar-md border avatar-rounded me-2"
                          >
                            <img
                          ...
                          <div>
                            <h6 class="fw-medium">
                              <router-link to="/applications/invoice-details"
                                >Anthony Lewis</router-link
                              >
                            </h6>
                      ...
                      <td>
                        <div class="action-icon d-inline-flex">
                          <router-link to="/applications/invoice-details" class="me-2"
                            ><i class="ti ti-eye"></i
                          ></router-link>
                          <router-link to="/applications/edit-invoices" class="me-2"
                    ...
                    <tr>
                      ...
                      <td>
                        <span
                          class="badge badge-soft-purple d-inline-flex align-items-center"
                        >
          ...
          <div class="modal-body text-center">
            ...
            <div class="d-flex justify-content-center">
              <a
                ...
                >Cancel</a
              >
              <router-link to="/applications/invoices" class="btn btn-danger"
