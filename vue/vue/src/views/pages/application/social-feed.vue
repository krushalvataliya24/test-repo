          ...
          <div class="stickysidebar">
            <div class="card">
              <div class="card-body">
                ...
                <ul
                  class="nav nav-pills border d-flex p-2 rounded mb-3"
                  id="pills-tab"
                  role="tablist"
                >
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                    ...
                    <div>
                      <a
                        href="javascript:void(0);"
                        class="btn btn-outline-light w-100 border"
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mt-3">
                  <a href="javascript:void(0);" class="btn btn-outline-light w-100 border"
                    >View All <i class="ti ti-arrow-right ms-2"></i
                  ></a>
                </div>
              </div>
            ...
            <div
              class="d-flex align-items-center flex-wrap justify-content-center template-more-links mb-4"
            >
