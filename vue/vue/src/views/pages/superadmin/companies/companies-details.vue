<template>
        ...
        <div class="col-sm-6">
          <h6 class="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0">
            <router-link to="/crm/companies-grid">
              <i class="ti ti-arrow-left me-2"></i>Companies</router-link
            >
        ...
        <div class="col-xl-4 theiaStickySidebar">
          <div class="card card-bg-1">
            <div class="card-body p-0">
              <span
                class="avatar avatar-xl border bg-white rounded-circle m-auto d-flex mb-2"
              >
                <img
              ...
              <div class="p-3 border-bottom">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <a
                    ...
                    >darlee@example.com <i class="ti ti-copy text-dark ms-2"></i
                  ></a>
                </div>
              ...
              <div class="p-3">
                ...
                <div class="d-flex align-items-center mb-3">
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-01.svg" alt=""
                  /></a>
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-06.svg" alt=""
                  /></a>
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-02.svg" alt=""
                  /></a>
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-03.svg" alt=""
                  /></a>
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-04.svg" alt=""
                  /></a>
                  <a href="javascript:void(0);" class="me-2"
                    ><img src="@/assets/img/social/social-05.svg" alt=""
                  /></a>
                </div>
                <div class="row gx-2">
                  <div class="col-6">
        ...
        <div class="col-xl-8">
          <div>
            <div class="bg-white rounded">
              <ul
                class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap mb-3"
                role="tablist"
              >
                ...
                <li class="nav-item" role="presentation">
                  <a
                    class="nav-link fw-medium d-flex align-items-center justify-content-center"
            ...
            <div class="tab-content">
              ...
              >
                <div class="card border-0">
                  ...
                  <div class="card-body">
                    <span
                      class="badge badge-soft-purple d-inline-flex align-items-center mb-3"
                    >
                    ...
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-start">
                        <span
                          class="avatar avatar-md avatar-rounded flex-shrink-0 bg-skyblue me-2"
                    ...
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-start">
                        <span
                          class="avatar avatar-md avatar-rounded bg-success flex-shrink-0 me-2"
                    ...
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-start">
                        <span
                          class="avatar avatar-md avatar-rounded flex-shrink-0 bg-warning me-2"
                    ...
                    <div class="border rounded p-3 mb-3">
                      <div class="d-flex align-items-start">
                        <span
                          class="avatar avatar-md avatar-rounded flex-shrink-0 bg-purple me-2"
                          ><i class="ti ti-user-circle fs-20"></i
                        ></span>
                        <div>
                          <h6 class="fw-medium d-flex align-items-center mb-1">
                            Meeting With
                            <span class="avatar avatar-sm avatar-rounded mx-1"
                      ...
                      <div>
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-3 mb-3">
                          ...
                          >
                            ...
                            <a
                              href="javascript:void(0);"
                              class="btn btn-icon btn-sm fs-16"
                        ...
                        <div class="notes-editor">
                          <div class="note-edit-wrap">
                            ...
                            >
                              <a
                                href="javascript:void(0);"
                                class="btn btn-outline-light border add-cancel me-3"
                                >Cancel</a
                              >
                      ...
                      <div>
                        ...
                        <div class="bg-light-500 rounded p-3 mb-3">
                          ...
                          <p class="text-dark mb-2">
                            Commented by <span class="text-primary"> Aeron</span> on 15
                            Sep 2023, 11:15 pm
                          </p>
                          <a
                            href="javascript:void(0);"
                            class="btn btn-dark d-inline-flex align-items-center"
                            ><i class="ti ti-arrow-back-up me-1"></i>Reply</a
                          >
                        </div>
                        <div class="notes-editor">
                          <div class="note-edit-wrap">
                    ...
                    <div class="border rounded p-3 mb-3">
                      ...
                      <div>
                        ...
                        <p class="mb-3">
                          ...
                          and their importance cannot be overstated. Whether it's
                          launching a new product, improving an existing
                        </p>
                        <div class="notes-editor">
                          <div class="note-edit-wrap">
                            <div class="mb-3">
                    ...
                    <div class="border rounded p-3 mb-3">
                      ...
                      >
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium">
                              <span class="text-dark">Darlee Robertson </span> logged a
                              call on 23 Jul 2023, 10:00 pm
                            </p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
                          ...
                          <a href="javascript:void(0);" class="btn btn-icon btn-sm fs-20"
                            ><i class="ti ti-trash"></i
                          ></a>
                        </div>
                      </div>
                    ...
                    <div class="border rounded p-3 mb-3">
                      ...
                      >
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium">
                              <span class="text-dark">Sharon Roy </span>  logged a call on
                              28 Jul 2023, 09:00 pm
                            </p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
                    ...
                    <div class="border rounded p-3">
                      ...
                      >
                        <div class="d-flex align-items-center">
                          ...
                          <div>
                            <p class="fw-medium">
                              <span class="text-dark">Vaughan Lewis </span> logged a call
                              on 30 Jul 2023, 08:00 pm
                            </p>
                          </div>
                        </div>
                        <div class="d-flex align-items-center">
                      ...
                      >
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <span class="badge badge-dark-transparent"
                            ><i class="ti ti-point-filled"></i>Proposal</span
                          >
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        ...
                        <div class="d-flex align-items-center">
                          ...
                          <span class="badge badge-soft-success"
                            ><i class="ti ti-point-filled"></i>Sent</span
                          >
                        </div>
                      </div>
                    </div>
  ...
  <!-- /Page Wrapper -->
  <companies-details-modal></companies-details-modal>
</template>
<script>
