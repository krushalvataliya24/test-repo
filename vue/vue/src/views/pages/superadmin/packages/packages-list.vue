            ...
            <div class="col-sm-8">
              ...
              >
                ...
                <a
                  ...
                  ><i class="ti ti-square-rounded-plus me-2"></i>Add New Plan</a
                >
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div class="d-flex align-items-center flex-wrap row-gap-2">
                  ...
                  <div class="border-top pt-3">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <p class="mb-0 d-flex align-items-center">
                        <i class="ti ti-grip-vertical me-2"></i>Plan Name
                      </p>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <p class="mb-0 d-flex align-items-center">
                        <i class="ti ti-grip-vertical me-2"></i>Plan Type
                      </p>
                      <div class="status-toggle">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <p class="mb-0 d-flex align-items-center">
                        <i class="ti ti-grip-vertical me-2"></i>Total Subscribers
                      </p>
                      <div class="status-toggle">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <p class="mb-0 d-flex align-items-center">
                        <i class="ti ti-grip-vertical me-2"></i>Price
                      </p>
                      <div class="status-toggle">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <p class="mb-0 d-flex align-items-center">
                        <i class="ti ti-grip-vertical me-2"></i>Created Date
                      </p>
                      <div class="status-toggle">
                  ...
                  <div class="filter-set-view">
                    ...
                    <div class="filter-reset-btns">
                      <div class="row">
                        ...
                        <div class="col-6">
                          <router-link to="/super-admin/packages" class="btn btn-primary"
                            >Filter</router-link
                          >
                        </div>
                      </div>
              ...
              <div class="view-icons">
                ...
                ></router-link>
                <router-link to="/super-admin/packages-grid"
