              ...
              <div class="d-flex align-items-center justify-content-between">
                ...
                >
                  ...
                  <div class="view-icons">
                    <router-link to="/super-admin/packages"
                      ><i class="ti ti-list-tree"></i
                    ></router-link>
                    <router-link to="/super-admin/packages-grid" class="active"
                    ...
                    <div class="card-body">
                      <div class="card">
                        <div class="card-body">
                          <h4>Basic</h4>
                          <h1>
                            $50<span class="fs-14 fw-normal text-gray">/monthly</span>
                          </h1>
                        </div>
                      </div>
                      <div class="pricing-content rounded bg-light mb-3">
                        <div class="price-hdr">
                          <h6 class="fs-14 fw-medium text-gray w-100">
                            Features Includes
                          </h6>
                        </div>
                        <div>
                          ...
                          >
                          <span class="text-dark d-flex align-items-center mb-3"
                            ><i class="ti ti-circle-x-filled text-danger me-2"></i
                            >Tasks</span
                          >
                    ...
                    <div class="card-body">
                      <div class="card">
                        <div class="card-body">
                          <h4>Advanced</h4>
                          <h1>
                            $200<span class="fs-14 fw-normal text-gray">/monthly</span>
                          </h1>
                        </div>
                      </div>
                      <div class="pricing-content rounded bg-light mb-3">
                        ...
                        <div>
                          ...
                          <span class="text-dark d-flex align-items-center mb-3"
                            ><i class="ti ti-discount-check-filled text-success me-2"></i
                            >Unlimited Companies</span
                          >
                          <span class="text-dark d-flex align-items-center mb-3"
                            ><i class="ti ti-discount-check-filled text-success me-2"></i
                            >Unlimited Compaigns</span
                          >
                          <span class="text-dark d-flex align-items-center mb-3"
                            ><i class="ti ti-circle-x-filled text-danger me-2"></i
                            >Tasks</span
                    ...
                    <div class="card-body">
                      <div class="card">
                        <div class="card-body">
                          <h4>Premium</h4>
                          <h1>
                            $300<span class="fs-14 fw-normal text-gray">/monthly</span>
                          </h1>
                        </div>
                      </div>
                      <div class="pricing-content rounded bg-light mb-3">
                    ...
                    <div class="card-body">
                      <div class="card">
                        <div class="card-body">
                          <h4>Enterprise</h4>
                          <h1>
                            $400<span class="fs-14 fw-normal text-gray">/monthly</span>
                          </h1>
                        </div>
                      </div>
                      <div class="pricing-content rounded bg-light mb-3">
