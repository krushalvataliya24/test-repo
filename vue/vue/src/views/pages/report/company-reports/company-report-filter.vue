      ...
      <div class="dropdown me-2">
        ...
        <div class="dropdown-menu dropdown-menu-md-end dropdown-md p-3">
          ...
          <div class="border-top pt-3">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Won Deals
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Lost Deals
              </p>
              <div class="status-toggle">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              <p class="mb-0 d-flex align-items-center">
                <i class="ti ti-grip-vertical me-2"></i>Date Created
              </p>
              <div class="status-toggle">
                <input type="checkbox" id="col-status" class="check" />
                <label for="col-status" class="checktoggle"></label>
          ...
          <div class="filter-set-view">
            ...
            <div class="filter-reset-btns">
              <div class="row">
                ...
                <div class="col-6">
                  <router-link to="/report/company-reports" class="btn btn-primary"
                    >Filter</router-link
                  >
                </div>
              </div>
