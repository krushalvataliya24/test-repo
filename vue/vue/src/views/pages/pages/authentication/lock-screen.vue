    ...
    <div class="main-wrapper">
      <div class="account-content">
        <div class="d-flex flex-wrap w-100 vh-100 overflow-hidden">
          <div
            class="d-flex align-items-center justify-content-center flex-fill flex-wrap vh-100 overflow-auto"
          >
            ...
            <div class="container">
              <div class="row justify-content-center">
                <div class="col-md-5">
                      ...
                      <div class="card border p-sm-3">
                        <div class="card-body p-4">
                          <div class="text-center">
                            ...
                            <div class="mb-3">
                              <span class="avatar avatar-xxxl rounded-circle mb-4"
                                ><img
                  ...
                  <div
                    class="d-flex align-items-center flex-wrap row-gap-2 justify-content-center mb-4"
                  >
                    <a href="javascript:void(0);" class="fw-medium me-3"
                      >Terms & Condition</a
                    >
                    ...
                    <div class="dropdown">
                      <a
                        ...
                        class="dropdown-toggle fw-medium border-0 p-0 bg-transparent shadow-none"
