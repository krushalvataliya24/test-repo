          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                ...
                <button
                  type="button"
                  class="btn btn-primary mt-1 ms-1"
                  data-bs-toggle="modal"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                ...
                <button
                  type="button"
                  class="btn btn-secondary waves-effect waves-light mt-1 ms-1"
                  data-bs-toggle="modal"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="bd-example">
                ...
                <button
                  type="button"
                  class="btn btn-secondary mb-1 ms-1"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-warning mb-1 ms-1"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-success mb-1 ms-1"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-danger mb-1 ms-1"
                  data-bs-toggle="modal"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                ...
                <button
                  type="button"
                  class="btn btn-warning mt-1 ms-1"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-danger mt-1 ms-1"
                  data-bs-toggle="modal"
