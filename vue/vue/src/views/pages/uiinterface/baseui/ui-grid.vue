      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              ...
              Bootstrap grid system allow all six breakpoints, and any breakpoints you can
              customize.
            </div>
            <div class="card-body">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center">
                        ...
                        <small class="digits">≥1400px</small>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
          ...
          <div class="card">
            <div class="card-header">
              ...
              <p class="mt-1 f-m-light">
                You may use predefined grid classes. Using <code>.col-md-* </code>you can
                set the grid system.
              </p>
            </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              ...
              <p class="mt-1 f-m-light">
                You can use the <code>align-items-*</code> class to set the vertical
                alignment.
              </p>
            </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              ...
              <p class="mt-1 f-m-light">
                You can use the <code>justify-content-*</code> class to set the horizontal
                alignment.
              </p>
            </div>
            <div class="card-body grid-showcase grid-align">
              <div class="row justify-content-start bg-light">
                <div class="col-5">
                  <span class="bg-white text-dark">One column</span>
                </div>
                <div class="col-5">
                  <span class="bg-white text-dark">Two column</span>
                </div>
              </div>
        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header">
              ...
              <p class="mt-1 f-m-light">
                To nest your content with the default grid, add a new<code>.row</code> and
                set of <code>.col-sm-*</code> columns within an existing
              ...
              <div class="row g-3">
                ...
                <div class="col-9">
                  <div class="grid-wrapper pb-0">
                    <div class="row g-2">
                      <div class="col-5">
                        <span class="border border-2">Level 2: .col-5</span>
                      </div>
                      <div class="col-7">
                        <span class="border border-2">Level 2: .col-7</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="grid-wrapper pb-0">
                    <div class="row g-2">
                      <div class="col-sm-2 col-4">
                        <span class="border border-2">Level 1: .col-2</span>
                      </div>
                      <div class="col-sm-10 col-8">
                        <span class="border border-2">Level 1: .col-10</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="card">
            ...
            <div class="card-body grid-showcase">
              <div class="row g-2">
                ...
                <div class="col-sm-2 col-4 order-5">
                  <span>fifth Item (order-5)</span>
                </div>
                <div class="col-sm-6 col-4 order-4">
        ...
        <div class="col-sm-12">
          <div class="card">
            ...
            <div class="card-body grid-showcase">
              <div class="row g-2">
                <div class="col-sm-5 col-4 offset-sm-3 offset-2">
                  <span>col-5 offset-3</span>
                </div>
                <div class="col-sm-2 col-4 offset-sm-2 offset-1">
                  <span>col-2 offset-2</span>
                </div>
                <div class="col-sm-4 col-5 offset-2"><span>col-4 offset-2</span></div>
                <div class="col-sm-3 col-4 offset-sm-2 offset-1">
                ...
                <div class="row">
                  ...
                  <div class="col-4">
                    <span
                      ...
                      wrapped onto a new line as one contiguous unit.</span
                    >
                  </div>
                  <div class="col-6">
                    <span
                      >.col-6<br />Subsequent columns continue along the new line.</span
                    >
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <p class="mb-4">
                ...
                <span class="text-danger">.me-auto</span>to force sibling columns away
                from one another.
              </p>
              <div class="grid-showcase">
                <div class="row mb-3">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p>
                ...
                <span class="text-danger">responsive display utilities.</span>
              </p>
              <div class="grid-showcase">
                <div class="row">
        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            <div class="card-body">
              <p>
                The <span class="text-danger">.col-*</span> classes can also be used
                outside a <span class="text-danger">.row</span> to give an element a
                specific width. Whenever column classes are used as non direct children of
                a row,the paddings are omitted.
              </p>
              <div class="grid-showcase">
                <div class="col-3">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <P
                >The classes can be used together with utilities to create responsive
                floated images. Make sure to wrap the content in a
                <span class="text-danger">.clearfix</span> wrapper to clear the float if
                the text is shorter.</P
              >
              <div class="clearfix">
                <img
