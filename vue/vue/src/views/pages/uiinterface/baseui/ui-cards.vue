    ...
    <div class="content">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                majority have suffered alteration many variations of passages of Lorem
                Ipsum available there are so many ways to solve but the majority have
                suffered.
              </p>
            </div>
            <div class="card-footer">
              ...
              <div class="card">
                <div class="card-body">
                  <blockquote class="blockquote mb-0 text-center">
                    ...
                    <footer class="blockquote-footer mt-2 fs-14">
          ...
          <div class="row">
            ...
            <div class="col-xl-12">
              <div class="card border border-success mb-3">
                ...
                <div class="card-footer bg-transparent border-top border-success">
                  Footer
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3">
          <div class="card border border-primary">
            <div class="card-body">
              ...
              <p class="mb-0 mt-3 fs-20 fw-semibold lh-1">Calculations</p>
            </div>
            <div class="card-footer">
              ...
              <div class="card w-75">
                ...
                <div class="card-body">
                  <div class="card-text">
                    ...
                    omnis excepturi consequatur molestiae
                  </div>
                </div>
                <div class="card-footer">
        ...
        <div class="col-xl-4">
          <div class="card overlay-card">
            ...
            <div class="card-img-overlay d-flex flex-column p-0">
              <div class="card-header">
                <div class="card-title text-fixed-white">Image Overlays Are Awesome!</div>
              </div>
              ...
              <div class="col-md-8">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text mb-3">
                    This is a wider card with suppo rting text below as a natural lead-in
                    to additional content. This content is a little bit longer.
                  </p>
                  <p class="card-text">
                    <small class="text-muted">Last updated 3 mins ago</small>
      ...
      <div class="row">
        <div class="col-xl-3">
          <div class="card border border-primary">
            <div class="card-body">
              <p class="fs-14 fw-semibold mb-2 lh-1">Home Page Design</p>
