    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">Border color Styling</div>
            </div>
            <div class="card-body">
              <div class="mb-4">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">Border with opacity</div>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <img
                ...
                class="avatar-xxl avatar bd-placeholder-img rounded"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-02.jpg"
                class="avatar-xxl avatar d-placeholder-img rounded-top"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-03.jpg"
                class="avatar-xxl avatar bd-placeholder-img rounded-end"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-07.jpg"
                class="avatar-xxl avatar bd-placeholder-img rounded-bottom"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-04.jpg"
                class="avatar-xxl avatar bd-placeholder-img rounded-start"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-05.jpg"
                class="avatar-xxl avatar bd-placeholder-img rounded-circle"
                alt="img"
              />
              <img
                src="@/assets/img/profiles/avatar-06.jpg"
                class="avatar-xxl avatar bd-placeholder-img rounded-pill"
                alt="img"
              />
            </div>
          </div>
