    ...
    <div class="content">
          ...
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">
                Always Open Accordion
                <p class="text-muted subtitle fs-12 fw-normal">
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      classes that we use to style each element. These classes control the
                      overall appearance, as well as the showing and hiding via CSS
                      transitions. It's also worth noting that just about any HTML can go
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">With Spacing</div>
            </div>
            <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">Left Aligned Icons</div>
            </div>
            <div class="card-body">
              <div
      ...
      <div class="row">
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              <p class="mb-0">
                <a
                  class="btn btn-primary collapsed mb-2"
                  data-bs-toggle="collapse"
                ...
                <button
                  class="btn btn-secondary collapsed mb-2 ms-1"
                  type="button"
                  data-bs-toggle="collapse"
        ...
        <div class="col-xl-6">
          <div class="card">
            <div class="card-header justify-content-between">
              <div class="card-title">Targets Collapse</div>
            </div>
            <div class="card-body">
              <p class="mb-0">
                <a
                ...
                >
                <button
                  class="btn btn-success mb-2 ms-1"
                  type="button"
                  data-bs-toggle="collapse"
