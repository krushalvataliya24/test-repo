        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="avatar avatar-sm me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
              <span class="avatar avatar-md me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
              <span class="avatar avatar-lg me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
              <span class="avatar avatar-xl me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
              <span class="avatar avatar-xxl me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
              <span class="avatar avatar-xxxl me-2 ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
              </span>
            </div>
          </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="avatar avatar-sm online me-2 avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-03.jpg" alt="img" />
              </span>
              <span class="avatar avatar-md me-2 online avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-03.jpg" alt="img" />
              </span>
              <span class="avatar avatar-lg me-2 online avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-03.jpg" alt="img" />
              </span>
              <span class="avatar avatar-xl me-2 online avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-03.jpg" alt="img" />
              </span>
              <span class="avatar avatar-xxl me-2 online avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-03.jpg" alt="img" />
              </span>
            </div>
          </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="avatar avatar-sm me-2 avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
                <span class="badge rounded-pill bg-secondary avatar-badge">5</span>
              </span>
              <span class="avatar avatar-md me-2 avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
                <span class="badge rounded-pill bg-warning avatar-badge">1</span>
              </span>
              <span class="avatar avatar-lg me-2 avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
                <span class="badge rounded-pill bg-info avatar-badge">7</span>
              </span>
              <span class="avatar avatar-xl me-2 avatar-rounded ms-1">
                <img src="@/assets/img/profiles/avatar-02.jpg" alt="img" />
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="avatar bg-danger avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-success avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-warning avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-info avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
            </div>
          </div>
        ...
        <div class="col-xl-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <span class="avatar bg-soft-danger avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-soft-success avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-soft-danger avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
              <span class="avatar bg-soft-info avatar-rounded ms-1">
                <span class="avatar-title">SR</span>
              </span>
            </div>
          </div>
