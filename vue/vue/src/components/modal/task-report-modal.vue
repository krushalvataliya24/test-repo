        ...
        <div class="modal-body">
          <form action="#">
            ...
            <div class="mb-3">
              ...
              >
              <vue-select :options="Yeartask" id="yeartask" placeholder="2023" />
            </div>
...
export default {
  data() {
    return {
      Downtask: ["Download as PDF", "Download as Excel"],
      Fieldstask: ["All Fields", "Name", "Assigned To", "Priority", "Status", "Type"],
      Positiontask: [
        "All Position",
        "Installer",
        "Senior Manager",
      ...
      Sourcetask: ["All Source", "Google", "Campaigns", "Referrals", "Paid Social"],
      Yeartask: ["2023", "2022", "2021"],
    };
  },
};
</script>
