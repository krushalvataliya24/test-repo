...
route.get(public_routes.paymentGatewaySettings, (req, res, next) => {
  res.render(index, {
    page_path: "settings/financial-settings/payment-gateway",
    title: "Settings",
  });
});
...
route.get(public_routes.layout_horizontal_single, (req, res, next) => {
  res.render(index, {
    page_path: "layouts/layout-horizontal-single",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.layout_without_header, (req, res, next) => {
  res.render(index, {
    page_path: "layouts/layout-without-header",
    title: "CRMS Admin Template",
  });
});
...
route.get(public_routes.layout_detached, (req, res, next) => {
  res.render(index, {
    page_path: "layouts/layout-detached",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.dashboard, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/dashboard",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.companies, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/companies",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.subscription, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/subscription",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.packages, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/packages",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.packages_grid, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/packages-grid",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.domain, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/domain",
    title: "CRMS Admin Template",
  });
});
route.get(public_routes.purchase_transaction, (req, res, next) => {
  res.render(index, {
    page_path: "superadmin/purchase-transaction",
    title: "CRMS Admin Template",
  });
});
...
route.get(public_routes.plugin, (req, res, next) => {
  res.render(index, {
    page_path: "plugin",
    title: "CRMS Admin Template",
  });
