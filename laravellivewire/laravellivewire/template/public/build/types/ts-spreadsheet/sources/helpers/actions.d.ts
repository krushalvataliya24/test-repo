...
export declare function getHeaderCell(letter: string, index: number, showMenuIcon?: boolean): string;
...
export declare function updateSpans(dc: number, dr: number, index: number, page: DataPage): ISpan[] | undefined;
