								...
								<div class="d-flex align-items-center flex-wrap row-gap-2">
									...
									<div class="active-list">													
										<ul class="mb-0">
											...
											<li>
												<a href="{{url('activity-task')}}" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Task"><i class="ti ti-subtask"></i></a>
											</li>
											<li>
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="{{url('activity-task')}}" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
