                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <ul class="contact-breadcrumb">
                                    <li><a href="{{url('companies')}}"><i class="ti ti-arrow-narrow-left"></i>Company</a></li>
                                    <li>NovaWave LLC</li>
                                </ul>
                            </div>
                            <div class="col-sm-6 text-sm-end">
                                <div class="contact-pagination">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="{{url('company-details')}}"><i class="ti ti-chevron-left"></i></a>
                                        </li>
                                        <li>
                                            <a href="{{url('company-details')}}"><i class="ti ti-chevron-right"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="avatar avatar-xxl me-3 flex-shrink-0 border p-2">								
                                        <img src="{{URL::asset('/build/img/icons/company-icon-01.svg')}}" alt="Image">
                                    </div>
                                    <div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex align-items-center mb-0">
                                <span class="avatar avatar-sm border rounded-circle p-1 me-2">
                                    <img src="{{URL::asset('/build/img/icons/company-icon-02.svg')}}" alt="Image">
                                </span>
                                <div>
