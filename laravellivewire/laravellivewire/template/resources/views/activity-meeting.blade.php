								...
								<div class="d-flex align-items-center flex-wrap row-gap-2">
									...
									<div class="active-list">													
										<ul class="mb-0">
											...
											<li>
												<a href="{{url('activity-mail')}}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Mail"><i class="ti ti-mail"></i></a>
											</li>
											<li>
											...
											<li>
												<a href="{{url('activity-meeting')}}" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Meeting"><i class="ti ti-user-share"></i></a>
											</li>
										</ul>
									</div>
								</div>
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="{{url('activity-meeting')}}" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
