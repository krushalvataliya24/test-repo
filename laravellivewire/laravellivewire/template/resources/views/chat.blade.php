                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                        <div class="profile-img online">
                                            <img src="{{URL::asset('/build/img/profiles/avatar-02.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                ...
                                <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                        <div class="profile-img online">
                                            <img src="{{URL::asset('/build/img/profiles/avatar-07.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                        <div class="profile-img online">
                                            <img src="{{URL::asset('/build/img/profiles/avatar-05.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="top-contacts-box">
                                        <div class="profile-img online">
                                            <img src="{{URL::asset('/build/img/profiles/avatar-03.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
        ...
        <div class="chat-body">
            <div class="messages">
                ...
                <div class="chats chats-right">
                    <div class="chat-content">
                        ...
                        <div class="message-content ">
                            ...
                            <div class="chat-voice-group">
                                <ul>
                                    <li><a href="javascript:void(0);"><span><img src="{{URL::asset('/build/img/icons/play-01.svg')}}" alt="image"></span></a></li>
                    ...
                    <div class="chat-avatar">
                        <img src="{{URL::asset('/build/img/profiles/avatar-10.jpg')}}" class="rounded-circle dreams_chat" alt="image">
                    </div>
                </div>
                <div class="chats">
                    <div class="chat-avatar">
                ...
                <div class="chats">
                    ...
                    <div class="chat-content">
                        ...
                        <div class="message-content review-files">
                            <p class="d-flex align-items-center">Please check and review the files<span class="ms-1 d-flex"><img src="{{URL::asset('/build/img/icons/smile-chat.svg')}}" alt="Icon"></span></p>
                        ...
                        <div class="like-chat-grp">
                            <ul>
                                <li class="like-chat"><a href="javascript:void(0);">2<img src="{{URL::asset('/build/img/icons/like.svg')}}"  alt="Icon"></a></li>
                                <li class="comment-chat"><a href="javascript:void(0);">2<img src="{{URL::asset('/build/img/icons/heart.svg')}}"  alt="Icon"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
