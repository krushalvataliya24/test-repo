            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="{{ Request::is('excel') ? 'active' : '' }}"
                                href="{{ url('excel') }}"><i class="ti ti-user-up"></i><span>Excel</span></a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ Request::is('storages', 'ban-ip-address') ? 'subdrop active' : '' }}">
                                <i class="ti ti-flag-cog"></i><span>Other Settings</span><span
                                    class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li><a class="{{ Request::is('storages') ? 'active' : '' }}"
                                        href="{{ url('storages') }}">Storage</a></li>
