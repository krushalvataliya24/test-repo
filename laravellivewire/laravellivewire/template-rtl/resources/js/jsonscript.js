...
$(document).ready(function () {
	...
	if($('#categorieslist').length > 0) {
		$('#categorieslist').DataTable({
			...
			"data":[
				{
					...
					"rating" : "4.2",
					"owner" : "Hendry",
					"owner_image": "build/img/profiles/avatar-14.jpg",
					"status" : "0",
					"Action" : ""
				},
				{
				...
				,
				{
					...
					"customer_image" : "build/img/profiles/avatar-06.jpg",
				...
				,
				{
					...
					"customer_image" : "build/img/profiles/avatar-05.jpg",
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="d-flex align-items-center"><a href="contact-details" class="avatar avatar-sm me-2"><img class="img-fluid" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact-details" class="d-flex flex-column">' + row['customer_name'] + ' <span class="text-default">' + row['customer_no'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if($('#companieslist').length > 0) {
		$('#companieslist').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border rounded p-1 me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column fw-medium">'+row['company_name']+'</a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
				...
				{ "render": function ( data, type, row ){
					return '<div class="dropdown table-action"><a href="#" class="action-icon " data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_edit"><i class="ti ti-edit text-blue"></i> Edit</a><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_contact"><i class="ti ti-trash text-danger"></i> Delete</a><a class="dropdown-item" href="company-details"><i class="ti ti-eye text-blue-light"></i> Preview</a></div></div>';
				}}
			]
		});
	}
	...
	if($('#deal_list').length > 0) {
		$('#deal_list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<a href="deals-details" class="title-name">'+row['Deal_Name']+'</a>';
				}},
				{ "data": "Stage" },
				{ "data": "Deal_Value" },
				{ "render": function ( data, type, row ){
	...
	if($('#recent-project').length > 0) {
			...
			"data":[
				{
					...
					"priority_img" : "build/img/priority/truellysel.svg",
					"recent_name" : "NovaWave LLC",
					"recent_img" : "build/img/icons/company-icon-01.svg",
					"client" : "1",
				...
				},
				{
					"id" : 3,
					"priority_name" : "Truelysell",
					"priority_img" : "build/img/priority/truellysell.svg",
					"recent_name" : "SilverHawk",
					"recent_img" : "build/img/icons/company-icon-03.svg",
					"client" : "",
				...
				},
				{
					...
					"priority_img" : "build/img/priority/servbook.svg",
					"recent_name" : "SummitPeak",
					"recent_img" : "build/img/icons/company-icon-04.svg",
					"client" : "1",
				...
				},
				{
					...
					"priority_img" : "build/img/priority/dream-pos.svg",
					"recent_name" : "RiverStone Ventur",
					"recent_img" : "build/img/icons/company-icon-05.svg",
					"client" : "2",
		...
		"columns": [
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="project-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['priority_img']+'" alt="User Image"></a><a href="project-details">'+row['priority_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['recent_img']+'" alt="User Image"></a><a href="company-details">'+row['recent_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
	...
	if($('#lead-project').length > 0) {
			...
			"data":[
				{
					...
					"lead_img" : "build/img/icons/company-icon-01.svg",
					"phone" : "+1 875455453",
					"status" : "1"
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-02.svg",
					"phone" : "+1 989757485",
					"status" : "2"
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-03.svg",
					"phone" : "+1 546555455",
					"status" : ""
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-04.svg",
					"phone" : "+1 454478787",
					"status" : "1"
				}
		...
		"columns": [
			{ "data": "lead" },
			{ "render": function ( data, type, row ){
				return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
			}},
			{ "data": "phone" },
			{ "render": function ( data, type, row ){
	...
	if($('#contracts-list').length > 0) {
		$('#contracts-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details">'+row['customer']+'</a></h2>';
				}},  
				{ "data": "contract_value" },                 
				{ "data": "contract_type" },                 
				{ "data": "date" },                 
	...
	if($('#analytic-contact').length > 0) {
		$('#analytic-contact').DataTable({
			...
			"data":[
				{
					...
					"lead_img" : "build/img/profiles/avatar-16.jpg",
					"phone" : "+1 124547845",
				...
				},
				{
					...
					"lead_img" : "build/img/profiles/avatar-22.jpg",
					"phone" : "+1 478845447",
				...
				},
				{
					...
					"lead_img" : "build/img/profiles/avatar-23.jpg",
					"phone" : "+1 215544845",
				...
				},
				{
					...
					"lead_img" : "build/img/profiles/avatar-24.jpg",
					"phone" : "+1 124547845",
				...
				},
				{
					...
					"lead_city" : "Installer",
					"lead_img" : "build/img/profiles/avatar-20.jpg",
					"phone" : "+1 466701256",
					"email" : "sharon@example.com",
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="contact-details" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="contact-details" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
		...
		$('#analytic-company').DataTable({
			...
			"data":[
				...
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-05.svg",
					"phone" : "+1 124547845",
					"email" : "joe@example.com",
					"date" : "17 Oct 2023, 11:34 am"
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-07.svg",
					"phone" : "+1 124547845",
					"email" : "joe@example.com",
					"date" : "17 Oct 2023, 11:34 am"
				},
				{
					...
					"lead_img" : "build/img/icons/company-icon-10.svg",
					"phone" : "+1 466701256",
					"email" : "sharon@example.com",
					"date" : "15 Nov 2023, 07:26 pm"
				}
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details">'+row['lead_name']+'</a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
	...
	if($('#analytic-lead').length > 0) {
		$('#analytic-lead').DataTable({
			...
			"columns": [
				{ "data": "name" },
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="leads-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['lead_img']+'" alt="User Image"></a><a href="leads-details" class="d-flex flex-column">'+row['lead_name']+'<span class="text-default">'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "render": function ( data, type, row ){
				...
				"data":[
					{
						...
						"checkbox": "",
						"rating": "",
						"lang_img" : "build/img/icons/flag-01.svg",
						"language" : "English",
						"code" : "en",
						"total" : "3481",
						"done" : "2861",
					...
					},
					{
						...
						"checkbox": "",
						"rating": "",
						"lang_img" : "build/img/icons/flag-02.svg",
						"language" : "Arabic",
						"code" : "ar",
						"total" : "4815",
						"done" : "4815",
					...
					},
					{
						...
						"checkbox": "",
						"rating": "",
						"lang_img" : "build/img/icons/flag-03.svg",
						"language" : "Chinese",
						"code" : "zh",
						"total" : "2590",
						"done" : "250",
					...
					},
					{
						...
						"checkbox": "",
						"rating": "",
						"lang_img" : "build/img/icons/flag-04.svg",
						"language" : "Hindi",
						"code" : "hi",
						"total" : "1892",
						"done" : "387",
				...
				"data":[
					{
						...
						"assigned_image" : "build/img/profiles/avatar-02.jpg",
					...
					},
					{
						...
						"assigned_image" : "build/img/profiles/avatar-01.jpg",
					...
					},
					{
						...
						"assigned_image" : "build/img/profiles/avatar-04.jpg",
					...
					},
					{
						...
						"assigned_image" : "build/img/profiles/avatar-03.jpg",
					...
					},
					{
						...
						"assigned_image" : "build/img/profiles/avatar-05.jpg",
						"assigned_date" : "22 Sep 2023",
						"created" : "25 Sep 2023, 12:12 pm",
						"due_date" : "25 Dec 2023",
						"customer_name" : "Carol Thomas",
					...
					},
					{
						...
						"assigned_image" : "build/img/profiles/avatar-06.jpg",
						"assigned_date" : "30 Sep 2023",
				...
				"data":[
					{
						...
						"country_image":"build/img/flags/as.png",
						"state": "Swains Island",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/ad.png",
					...
					},
					{
						...
						"country_image":"build/img/flags/ao.png",
						"state": "Benguella",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/ai.png",
						"state": "The Valley",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/qa.png",
						"state": "Victoria Land",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/ag.png",
						"state": "Saint Paul",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/ar.png",
						"state": "Santa Fe",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/au.png",
						"state": "Queensland",
						"Action" : ""
					},
					{
						...
						"country_image":"build/img/flags/at.png",
						"state": "Tyrol",
						"Action" : ""
					}
					,
					{
						...
						"country_image":"build/img/flags/az.png",
						"state": "Karabakh",
						"Action" : ""
					}
	...
	if($('#contact-reports').length > 0) {
		$('#contact-reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="contact-details" class="avatar avatar-sm me-2"><img class="w-auto h-auto" src="'+row['customer_image']+'" alt="User Image"></a><a href="contact-details" class="d-flex flex-column">'+row['customer_name']+' <span class="text-default">'+row['customer_no']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details">'+row['company_name']+'</a></h2>';
				}},
				{ "data": "industry" },
				{ "data": "type" },
				{ "data": "source" },
	...
	if($('#leads_reports').length > 0) {
		$('#leads_reports').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="d-flex align-items-center"><a href="company-details" class="avatar avatar-sm border me-2"><img class="w-auto h-auto" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="d-flex flex-column">'+row['company_name']+'<span class="text-default">'+row['company_address']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
				...
				"data":[
					{
						...
						"status" : "1",
						"created_date" : "25 Sep 2023, 01:22 pm",
						"img" : "build/img/profiles/avatar-14.jpg",
