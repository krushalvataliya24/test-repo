						...
						<div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
							...
							<div class="d-flex align-items-center flex-wrap row-gap-2">
										...
										<div class="filter-set-view">
											...
											<div class="filter-reset-btns">
												<div class="row">
													...
													<div class="col-6">
														<a href="{{url('companies')}}" class="btn btn-primary">Filter</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="view-icons">
									<a href="{{url('companies')}}" class="active"><i class="ti ti-list-tree"></i></a>
									<a href="{{url('companies-grid')}}"><i class="ti ti-grid-dots"></i></a>
								</div>
							</div>	
						</div>
						<!-- /Filter -->
