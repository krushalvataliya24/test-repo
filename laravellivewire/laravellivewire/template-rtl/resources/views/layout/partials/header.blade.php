...
<div class="header">
    ...
    <div class="header-left active">
        <a href="{{ url('deals-dashboard') }}" class="logo logo-normal">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item nav-list">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="faq" class="btn btn-help">
                            <i class="ti ti-help-hexagon"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="lead-reports" class="btn btn-chart-pie">
            ...
            <li class="nav-item dropdown nav-item-box">
                ...
                <div class="dropdown-menu dropdown-menu-end notification-dropdown">
                                ...
                                <a href="{{ url('activities') }}">
                                    <div class="media d-flex">
                                        ...
                                        <div class="media-body flex-grow-1">
                                            <p class="noti-details">Ray Arnold left 6 comments on Isla Nublar SOC2
                                                compliance report</p>
                                ...
                                <a href="{{ url('activities') }}">
                                    <div class="media d-flex">
                                        ...
                                        <div class="media-body flex-grow-1">
                                            ...
                                            <p class="noti-sub-details">“Oh, I finished de-bugging the phones, but the
                            ...
                            <li class="notification-message">
                                <a href="{{ url('activities') }}">
                                    <div class="media d-flex">
                                        ...
                                        <div class="media-body flex-grow-1">
                                            <p class="noti-details">John Hammond attached a file to Isla Nublar SOC2
                                                compliance report</p>
                                            <div class="noti-pdf">
                    ...
                    <div class="topnav-dropdown-footer">
                        <a href="{{ url('activities') }}" class="view-link">View all</a>
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                <div class="dropdown-menu menu-drop-user">
                    <div class="profilename">
                        <a class="dropdown-item" href="{{ url('deals-dashboard') }}">
