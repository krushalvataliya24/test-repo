						...
						<div class="d-flex align-items-center flex-wrap row-gap-2">
							<div class="d-flex align-items-center flex-wrap row-gap-2">
								...
								<div class="active-list">													
									<ul class="mb-0">
										<li>
											<a href="{{url('activity-calls')}}" class="active" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Calls"><i class="ti ti-phone"></i></a>
										</li>
										<li>
								...
								<div class="filter-set-view">
										...
										<div class="filter-reset-btns">
											<div class="row">
												...
												<div class="col-6">
													<a href="{{url('activity-calls')}}" class="btn btn-primary">Filter</a>
												</div>
											</div>
										</div>
									</div>
