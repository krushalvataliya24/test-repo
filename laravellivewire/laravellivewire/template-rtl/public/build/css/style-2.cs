...
.bg-dark.bg-opacity-10 {
  background-color: rgba(5, 4, 7, 0.1) !important;
}
.bg-dark.bg-opacity-25 {
  background-color: rgba(5, 4, 7, 0.25) !important;
}
.bg-dark.bg-opacity-50 {
  background-color: rgba(5, 4, 7, 0.5) !important;
}
.bg-dark.bg-opacity-75 {
  background-color: rgba(5, 4, 7, 0.75) !important;
}
...
.bg-dark {
  background-color: #050407 !important;
  border: 1px solid #050407 !important;
  color: #FFF;
}
...
.bg-soft-dark {
  background-color: rgba(5, 4, 7, 0.3);
  color: #FFF;
}
...
.bg-dark-gradient {
  background: linear-gradient(to right, #050407 0%, #54505D 100%) !important;
  color: #FFF;
}
...
@media (min-width: 991.98px) {
  ...
  .mini-sidebar .sidebar .sidebar-menu > ul > li ul li a {
    padding: 8px 10px;
  }
...
.btn-outline-dark:hover, .btn-outline-dark:focus, .btn-outline-dark.focus, .btn-outline-dark:active, .btn-outline-dark.active {
  background-color: #050407 !important;
  border: 1px solid #050407 !important;
  box-shadow: 0 3px 10px rgba(5, 4, 7, 0.5);
  color: #FFF !important;
}
...
.badge.badge-dark {
  background: #050407;
  box-shadow: 0 1px 1px rgba(5, 4, 7, 0.5);
  color: #FFF;
}
.badge.badge-soft-dark {
  background: rgba(5, 4, 7, 0.1);
  box-shadow: 0 1px 1px rgba(5, 4, 7, 0.5);
  color: #050407;
}
...
.border.border-dark.border-opacity-10 {
  border-color: rgba(5, 4, 7, 0.1) !important;
}
.border.border-dark.border-opacity-25 {
  border-color: rgba(5, 4, 7, 0.25) !important;
}
.border.border-dark.border-opacity-50 {
  border-color: rgba(5, 4, 7, 0.5) !important;
}
.border.border-dark.border-opacity-75 {
  border-color: rgba(5, 4, 7, 0.75) !important;
}
.border.border-dark.border-opacity-100 {
  border-color: #050407 !important;
}
...
.alert-dark {
  background-color: rgba(5, 4, 7, 0.1);
  color: #6F6F6F;
  border-color: rgba(5, 4, 7, 0.1);
}
...
.alert-dark.custom-alert-icon {
  border-inline-start: 0.313rem solid #050407 !important;
  color: #9595b5;
  background-color: #FFF;
  border: 1px solid #6F6F6F;
  font-size: 0.813rem;
...
.toggle.on.toggle-dark {
  background-color: rgba(5, 4, 7, 0.4);
}
...
.page-header .head-icons a.active, .page-header .head-icons a:hover {
  background: #00918E;
  color: #FFF;
}
...
.filter-list > ul > li .btn-purple-light:hover, .filter-list > ul > li .btn-purple-light.active, .filter-list > ul > li .btn-purple-light:focus, .filter-list > ul > li .btn-purple-light.show {
...
.toggle-popup.sidebar-popup, .toggle-popup1.sidebar-popup,
...
.toggle-popup .sidebar-layout, .toggle-popup1 .sidebar-layout,
...
.toggle-popup .sidebar-layout .sidebar-header, .toggle-popup1 .sidebar-layout .sidebar-header,
...
.toggle-popup .sidebar-layout .sidebar-header h4, .toggle-popup1 .sidebar-layout .sidebar-header h4,
.toggle-popup2 .sidebar-layout .sidebar-header h4 {
  margin: 0;
  font-weight: 600;
}
.toggle-popup .sidebar-layout .sidebar-header a, .toggle-popup1 .sidebar-layout .sidebar-header a,
.toggle-popup2 .sidebar-layout .sidebar-header a {
  color: #FF0000;
  font-size: 24px;
}
.toggle-popup .sidebar-layout .sidebar-header .toggle-btn, .toggle-popup1 .sidebar-layout .sidebar-header .toggle-btn,
...
.toggle-popup .sidebar-layout .sidebar-header .toggle-btn:hover, .toggle-popup1 .sidebar-layout .sidebar-header .toggle-btn:hover,
...
.toggle-popup .sidebar-layout .toggle-body, .toggle-popup1 .sidebar-layout .toggle-body,
.toggle-popup2 .sidebar-layout .toggle-body {
  padding: 20px 20px 0;
}
.toggle-popup .sidebar-layout .toggle-body .select2-container--default .select2-selection--single, .toggle-popup1 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single,
.toggle-popup2 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single {
  height: 42px;
}
.toggle-popup .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__rendered, .toggle-popup1 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__rendered,
.toggle-popup2 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__rendered {
  height: 42px;
  line-height: 42px;
}
.toggle-popup .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__arrow, .toggle-popup1 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__arrow,
.toggle-popup2 .sidebar-layout .toggle-body .select2-container--default .select2-selection--single .select2-selection__arrow {
  height: 42px;
}
.toggle-popup .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple, .toggle-popup1 .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple,
.toggle-popup2 .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple {
  height: 42px;
  overflow-y: auto;
}
.toggle-popup .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple .select2-selection__choice, .toggle-popup1 .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple .select2-selection__choice,
.toggle-popup2 .sidebar-layout .toggle-body .select2-container--default .select2-selection--multiple .select2-selection__choice {
  margin-top: 4px;
}
.toggle-popup .sidebar-layout .toggle-body .submit-button, .toggle-popup1 .sidebar-layout .toggle-body .submit-button,
...
.active-list ul li a:hover, .active-list ul li a.active {
  background-color: #00918E;
  border-color: #00918E;
  color: #FFF;
}
...
.lang-direct li a:hover, .lang-direct li a.active {
  background-color: #3C2371;
  color: #FFF;
}
...
.translate-item .btn, .translate-item .lang-flag {
  margin-bottom: 24px;
}
...
.dataTables_paginate .paging_numbers, #dataTables_paginate .paging_numbers {
  float: right;
}
...
.dataTables_paginate .pagination li, #dataTables_paginate .pagination li {
  margin: 0 2px;
}
...
.dataTables_paginate .pagination li a:hover, #dataTables_paginate .pagination li a:hover {
  background: #00918E;
  color: #FFF;
}
...
.dataTables_paginate .pagination li.previous.disabled, .dataTables_paginate .pagination li.previous, #dataTables_paginate .pagination li.previous.disabled, #dataTables_paginate .pagination li.previous {
  width: auto;
  margin: 0 13px 0 0;
}
.dataTables_paginate .pagination li.previous.disabled a, .dataTables_paginate .pagination li.previous a, #dataTables_paginate .pagination li.previous.disabled a, #dataTables_paginate .pagination li.previous a {
  background-color: transparent;
  border: 0;
  width: auto;
  padding: 0;
}
.dataTables_paginate .pagination li.previous.disabled a i, .dataTables_paginate .pagination li.previous a i, #dataTables_paginate .pagination li.previous.disabled a i, #dataTables_paginate .pagination li.previous a i {
  margin-right: 8px;
}
.dataTables_paginate .pagination li.previous.disabled a:hover, .dataTables_paginate .pagination li.previous a:hover, #dataTables_paginate .pagination li.previous.disabled a:hover, #dataTables_paginate .pagination li.previous a:hover {
  color: #00918E;
}
.dataTables_paginate .pagination li.next.disabled, .dataTables_paginate .pagination li.next, #dataTables_paginate .pagination li.next.disabled, #dataTables_paginate .pagination li.next {
  width: auto;
  margin: 0 0 0 13px;
}
.dataTables_paginate .pagination li.next.disabled a, .dataTables_paginate .pagination li.next a, #dataTables_paginate .pagination li.next.disabled a, #dataTables_paginate .pagination li.next a {
  background-color: transparent;
  border: 0;
  width: auto;
  padding: 0;
}
.dataTables_paginate .pagination li.next.disabled a i, .dataTables_paginate .pagination li.next a i, #dataTables_paginate .pagination li.next.disabled a i, #dataTables_paginate .pagination li.next a i {
  margin-left: 8px;
}
.dataTables_paginate .pagination li.next.disabled a:hover, .dataTables_paginate .pagination li.next a:hover, #dataTables_paginate .pagination li.next.disabled a:hover, #dataTables_paginate .pagination li.next a:hover {
  color: #00918E;
}
@media (max-width: 767.98px) {
  .dataTables_paginate .pagination, #dataTables_paginate .pagination {
...
.dataTables_length, #dataTables_length .dataTables_paginate,
#dataTables_paginate {
...
/*# sourceMappingURL=style-2.cs.map */
