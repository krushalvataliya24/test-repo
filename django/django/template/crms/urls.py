...
urlpatterns = [
    ...
    path('crms/template/', app_views.login, name='login'),
    path('crms/template/index', dashboard_views.index, name='index'),
    ...
    path('crms/template/leads-kanban', app_views.leads_kanban, name='leads_kanban'),
